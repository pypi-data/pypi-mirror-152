...
class App(object):
    ...
    def __init__(self, verbose=True):
        ...
        # 增加配置项，方便热更新
        self.config = None # self.config===body_json
        self.add_route_plus(lambda k: self.config, '/app-config')
        self.add_route_plus(self._set_config, '/set-app-config', methods="POST")
