...
def helps_print():
  return '''\033[96mHOPYBOX {} Helps Documentation\n(HOPYBOX {} 帮助文档)\033[0m
...
(启动此模式方法:输入“take command”)\033[0m\033[95m
 ...
 ⎜ fwayget {ip} # Look for the IPV4's address 
...
If you have any questions, please contact the developer as hostudio.hopybox@foxmail.com.'''.format(vcd,vcd)