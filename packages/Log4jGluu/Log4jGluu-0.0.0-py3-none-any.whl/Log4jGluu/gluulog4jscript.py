...
class gluulog4jscanner:
    ...
    global vulnerable_files,patched_files
    ...
    def scan_oxauth(self,patched_versions):
    ...
    def scan_identity(self,patched_versions):
    ...
    def scan_idp(self,patched_versions):
    ...
    def scan_casa(self,patched_versions):
    ...
    def scan_fido(self,patched_versions):
    ...
    def scan_scim(self, patched_versions):
...
def main():
    gluu = gluulog4jscanner()
    oxauth_status,identity_status,idp_status,casa_status,fido_status,scim_status=gluu.check_services()
    if gluu.args.revert:
        gluu.revert_back(oxauth_status,identity_status,idp_status,casa_status,fido_status,scim_status)
        time.sleep(120)
    ...
    if vulnerable_files > 0:
        ...
        if ch =="y":
            ...
            if ch_2=="confirm" or ch_2=="Confirm" or ch_2=="CONFIRM":
                ...
                if oxauth_status=="active":
                    gluulog4jscanner.backup_oxauth()
                if identity_status=="active":
                    gluulog4jscanner.backup_identity()
                if idp_status=="active":
                    gluulog4jscanner.backup_idp()
                if casa_status=="active":
                    gluulog4jscanner.backup_casa()
                if fido_status=="active":
                    gluulog4jscanner.backup_fido()
                if scim_status=="active":
                    gluulog4jscanner.backup_scim()
