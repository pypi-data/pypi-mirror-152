...
"""Tests for `PFAS_SAT_InputData` package."""

import pytest
from PFAS_SAT_InputData import InputData
...
def test_InputData(Input_Data):
    assert list(Input_Data.Data.columns) == ['Category', 'Dictionary_Name', 'Parameter Name', 'Parameter Description', 'amount', 'unit',
