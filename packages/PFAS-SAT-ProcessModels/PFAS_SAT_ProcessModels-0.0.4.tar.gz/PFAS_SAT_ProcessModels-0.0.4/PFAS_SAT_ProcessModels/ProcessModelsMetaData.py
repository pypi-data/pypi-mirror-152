...
ProcessModelsMetaData['ThermalTreatment']['InputType'] = ['MSW', 'FoodWaste', 'SpentGAC', 'SpentIER',
                                                          ...
                                                          'AFFF_Sulfonate', 'AFFF_Fluorotelomer', 'ContaminatedSoil']
...
ProcessModelsMetaData['SCWO']['InputType'] = ['AFFF_Sulfonate', 'AFFF_Fluorotelomer', 'ROConcentrate',
                                              'ContaminatedWater', 'LFLeachate',
                                              'ContactWater']
...
ProcessModelsMetaData['DeepWellInjection']['InputType'] = ['WWTEffluent', 'ROConcentrate', 'ContaminatedWater',
                                                           'ContactWater', 'LFLeachate',
                                                           'AFFF_Sulfonate', 'AFFF_Fluorotelomer']
