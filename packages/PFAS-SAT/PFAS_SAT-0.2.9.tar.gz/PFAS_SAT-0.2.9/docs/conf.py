#!/usr/bin/env python
#
# swolfpy documentation build configuration file, created by
...
for mod in ['PFAS_SAT', 'PFAS_InputData', 'PFAS_SAT_ProcessModels']:
    try:
...
latex_documents = [
    (master_doc, 'PFAS_SAT.tex',
     'PFAS_SAT Documentation',
     """Mojtaba Sardarmehni
        Amanda Karam
        Dr. James W. Levis
        Dr. Detlef Knappe
        Dr. Morton Barlaz""", 'manual'),
]
...
texinfo_documents = [
    (master_doc, 'PFAS AT',
     ...
     author,
     'PFAS SAT',
     'Perfluoroalkyl Substances Systems Analysis Tool (PFAS SAT)',
     ''),
]
