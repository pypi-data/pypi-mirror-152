...
from StructuralGT import gui_multi_image, gui_single_image, gui_3d_image
...
def multi_image():
    ...
    button_back = Button(mframe_2, text="Go Back", command=lambda: multi.destroy())
...
button2 = Button(frame_2, text="Multi-Image StructuralGT", bg="Light Blue", command=lambda:  multi_image())
button3 = Button(frame_2, text="3D Image StructuralGT", bg="Light Blue", command=lambda: gui_3d_image.make_gui(window))
button_about = Button(frame_2, text="About...", command=lambda: about_window())
