...
class GeneratorXmlFourDotZero(AbstractGeneratorXml):
    ...
    def generate_xml(self):
        ...
        dom.setAttribute('Certificado', self.global_data.get('certificado'))
        ...
        if self.data.get('confirmacion') and len(self.data.get('confirmacion', [])) == 5:
        ...
        if (self.tipo_objeto == INGRESO) or (self.tipo_objeto == EGRESO and not self.global_data.get('concepto_fijo')):
            ...
            dom.setAttribute('CondicionesDePago', self.data.get('condicion_pago')) # hasta 1000 caracteres
    ...
    def get_emisor(self):
        try:
            ...
            # emisor.setAttribute('FacAtrAdquirente', self.data.get('fac_atr_adquirente')) #Pendiente de agregar
            return emisor
        except Exception as e:
    ...
    def get_receptor(self):
        try:
            ...
            #if self.data.get('receptor_rfc') not in ['XAXX010101000', 'XEXX010101000']:
