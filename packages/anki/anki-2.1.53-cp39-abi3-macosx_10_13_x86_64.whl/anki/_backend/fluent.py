...
class LegacyTranslationEnum:
    ...
    EXPORTING_INCLUDE_HTML_AND_MEDIA_REFERENCES = (16, 15)
    EXPORTING_INCLUDE_MEDIA = (16, 16)
    EXPORTING_INCLUDE_SCHEDULING_INFORMATION = (16, 17)
    EXPORTING_INCLUDE_TAGS = (16, 18)
    EXPORTING_NOTE_EXPORTED = (16, 19)
    EXPORTING_NOTES_IN_PLAIN_TEXT = (16, 20)
    EXPORTING_PROCESSED_MEDIA_FILES = (16, 21)
    EXPORTING_SELECTED_NOTES = (16, 22)
    EXPORTING_SUPPORT_OLDER_ANKI_VERSIONS = (16, 23)
    ...
    IMPORTING_EXTRACTING = (19, 11)
    IMPORTING_FAILED_DEBUG_INFO = (19, 12)
    IMPORTING_FAILED_TO_IMPORT_MEDIA_FILE = (19, 13)
    IMPORTING_FIELD_MAPPING = (19, 14)
    IMPORTING_FIELD_OF_FILE_IS = (19, 15)
    IMPORTING_FIELDS_SEPARATED_BY = (19, 16)
    IMPORTING_FILE_VERSION_UNKNOWN_TRYING_IMPORT_ANYWAY = (19, 17)
    IMPORTING_FIRST_FIELD_MATCHED = (19, 18)
    IMPORTING_GATHERING = (19, 19)
    IMPORTING_IDENTICAL = (19, 20)
    IMPORTING_IGNORE_FIELD = (19, 21)
    IMPORTING_IGNORE_LINES_WHERE_FIRST_FIELD_MATCHES = (19, 22)
    IMPORTING_IGNORED = (19, 23)
    IMPORTING_IMPORT_EVEN_IF_EXISTING_NOTE_HAS = (19, 24)
    IMPORTING_IMPORT_OPTIONS = (19, 25)
    IMPORTING_IMPORTING_COLLECTION = (19, 26)
    IMPORTING_IMPORTING_COMPLETE = (19, 27)
    IMPORTING_IMPORTING_FILE = (19, 28)
    IMPORTING_INVALID_FILE_PLEASE_RESTORE_FROM_BACKUP = (19, 29)
    IMPORTING_MAP_TO = (19, 30)
    IMPORTING_MAP_TO_TAGS = (19, 31)
    IMPORTING_MAPPED_TO = (19, 32)
    IMPORTING_MAPPED_TO_TAGS = (19, 33)
    IMPORTING_MNEMOSYNE_20_DECK_DB = (19, 34)
    IMPORTING_MULTICHARACTER_SEPARATORS_ARE_NOT_SUPPORTED_PLEASE = (19, 35)
    IMPORTING_NOTE_ADDED = (19, 36)
    IMPORTING_NOTE_IMPORTED = (19, 37)
    IMPORTING_NOTE_UNCHANGED = (19, 38)
    IMPORTING_NOTE_UPDATED = (19, 39)
    IMPORTING_NOTES_ADDED_FROM_FILE = (19, 40)
    IMPORTING_NOTES_FOUND_IN_FILE = (19, 41)
    IMPORTING_NOTES_SKIPPED_AS_THEYRE_ALREADY_IN = (19, 42)
    IMPORTING_NOTES_THAT_COULD_NOT_BE_IMPORTED = (19, 43)
    IMPORTING_NOTES_UPDATED_AS_FILE_HAD_NEWER = (19, 44)
    IMPORTING_PACKAGED_ANKI_DECKCOLLECTION_APKG_COLPKG_ZIP = (19, 45)
    IMPORTING_PAUKER_18_LESSON_PAUGZ = (19, 46)
    IMPORTING_PROCESSED_MEDIA_FILE = (19, 47)
    IMPORTING_PROCESSED_NOTES = (19, 48)
    IMPORTING_ROWS_HAD_NUM1D_FIELDS_EXPECTED_NUM2D = (19, 49)
    IMPORTING_SELECTED_FILE_WAS_NOT_IN_UTF8 = (19, 50)
    IMPORTING_SEMICOLON = (19, 51)
    IMPORTING_SKIPPED = (19, 52)
    IMPORTING_SUPERMEMO_XML_EXPORT_XML = (19, 53)
    IMPORTING_TAB = (19, 54)
    IMPORTING_TAG_MODIFIED_NOTES = (19, 55)
    IMPORTING_TEXT_SEPARATED_BY_TABS_OR_SEMICOLONS = (19, 56)
    IMPORTING_THE_FIRST_FIELD_OF_THE_NOTE = (19, 57)
    IMPORTING_THE_PROVIDED_FILE_IS_NOT_A = (19, 58)
    IMPORTING_THIS_FILE_DOES_NOT_APPEAR_TO = (19, 59)
    IMPORTING_THIS_WILL_DELETE_YOUR_EXISTING_COLLECTION = (19, 60)
    IMPORTING_UNABLE_TO_IMPORT_FILENAME = (19, 61)
    IMPORTING_UNABLE_TO_IMPORT_FROM_A_READONLY = (19, 62)
    IMPORTING_UNKNOWN_FILE_FORMAT = (19, 63)
    IMPORTING_UPDATE_EXISTING_NOTES_WHEN_FIRST_FIELD = (19, 64)
    IMPORTING_UPDATED = (19, 65)
    KEYBOARD_CTRL = (20, 0)
    KEYBOARD_SHIFT = (20, 1)
...
Debug info: '''
    ...
    def exporting_note_exported(self, count: int) -> str:
        ...
        return self._translate(16, 19, {"count": count})
    ...
    def exporting_processed_media_files(self, count: int) -> str:
        ...
        return self._translate(16, 21, {"count": count})
    ...
    def importing_failed_to_import_media_file(self, debug_info: str) -> str:
        ...
        return self._translate(19, 13, {"debugInfo": debug_info})
    ...
    def importing_map_to(self, val: FluentVariable) -> str:
        r''' Map to {$val} '''
        return self._translate(19, 30, {"val": val})
    ...
    def importing_mapped_to(self, val: FluentVariable) -> str:
        r''' mapped to <b>{$val}</b> '''
        return self._translate(19, 32, {"val": val})
    ...
    def importing_note_imported(self, count: int) -> str:
        ...
        return self._translate(19, 37, {"count": count})


    def importing_note_unchanged(self, count: int) -> str:
        r''' {$count} notes unchanged '''
        return self._translate(19, 38, {"count": count})


    def importing_note_updated(self, count: int) -> str:
        r''' {$count} notes updated '''
        return self._translate(19, 39, {"count": count})
    ...
    def importing_notes_skipped_as_theyre_already_in(self, val: FluentVariable) -> str:
        ...
        return self._translate(19, 42, {"val": val})
    ...
    def importing_processed_media_file(self, count: int) -> str:
        ...
        return self._translate(19, 47, {"count": count})


    def importing_processed_notes(self, count: int) -> str:
        r''' Processed {$count} notes... '''
        return self._translate(19, 48, {"count": count})
    ...
    def importing_rows_had_num1d_fields_expected_num2d(self, row: str, found: FluentVariable, expected: FluentVariable) -> str:
        ...
        return self._translate(19, 49, {"row": row, "found": found, "expected": expected})
    ...
    def importing_unable_to_import_filename(self, filename: str) -> str:
        ...
        return self._translate(19, 61, {"filename": filename})
