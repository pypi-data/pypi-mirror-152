...
class RustBackendGenerated:
    ...
    def import_anki_package(self, package_path: str) -> anki.import_export_pb2.ImportAnkiPackageResponse:
        ...
        output = anki.import_export_pb2.ImportAnkiPackageResponse()
        output.ParseFromString(raw_bytes)
        return output
    ...
    def export_anki_package(self, message: anki.import_export_pb2.ExportAnkiPackageRequest) -> int:
