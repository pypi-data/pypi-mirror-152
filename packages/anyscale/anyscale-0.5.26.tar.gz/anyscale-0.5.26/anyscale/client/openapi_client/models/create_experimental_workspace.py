...
class CreateExperimentalWorkspace(object):
    ...
    def __init__(self, name=None, description=None, cloud_id=None, compute_config_id=None, base_snapshot=None, cluster_environment_build_id=None, idle_timeout_minutes=120, local_vars_configuration=None):  # noqa: E501
