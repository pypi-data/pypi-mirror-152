...
class ClusterCreateParams(object):
    ...
    attribute_map = {
        ...
        'use_scheduling_defaults': 'use_scheduling_defaults',
    ...
    def __init__(self, name=None, high_availability_mode='Full', openshift_version=None, ocp_release_image=None, base_dns_domain=None, cluster_network_cidr='10.128.0.0/14', cluster_network_host_prefix=None, service_network_cidr='172.30.0.0/16', api_vip=None, ingress_vip=None, pull_secret=None, ssh_public_key=None, vip_dhcp_allocation=True, http_proxy=None, https_proxy=None, no_proxy=None, user_managed_networking=False, additional_ntp_source=None, olm_operators=None, hyperthreading='all', network_type='OpenShiftSDN', schedulable_masters=True, use_scheduling_defaults=True, cluster_networks=None, service_networks=None, machine_networks=None, platform=None, cpu_architecture='x86_64', disk_encryption=None, ignition_endpoint=None):  # noqa: E501
        ...
        self._use_scheduling_defaults = None
        ...
        if use_scheduling_defaults is not None:
            self.use_scheduling_defaults = use_scheduling_defaults
    ...
    @property
    def use_scheduling_defaults(self):
        """Gets the use_scheduling_defaults of this ClusterCreateParams.  # noqa: E501

        False if the scheduling of workloads on masters has been set by the user through the API.  # noqa: E501

        :return: The use_scheduling_defaults of this ClusterCreateParams.  # noqa: E501
        :rtype: bool
        """
        return self._use_scheduling_defaults

    @use_scheduling_defaults.setter
    def use_scheduling_defaults(self, use_scheduling_defaults):
        """Sets the use_scheduling_defaults of this ClusterCreateParams.

        False if the scheduling of workloads on masters has been set by the user through the API.  # noqa: E501

        :param use_scheduling_defaults: The use_scheduling_defaults of this ClusterCreateParams.  # noqa: E501
        :type: bool
        """

        self._use_scheduling_defaults = use_scheduling_defaults
