...
class AzureMachineLearningWorkspaces:
    ...
    :vartype batch_job_deployment:
     azure.mgmt.machinelearningservices.aio.operations.BatchJobDeploymentOperations
    :ivar batch_job_endpoint: BatchJobEndpointOperations operations
    :vartype batch_job_endpoint:
     azure.mgmt.machinelearningservices.aio.operations.BatchJobEndpointOperations
