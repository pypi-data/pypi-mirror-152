...
from .operations import BatchDeploymentsOperations, BatchEndpointsOperations, CodeContainersOperations, CodeVersionsOperations, ComponentContainersOperations, ComponentVersionsOperations, ComputeOperations, DatasetContainersOperations, DatasetVersionsOperations, DatastoresOperations, EnvironmentContainersOperations, EnvironmentVersionsOperations, JobsOperations, ModelContainersOperations, ModelVersionsOperations, OnlineDeploymentsOperations, OnlineEndpointsOperations, Operations, PrivateEndpointConnectionsOperations, PrivateLinkResourcesOperations, QuotasOperations, UsagesOperations, VirtualMachineSizesOperations, WorkspaceConnectionsOperations, WorkspaceFeaturesOperations, WorkspacesOperations
...
class AzureMachineLearningWorkspaces:
    ...
    :ivar dataset_containers: DatasetContainersOperations operations
    :vartype dataset_containers:
     azure.mgmt.machinelearningservices.aio.operations.DatasetContainersOperations
    :ivar dataset_versions: DatasetVersionsOperations operations
    :vartype dataset_versions:
     azure.mgmt.machinelearningservices.aio.operations.DatasetVersionsOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.dataset_containers = DatasetContainersOperations(self._client, self._config, self._serialize, self._deserialize)
        self.dataset_versions = DatasetVersionsOperations(self._client, self._config, self._serialize, self._deserialize)
