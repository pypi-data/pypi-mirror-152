...
class TextClassificationJob(AutoMLNLPJob):
    ...
    @classmethod
    def _from_rest_object(cls, obj: JobBaseData) -> "TextClassificationJob":
    ...
    def _load_from_dict(
        ...
        if inside_pipeline:
            ...
            return load_from_dict(AutoMLTextClassificationNode, data, context, additional_message, **kwargs)

        return load_from_dict(TextClassificationSchema, data, context, additional_message, **kwargs)
