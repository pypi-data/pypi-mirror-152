...
_RESOURCETREE = _descriptor.Descriptor(
  name='ResourceTree',
  full_name='bosdyn.api.ResourceTree',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='resource', full_name='bosdyn.api.ResourceTree.resource', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='sub_resources', full_name='bosdyn.api.ResourceTree.sub_resources', index=1,
...
_LEASEUSERESULT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='latest_known_lease', full_name='bosdyn.api.LeaseUseResult.latest_known_lease', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='latest_resources', full_name='bosdyn.api.LeaseUseResult.latest_resources', index=5,
...
_LEASERESOURCE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='stale_time', full_name='bosdyn.api.LeaseResource.stale_time', index=3,
      number=4, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LISTLEASESRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='resource_tree', full_name='bosdyn.api.ListLeasesResponse.resource_tree', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_RESOURCETREE.fields_by_name['sub_resources'].message_type = _RESOURCETREE
...
_LEASEUSERESULT.fields_by_name['latest_known_lease'].message_type = _LEASE
_LEASEUSERESULT.fields_by_name['latest_resources'].message_type = _LEASE
...
_LEASERESOURCE.fields_by_name['stale_time'].message_type = google_dot_protobuf_dot_timestamp__pb2._TIMESTAMP
...
_LISTLEASESRESPONSE.fields_by_name['resource_tree'].message_type = _RESOURCETREE
...
DESCRIPTOR.message_types_by_name['ResourceTree'] = _RESOURCETREE
...
ResourceTree = _reflection.GeneratedProtocolMessageType('ResourceTree', (_message.Message,), dict(
