...
[boto3 1.23.9](https://boto3.amazonaws.com/v1/documentation/api/1.23.9/index.html)
...
- `boto3-stubs[emr-serverless]` - Type annotations for
  [EMRServerlessWebService](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_emr_serverless/)
  service.
