# -*- coding: utf-8 -*-
"""
Functional specification for the bowyer.cfg.builder module.
...
class SpecifySetSystemId:
    ...
    def it_returns_valid_configuration(self, valid_normalized_config):
        ...
        """
        import bowyer.cfg.builder   # pylint: disable=C0415
        import bowyer.cfg.validate  # pylint: disable=C0415
        bowyer.cfg.builder.set_system_id(cfg       = valid_normalized_config,
...
class SpecifyAddHost:
    ...
    def it_returns_valid_configuration(self, valid_normalized_config):
        ...
        import bowyer.cfg.builder   # pylint: disable=C0415
        import bowyer.cfg.validate  # pylint: disable=C0415
        bowyer.cfg.builder.add_host(cfg     = valid_normalized_config,
                                    id_host = 'new_host_id')
        bowyer.cfg.validate.normalized(valid_normalized_config)
...
class SpecifyRemoveHost:
    ...
    def it_returns_valid_configuration(self, valid_normalized_config):
        ...
        bowyer.cfg.builder.add_host(cfg     = valid_normalized_config,
                                    id_host = 'new_host_id')
        bowyer.cfg.builder.remove_host(cfg     = valid_normalized_config,
                                       id_host = 'new_host_id')
        bowyer.cfg.validate.normalized(valid_normalized_config)
...
class SpecifyAddProcess:
    ...
    def it_returns_valid_configuration(self, valid_normalized_config):
        ...
        import bowyer.cfg.builder   # pylint: disable=C0415
        import bowyer.cfg.validate  # pylint: disable=C0415
        bowyer.cfg.builder.add_process(cfg        = valid_normalized_config,
...
class SpecifyRemoveProcess:
    ...
    def it_returns_valid_configuration(self, valid_normalized_config):
        ...
        bowyer.cfg.builder.add_process(cfg        = valid_normalized_config,
                                       id_process = 'new_process_id',
                                       id_host    = 'some_host')
        bowyer.cfg.builder.remove_process(cfg        = valid_normalized_config,
                                          id_process = 'new_process_id')
        bowyer.cfg.validate.normalized(valid_normalized_config)
...
class SpecifyRemoveNode:
    ...
    def it_returns_valid_configuration(self, valid_normalized_config):
        ...
        bowyer.cfg.builder.add_node(
                    ...
                    id_process    = 'some_process')
        bowyer.cfg.builder.remove_node(cfg     = valid_normalized_config,
                                       id_node = 'new_node_id')
        bowyer.cfg.validate.normalized(valid_normalized_config)
...
class SpecifyAddEdge:
    ...
    def it_returns_valid_configuration(self, valid_normalized_config):
        ...
        import bowyer.cfg.builder   # pylint: disable=C0415
        import bowyer.cfg.validate  # pylint: disable=C0415
        bowyer.cfg.builder.add_edge(cfg     = valid_normalized_config,
                                    id_src  = 'some_node',
                                    src_ref = 'outputs.foo',
                                    id_dst  = 'some_node',
                                    dst_ref = 'inputs.foo',
...
class SpecifyRemoveEdge:
    ...
    def it_returns_valid_configuration(self, valid_normalized_config):
        ...
        bowyer.cfg.builder.add_edge(cfg     = valid_normalized_config,
                                    ...
                                    data    = 'some_data_type')
        bowyer.cfg.builder.remove_edge(cfg = valid_normalized_config,
...
class SpecifyAddData:
    ...
    def it_returns_valid_configuration(self, valid_normalized_config):
        ...
        import bowyer.cfg.builder   # pylint: disable=C0415
        import bowyer.cfg.validate  # pylint: disable=C0415
        bowyer.cfg.builder.add_data(cfg       = valid_normalized_config,
...
class SpecifyRemoveData:
    ...
    def it_returns_valid_configuration(self, valid_normalized_config):
        ...
        bowyer.cfg.builder.add_data(cfg       = valid_normalized_config,
                                    id_data   = 'new_type_alias',
                                    spec_data = 'py_dict')
        bowyer.cfg.builder.remove_data(cfg     = valid_normalized_config,
                                       id_data = 'new_type_alias')
        bowyer.cfg.validate.normalized(valid_normalized_config)
