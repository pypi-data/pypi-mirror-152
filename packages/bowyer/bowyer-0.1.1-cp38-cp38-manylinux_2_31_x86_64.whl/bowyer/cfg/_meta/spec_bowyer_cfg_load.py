# -*- coding: utf-8 -*-
"""
Functional specification for the bowyer.cfg.load module.
...
class SpecifyFromPath:
    """
    Spec for the bowyer.cfg.from_path function.
    ...
    def it_returns_a_python_dict(self, filepath_cfg_yaml):
        ...
        """
        import bowyer.cfg.load  # pylint: disable=C0415

        assert isinstance(bowyer.cfg.load.from_path(filepath_cfg_yaml),
                          dict)
    ...
    def it_loads_a_single_yaml_file(self, dict_of_strings, filepath_cfg_yaml):
        ...
        check_match(bowyer.cfg.load.from_path(filepath_cfg_yaml),
                    dict_of_strings)
    ...
    def it_loads_a_single_json_file(self, dict_of_strings, filepath_cfg_json):
        ...
        check_match(bowyer.cfg.load.from_path(filepath_cfg_json),
                    dict_of_strings)
    ...
    def it_loads_a_single_xml_file(self, dict_of_strings, filepath_cfg_xml):
        ...
        check_match(bowyer.cfg.load.from_path(filepath_cfg_xml),
                    dict_of_strings)
    ...
    def it_loads_a_directory_of_yaml_files(
        ...
        check_match(bowyer.cfg.load.from_path(dirpath_cfg_yaml),
                    dict_of_strings)
    ...
    def it_loads_a_directory_of_json_files(
        ...
        check_match(bowyer.cfg.load.from_path(dirpath_cfg_json),
                    dict_of_strings)
    ...
    def it_loads_a_directory_of_xml_files(
        ...
        check_match(bowyer.cfg.load.from_path(dirpath_cfg_xml),
                    dict_of_strings)
...
class SpecifyFromFilePath:
    """
    Spec for the bowyer.cfg.load.from_filepath function.
    ...
    def it_returns_a_python_dict(self, filepath_cfg_yaml):
        ...
        assert isinstance(bowyer.cfg.load.from_filepath(filepath_cfg_yaml),
                          dict)
    ...
    def it_loads_a_single_yaml_file(self, dict_of_strings, filepath_cfg_yaml):
        ...
        check_match(bowyer.cfg.load.from_filepath(filepath_cfg_yaml),
                    dict_of_strings)
    ...
    def it_loads_a_single_json_file(self, dict_of_strings, filepath_cfg_json):
        ...
        check_match(bowyer.cfg.load.from_filepath(filepath_cfg_json),
                    dict_of_strings)
    ...
    def it_loads_a_single_xml_file(self, dict_of_strings, filepath_cfg_xml):
        ...
        check_match(bowyer.cfg.load.from_filepath(filepath_cfg_xml),
                    dict_of_strings)
...
class SpecifyLoad:
    """
    Spec for the bowyer.cfg.load function.
    ...
    def it_returns_a_python_dict(self, dirpath_cfg_yaml):
        ...
        assert isinstance(bowyer.cfg.load.from_dirpath(dirpath_cfg_yaml),
                          dict)
    ...
    def it_loads_a_directory_of_yaml_files(
        ...
        check_match(bowyer.cfg.load.from_dirpath(dirpath_cfg_yaml),
                    dict_of_strings)
    ...
    def it_loads_a_directory_of_json_files(
        ...
        check_match(bowyer.cfg.load.from_dirpath(dirpath_cfg_json),
                    dict_of_strings)
    ...
    def it_loads_a_directory_of_xml_files(
        ...
        check_match(bowyer.cfg.load.from_dirpath(dirpath_cfg_xml),
                    dict_of_strings)
...
def _iter_leaves(data_structure):
    ...
    """
    for pv_pair in bowyer.util.gen_path_value_pairs_depth_first(data_structure):
        (_, value) = pv_pair
