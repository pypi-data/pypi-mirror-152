# -*- coding: utf-8 -*-
"""
Functional specification for the bowyer.cfg.override module.
...
class SpecifyApply:
    ...
    def it_changes_nothing_when_no_override_is_given(
        ...
        """
        import bowyer.cfg.override  # pylint: disable=C0415

        cfg_orig = copy.deepcopy(valid_normalized_config)
        cfg_mod = bowyer.cfg.override.apply(valid_normalized_config, None)
    ...
    def it_can_override_a_single_field(self, valid_normalized_config):
        ...
        bowyer.cfg.override.apply(cfg, ('system.id_system', 'some_other_name'))
