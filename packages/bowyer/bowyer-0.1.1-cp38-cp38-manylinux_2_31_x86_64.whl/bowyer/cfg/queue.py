...
def denormalize(cfg):
    ...
    if 'queue' not in cfg:
        cfg['queue'] = dict()
        cfg['queue']['inter_process']     = 'bowyer.queue.multiprocessing'
        cfg['queue']['inter_host_server'] = 'bowyer.queue.zmq_server'
        cfg['queue']['inter_host_client'] = 'bowyer.queue.zmq_client'
    ...
    #      'to_node':   ('python',),
    #      'tags':      ('*',),
    #      'logic':     'bowyer.queue.zmq_server'},
    #     {'edge_type': 'inter_host_client',
    #      'from_node': ('python',),
    #      'to_node':   ('python',),
    #      'tags':      ('*',),
    #      'logic':     'bowyer.queue.zmq_client'},
    #     {'edge_type': 'inter_process_server',
    #      'from_node': ('python',),
    #      'to_node':   ('python',),
    #      'tags':      ('*',),
    #      'logic':     'bowyer.queue.multiprocessing'},
