# -*- coding: utf-8 -*-
"""
Functional specification for the bowyer.util.serialization module.
...
class SpecifySerialize:
    ...
    def it_returns_a_python_unicode_string(self):
        ...
        """
        import bowyer.util.serialization  # pylint: disable=C0415

        original = {'a': 1, 'b': 2, 'c': 3}
        encoded = bowyer.util.serialization.serialize(original)
...
class SpecifyDeserialize:
    ...
    def it_returns_a_python_dict(self):
        ...
        decoded = bowyer.util.serialization.deserialize(encoded)
