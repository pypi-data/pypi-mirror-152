...
##################### bb8064218275e501bed63e06786ae58e ##############################
...
class table:
    _info_group_ = """table"""
    _info_desc_ = """Access tables from casapy"""
    ### self
    ...
    def fromfits(self, tablename, fitsfile, whichhdu=int(1), storage='standard', convention='none', nomodify=True, ack=True):
        ...
        """
        return _wrap_table(swig_object=self._swigobj.fromfits(_str_ec(tablename), _str_ec(fitsfile), whichhdu, _str_ec(storage), _str_ec(convention), nomodify, ack))
    ...
    def fromascii(self, tablename, asciifile, headerfile='', autoheader=False, autoshape=[ int(-1) ], sep='', commentmarker='', firstline=int(0), lastline=int(-1), nomodify=True, columnnames=[  ], datatypes=[  ]):
        ...
        file.
        """
        return self._swigobj.fromascii(_str_ec(tablename), _str_ec(asciifile), _str_ec(headerfile), autoheader, autoshape, _str_ec(sep), _str_ec(commentmarker), firstline, lastline, nomodify, _str_ec(columnnames), _str_ec(datatypes))
    ...
    def create(self, tablename='', tabledesc={ }, lockoptions={ }, endianformat='', memtype='', nrow=int(0), dminfo={ }):
        ...
        hardly ever needed.
        """
        return self._swigobj.create(_str_ec(tablename), _dict_ec(tabledesc), _dict_ec(lockoptions), _str_ec(endianformat), _str_ec(memtype), nrow, _dict_ec(dminfo))
    ...
    def fromASDM(self, tablename, xmlfile):
        ...
        """
        return self._swigobj.fromASDM(_str_ec(tablename), _str_ec(xmlfile))
    ...
    def copy(self, newtablename, deep=False, valuecopy=False, dminfo={ }, endian='aipsrc', memorytable=False, returnobject=False, norows=False):
        ...
        """
        return _wrap_table(swig_object=self._swigobj.copy(_str_ec(newtablename), deep, valuecopy, _dict_ec(dminfo), _str_ec(endian), memorytable, returnobject, norows))
    ...
    def copyrows(self, outtable, startrowin=int(0), startrowout=int(-1), nrow=int(-1)):
        ...
        """
        return self._swigobj.copyrows(_str_ec(outtable), startrowin, startrowout, nrow)
    ...
    def lock(self, write=True, nattempts=int(0)):
        ...
        """
        return self._swigobj.lock(write, nattempts)
    ...
    def haslock(self, write=True):
        ...
        """
        return self._swigobj.haslock(write)
    ...
    def createmultitable(self, outputTableName, tables, subdirname):
        """
        """
        return self._swigobj.createmultitable(_str_ec(outputTableName), _str_ec(tables), _str_ec(subdirname))
    ...
    def toasciifmt(self, asciifile, headerfile='', columns=[  ], sep=''):
        ...
        """
        return self._swigobj.toasciifmt(_str_ec(asciifile), _str_ec(headerfile), _str_ec(columns), _str_ec(sep))
    ...
    def taql(self, taqlcommand='TaQL expression'):
        ...
        """
        return _wrap_table(swig_object=self._swigobj.taql(_str_ec(taqlcommand)))
    ...
    def query(self, query='String', name='', sortlist='', columns='', style=''):
        ...
        """
        return _wrap_table(swig_object=self._swigobj.query(_str_ec(query), _str_ec(name), _str_ec(sortlist), _str_ec(columns), _str_ec(style)))
    ...
    def calc(self, expr, prefix='using style base0, endincl, fortranorder', showtaql=False):
        ...
        """
        return _any_dc(self._swigobj.calc(_str_ec(expr), _str_ec(prefix), showtaql))
    ...
    def selectrows(self, rownrs, name=''):
        ...
        """
        return _wrap_table(swig_object=self._swigobj.selectrows(rownrs, _str_ec(name)))

    def info(self):
        """The info record contains information on the table.
        """
        return _dict_dc(self._swigobj.info())
    ...
    def putinfo(self, value):
        ...
        """
        return self._swigobj.putinfo(_dict_ec(value))
    ...
    def rownumbers(self, tab={ }, nbytes=int(0)):
        ...
        !!!NOTE INPUT PARAMETERS IGNORED!!!
        """
        return self._swigobj.rownumbers(_dict_ec(tab), nbytes)
    ...
    def setmaxcachesize(self, columnname, nbytes):
        ...
        """
        return self._swigobj.setmaxcachesize(_str_ec(columnname), nbytes)
    ...
    def isscalarcol(self, columnname):
        ...
        """
        return self._swigobj.isscalarcol(_str_ec(columnname))
    ...
    def isvarcol(self, columnname):
        ...
        """
        return self._swigobj.isvarcol(_str_ec(columnname))
    ...
    def coldatatype(self, columnname):
        ...
        """
        return _str_dc(self._swigobj.coldatatype(_str_ec(columnname)))
    ...
    def colarraytype(self, columnname):
        ...
        """
        return _str_dc(self._swigobj.colarraytype(_str_ec(columnname)))
    ...
    def addrows(self, nrow=int(1)):
        ...
        """
        return self._swigobj.addrows(nrow)
    ...
    def removerows(self, rownrs):
        ...
        """
        return self._swigobj.removerows(rownrs)
    ...
    def addcols(self, desc, dminfo={ }):
        ...
        columns to be added.
        """
        return self._swigobj.addcols(_dict_ec(desc), _dict_ec(dminfo))
    ...
    def renamecol(self, oldname, newname):
        ...
        """
        return self._swigobj.renamecol(_str_ec(oldname), _str_ec(newname))
    ...
    def removecols(self, columnames):
        ...
        """
        return self._swigobj.removecols(_str_ec(columnames))
    ...
    def iscelldefined(self, columnname, rownr=int(0)):
        ...
        empty cells.
        """
        return self._swigobj.iscelldefined(_str_ec(columnname), rownr)

    def getcell(self, columnname, rownr=int(0)):
        """A cell is the value at one row in one column. It may be a scalar
        or an array.
        """
        return _any_dc(self._swigobj.getcell(_str_ec(columnname), rownr))
    ...
    def getcellslice(self, columnname, rownr, blc, trc, incr=[ int(1) ]):
        ...
        """
        return _any_dc(self._swigobj.getcellslice(_str_ec(columnname), rownr, blc, trc, incr))
    ...
    def getcol(self, columnname, startrow=int(0), nrow=int(-1), rowincr=int(1)):
        ...
        shaped
        """
        return _any_dc(self._swigobj.getcol(_str_ec(columnname), startrow, nrow, rowincr))
    ...
    def getvarcol(self, columnname, startrow=int(0), nrow=int(-1), rowincr=int(1)):
        ...
        """
        return _dict_dc(self._swigobj.getvarcol(_str_ec(columnname), startrow, nrow, rowincr))
    ...
    def getcolslice(self, columnname, blc, trc, incr, startrow=int(0), nrow=int(-1), rowincr=int(1)):
        ...
        """
        return _any_dc(self._swigobj.getcolslice(_str_ec(columnname), blc, trc, incr, startrow, nrow, rowincr))

    def putcell(self, columnname, rownr, thevalue=[ ]):
        """A cell is the the value at one row in one column. It
        may be a scalar or an array.
        """
        return self._swigobj.putcell(_str_ec(columnname), rownr, _any_ec(thevalue))
    ...
    def putcellslice(self, columnname, rownr, value=[ ], blc=[ ], trc=[ ], incr=[ int(1) ]):
        ...
        (-1 in blc is equivalent to 0, so -1 is especially useful for trc).
        """
        return self._swigobj.putcellslice(_str_ec(columnname), rownr, _any_ec(value), blc, trc, incr)

    def putcol(self, columnname, value=[ ], startrow=int(0), nrow=int(-1), rowincr=int(1)):
        """
        """
        return self._swigobj.putcol(_str_ec(columnname), _any_ec(value), startrow, nrow, rowincr)
    ...
    def putvarcol(self, columnname, value, startrow=int(0), nrow=int(-1), rowincr=int(1)):
        ...
        """
        return self._swigobj.putvarcol(_str_ec(columnname), _dict_ec(value), startrow, nrow, rowincr)
    ...
    def putcolslice(self, columnname, value=[ ], blc=[ ], trc=[ ], incr=[ int(1) ], startrow=int(0), nrow=int(-1), rowincr=int(1)):
        ...
        blc and trc of the arrays in the column.
        """
        return self._swigobj.putcolslice(_str_ec(columnname), _any_ec(value), blc, trc, incr, startrow, nrow, rowincr)
    ...
    def getcolshapestring(self, columnname, startrow=int(0), nrow=int(-1), rowincr=int(1)):
        ...
        returned.
        """
        return _str_dc(self._swigobj.getcolshapestring(_str_ec(columnname), startrow, nrow, rowincr))
    ...
    def getkeyword(self, keyword=[ ]):
        ...
        """
        return _any_dc(self._swigobj.getkeyword(_any_ec(keyword)))
    ...
    def getkeywords(self):
        ...
        the table name prefixed by 'Table: '.
        """
        return _dict_dc(self._swigobj.getkeywords())
    ...
    def getcolkeyword(self, columnname, keyword=[ ]):
        ...
        read by separating the name with dots.
        """
        return _any_dc(self._swigobj.getcolkeyword(_str_ec(columnname), _any_ec(keyword)))
    ...
    def getcolkeywords(self, columnname):
        ...
        the table name prefixed by 'Table: '.
        """
        return _any_dc(self._swigobj.getcolkeywords(_str_ec(columnname)))
    ...
    def putkeyword(self, keyword=[ ], value=[ ], makesubrecord=False):
        ...
        """
        return self._swigobj.putkeyword(_any_ec(keyword), _any_ec(value), makesubrecord)
    ...
    def putcolkeyword(self, columnname, keyword=[ ], value=[ ]):
        ...
        In such a case intermediate records are created when needed.
        """
        return self._swigobj.putcolkeyword(_str_ec(columnname), _any_ec(keyword), _any_ec(value))
    ...
    def putcolkeywords(self, columnname, value):
        ...
        the subtable name prefixed by 'Table: '.
        """
        return self._swigobj.putcolkeywords(_str_ec(columnname), _dict_ec(value))

    def removekeyword(self, keyword=[ ]):
        """
        """
        return self._swigobj.removekeyword(_any_ec(keyword))

    def removecolkeyword(self, columnname, keyword=[ ]):
        """
        """
        return self._swigobj.removecolkeyword(_str_ec(columnname), _any_ec(keyword))
    ...
    def fieldnames(self, keyword=''):
        ...
        """
        return _str_dc(self._swigobj.fieldnames(_str_ec(keyword)))

    def colkeywordnames(self, columnname):
        """This function returns a vector of strings containing the names
        of all keywords in the column with the given name..
        """
        return _str_dc(self._swigobj.colkeywordnames(_str_ec(columnname)))
    ...
    def colfieldnames(self, columnname, keyword=''):
        ...
        are returned.
        """
        return _str_dc(self._swigobj.colfieldnames(_str_ec(columnname), _str_ec(keyword)))
    ...
    def getdesc(self, actual=True):
        ...
        """
        return _dict_dc(self._swigobj.getdesc(actual))
    ...
    def getcoldesc(self, columnname):
        ...
        """
        return _dict_dc(self._swigobj.getcoldesc(_str_ec(columnname)))
    ...
    def statistics(self, column, complex_value=''):
        ...
        """
        return _dict_dc(self._swigobj.statistics(_str_ec(column), _str_ec(complex_value)))

    def showcache(self, verbose=True):
        """Show the contents of the table cache.
        """
        return _str_dc(self._swigobj.showcache(verbose))
    ...
    def testincrstman(self, column):
        ...
        """
        return self._swigobj.testincrstman(_str_ec(column))
