...
##################### eabcda4e465af88325ac3d353eea91b4 ##############################
...
class imager:
    ...
    def advise(self, takeadvice=True, amplitudeloss=float(0.05), fieldofview=[ ]):
        ...
        """
        return self._swigobj.advise(takeadvice, amplitudeloss, _any_ec(fieldofview))
    ...
    def advisechansel(self, freqstart=float(1.0e6), freqend=float(1.1e6), freqstep=float(100.0), freqframe='LSRK', msname='', fieldid=int(0), getfreqrange=False, spwselection=''):
        ...
        """
        return _dict_dc(self._swigobj.advisechansel(freqstart, freqend, freqstep, _str_ec(freqframe), _str_ec(msname), fieldid, getfreqrange, _str_ec(spwselection)))

    def approximatepsf(self, psf=''):
        ...
        """
        return self._swigobj.approximatepsf(_str_ec(psf))

    def boxmask(self, mask='', blc=[ int(0),int(0),int(0),int(0) ], trc=[  ], value=float(1.0)):
        ...
        this requirement.
        """
        return self._swigobj.boxmask(_str_ec(mask), blc, trc, value)
    ...
    def calcuvw(self, fields=[ int(-1) ], refcode='', reuse=True):
        ...
        """
        return self._swigobj.calcuvw(fields, _str_ec(refcode), reuse)

    def clean(self, algorithm='clark', niter=int(1000), gain=float(0.1), threshold=[ ], displayprogress=False, model=[  ], keepfixed=[ bool(False) ], complist='', mask=[  ], image=[  ], residual=[  ], psfimage=[  ], interactive=False, npercycle=int(100), masktemplate=''):
        ...
        """
        return _dict_dc(self._swigobj.clean(_str_ec(algorithm), niter, gain, _any_ec(threshold), displayprogress, _str_ec(model), keepfixed, _str_ec(complist), _str_ec(mask), _str_ec(image), _str_ec(residual), _str_ec(psfimage), interactive, npercycle, _str_ec(masktemplate)))
    ...
    def clipimage(self, image='', threshold=[ ]):
        ...
        threshold.
        """
        return self._swigobj.clipimage(_str_ec(image), _any_ec(threshold))
    ...
    def clipvis(self, threshold=[ ]):
        ...
        data.
        """
        return self._swigobj.clipvis(_any_ec(threshold))
    ...
    def defineimage(self, nx=int(128), ny=int(-1), cellx=[ ], celly=[ ], stokes='I', phasecenter=[ ], mode='mfs', nchan=int(-1), start=[ ], step=[ ], spw=[ int(0) ], restfreq=[ ], outframe='LSRK', veltype='radio', facets=int(1), movingsource=[ ], distance=[ ], projection='SIN'):
        ...
        """
        return self._swigobj.defineimage(nx, ny, _any_ec(cellx), _any_ec(celly), _str_ec(stokes), _any_ec(phasecenter), _str_ec(mode), nchan, _any_ec(start), _any_ec(step), spw, _any_ec(restfreq), _str_ec(outframe), _str_ec(veltype), facets, _any_ec(movingsource), _any_ec(distance), _str_ec(projection))
    ...
    def drawmask(self, image='', mask='', niter=int(0), npercycle=int(0), threshold='0 mJy'):
        ...
        """
        return _dict_dc(self._swigobj.drawmask(_str_ec(image), _str_ec(mask), niter, npercycle, _str_ec(threshold)))
    ...
    def exprmask(self, mask='', expr=float(1.0)):
        ...
        """
        return self._swigobj.exprmask(_str_ec(mask), expr)

    def feather(self, image='', highres='', lowres='', lowpsf='', effdishdiam=float(-1.0), lowpassfiltersd=False):
        ...
        """
        return self._swigobj.feather(_str_ec(image), _str_ec(highres), _str_ec(lowres), _str_ec(lowpsf), effdishdiam, lowpassfiltersd)

    def filter(self, type='gaussian', bmaj=[ ], bmin=[ ], bpa=[ ]):
        ...
        imager.fitpsf.
        """
        return self._swigobj.filter(_str_ec(type), _any_ec(bmaj), _any_ec(bmin), _any_ec(bpa))
    ...
    def fitpsf(self, psf):
        ...
        """
        return self._swigobj.fitpsf(_str_ec(psf))
    ...
    def fixvis(self, fields=[ int(-1) ], phasedirs=[  ], refcode='', distances=[ float(0.0) ], datacolumn='all'):
        ...
        """
        return self._swigobj.fixvis(fields, _str_ec(phasedirs), _str_ec(refcode), distances, _str_ec(datacolumn))
    ...
    def ft(self, model=[  ], complist='', incremental=False, phasecentertime=float(-1.0)):
        ...
        """
        return self._swigobj.ft(_str_ec(model), _str_ec(complist), incremental, phasecentertime)
    ...
    def getweightgrid(self, type='imaging', wgtimages=[  ]):
        ...
        """
        return _any_dc(self._swigobj.getweightgrid(_str_ec(type), _str_ec(wgtimages)))

    def linearmosaic(self, images=[  ], mosaic='', fluxscale='', sensitivity='', fieldids=[ int(0) ], usedefaultvp=True, vptable=''):
        ...
        """
        return self._swigobj.linearmosaic(_str_ec(images), _str_ec(mosaic), _str_ec(fluxscale), _str_ec(sensitivity), fieldids, usedefaultvp, _str_ec(vptable))
    ...
    def make(self, image=''):
        ...
        vector of strings.
        """
        return self._swigobj.make(_str_ec(image))
    ...
    def predictcomp(self, objname='', standard='', epoch=[ ], freqs=[ float(1.0e11) ], pfx='predictcomp'):
        ...
        """
        return _str_dc(self._swigobj.predictcomp(_str_ec(objname), _str_ec(standard), _any_ec(epoch), freqs, _str_ec(pfx)))

    def makeimage(self, type='observed', image='', compleximage='', verbose=True):
        ...
        """
        return self._swigobj.makeimage(_str_ec(type), _str_ec(image), _str_ec(compleximage), verbose)
    ...
    def makemodelfromsd(self, sdimage='', modelimage='', sdpsf='', maskimage=''):
        ...
        """
        return self._swigobj.makemodelfromsd(_str_ec(sdimage), _str_ec(modelimage), _str_ec(sdpsf), _str_ec(maskimage))

    def mask(self, image='', mask='', threshold=[ ]):
        """A mask image is an image with the same shape as the other images but
        ...
        """
        return self._swigobj.mask(_str_ec(image), _str_ec(mask), _any_ec(threshold))

    def mem(self, algorithm='entropy', niter=int(20), sigma=[ ], targetflux=[ ], constrainflux=False, displayprogress=False, model=[  ], keepfixed=[ bool(False) ], complist='', prior=[  ], mask=[  ], image=[  ], residual=[  ]):
        ...
        may be acceptable.
        """
        return self._swigobj.mem(_str_ec(algorithm), niter, _any_ec(sigma), _any_ec(targetflux), constrainflux, displayprogress, _str_ec(model), keepfixed, _str_ec(complist), _str_ec(prior), _str_ec(mask), _str_ec(image), _str_ec(residual))

    def nnls(self, model=[  ], keepfixed=[ bool(False) ], complist='', niter=int(0), tolerance=float(1e-06), fluxmask=[  ], datamask=[  ], image=[  ], residual=[  ]):
        ...
        """
        return self._swigobj.nnls(_str_ec(model), keepfixed, _str_ec(complist), niter, tolerance, _str_ec(fluxmask), _str_ec(datamask), _str_ec(image), _str_ec(residual))
    ...
    def open(self, thems='', compress=False, usescratch=False):
        ...
        the data selection.
        """
        return self._swigobj.open(_str_ec(thems), compress, usescratch)

    def pb(self, inimage='', outimage='', incomps='', outcomps='', operation='apply', pointingcenter=[ ], parangle=[ ], pborvp='pb'):
        ...
        """
        return self._swigobj.pb(_str_ec(inimage), _str_ec(outimage), _str_ec(incomps), _str_ec(outcomps), _str_ec(operation), _any_ec(pointingcenter), _any_ec(parangle), _str_ec(pborvp))

    def plotsummary(self):
        """Performs a simple plot of the field and spectral window IDs
        versus time (after sorting).
        """
        return self._swigobj.plotsummary()
    ...
    def plotweights(self, gridded=False, increment=int(1)):
        ...
        """
        return self._swigobj.plotweights(gridded, increment)
    ...
    def regionmask(self, mask='', region={ }, boxes=[ ], circles=[ ], value=float(1.0)):
        ...
        """
        return self._swigobj.regionmask(_str_ec(mask), _dict_ec(region), _any_ec(boxes), _any_ec(circles), value)
    ...
    def regiontoimagemask(self, mask='', region={ }, boxes=[ ], circles=[ ], value=float(1.0)):
        ...
        """
        return self._swigobj.regiontoimagemask(_str_ec(mask), _dict_ec(region), _any_ec(boxes), _any_ec(circles), value)

    def residual(self, model=[  ], complist='', image=[  ]):
        """Calculate the residuals corresponding to the model and
        componentlist. {em Note that the model visibilities are updated}.
        """
        return self._swigobj.residual(_str_ec(model), _str_ec(complist), _str_ec(image))

    def restore(self, model=[  ], complist='', image=[  ], residual=[  ]):
        ...
        parameters.
        """
        return self._swigobj.restore(_str_ec(model), _str_ec(complist), _str_ec(image), _str_ec(residual))
    ...
    def updateresidual(self, model=[  ], complist='', image=[  ], residual=[  ]):
        ...
        """
        return self._swigobj.updateresidual(_str_ec(model), _str_ec(complist), _str_ec(image), _str_ec(residual))
    ...
    def sensitivity(self):
        ...
        """
        return self._swigobj.sensitivity()
    ...
    def setbeam(self, bmaj=[ ], bmin=[ ], bpa=[ ]):
        """This sets the clean beam that will be used in all restoration
        operations.
        """
        return self._swigobj.setbeam(_any_ec(bmaj), _any_ec(bmin), _any_ec(bpa))
    ...
    def selectvis(self, vis='', nchan=[ int(-1) ], start=[ int(0) ], step=[ int(1) ], spw=[ ], field=[ ], baseline=[ ], time=[ ], scan=[ ], intent='', observation=[ ], uvrange=[ ], taql='', usescratch=False, datainmemory=False, writeaccess=True):
        ...
        """
        return self._swigobj.selectvis(_str_ec(vis), nchan, start, step, _any_ec(spw), _any_ec(field), _any_ec(baseline), _any_ec(time), _any_ec(scan), _str_ec(intent), _any_ec(observation), _any_ec(uvrange), _str_ec(taql), usescratch, datainmemory, writeaccess)
    ...
    def setjy(self, field=[ ], spw=[ ], modimage='', fluxdensity=[ float(0.0),float(0.0),float(0.0),float(0.0) ], standard='SOURCE', scalebychan=False, spix=[ float(0.0) ], reffreq=[ ], polindex=[ float(0.0) ], polangle=[ float(0.0) ], rotmeas=float(0.0), time='', scan='', intent='', observation='', interpolation='nearest'):
        ...
        """
        return _dict_dc(self._swigobj.setjy(_any_ec(field), _any_ec(spw), _str_ec(modimage), fluxdensity, _str_ec(standard), scalebychan, spix, _any_ec(reffreq), polindex, polangle, rotmeas, _str_ec(time), _str_ec(scan), _str_ec(intent), _str_ec(observation), _str_ec(interpolation)))
    ...
    def setmfcontrol(self, cyclefactor=float(1.5), cyclespeedup=float(-1), cyclemaxpsffraction=float(0.8), stoplargenegatives=int(2), stoppointmode=int(-1), minpb=float(0.1), scaletype='NONE', constpb=float(0.4), fluxscale=[  ], flatnoise=True):
        ...
        """
        return self._swigobj.setmfcontrol(cyclefactor, cyclespeedup, cyclemaxpsffraction, stoplargenegatives, stoppointmode, minpb, _str_ec(scaletype), constpb, _str_ec(fluxscale), flatnoise)
    ...
    def setoptions(self, ftmachine='ft', cache=int(-1), tile=int(16), gridfunction='SF', location=[ ], padding=float(1.0), freqinterp='nearest', wprojplanes=int(-1), epjtablename='', applypointingoffsets=False, dopbgriddingcorrections=True, cfcachedirname='', rotpastep=float(5.0), pastep=float(360.0), pblimit=float(0.05), imagetilevol=int(0), singleprecisiononly=False, numthreads=int(-1), psterm=True, aterm=True, mterm=True, wbawp=False, conjbeams=True):
        ...
        """
        return self._swigobj.setoptions(_str_ec(ftmachine), cache, tile, _str_ec(gridfunction), _any_ec(location), padding, _str_ec(freqinterp), wprojplanes, _str_ec(epjtablename), applypointingoffsets, dopbgriddingcorrections, _str_ec(cfcachedirname), rotpastep, pastep, pblimit, imagetilevol, singleprecisiononly, numthreads, psterm, aterm, mterm, wbawp, conjbeams)
    ...
    def setscales(self, scalemethod='nscales', nscales=int(5), uservector=[ float(0.0),float(3.0),float(10.0) ]):
        ...
        first value is zero.
        """
        return self._swigobj.setscales(_str_ec(scalemethod), nscales, uservector)

    def setsmallscalebias(self, inbias=float(0.6)):
        """
        """
        return self._swigobj.setsmallscalebias(inbias)
    ...
    def settaylorterms(self, ntaylorterms=int(2), reffreq=float(0.0)):
        ...
        """
        return self._swigobj.settaylorterms(ntaylorterms, reffreq)
    ...
    def setsdoptions(self, scale=float(1.0), weight=float(1.0), convsupport=int(-1), pointingcolumntouse='DIRECTION', truncate=[ ], gwidth=[ ], jwidth=[ ], minweight=float(0.), clipminmax=False):
        ...
        """
        return self._swigobj.setsdoptions(scale, weight, convsupport, _str_ec(pointingcolumntouse), _any_ec(truncate), _any_ec(gwidth), _any_ec(jwidth), minweight, clipminmax)
    ...
    def setvp(self, dovp=False, usedefaultvp=True, vptable='', dosquint=False, parangleinc=[ ], skyposthreshold=[ ], telescope='', verbose=True):
        ...
        """
        return self._swigobj.setvp(dovp, usedefaultvp, _str_ec(vptable), dosquint, _any_ec(parangleinc), _any_ec(skyposthreshold), _str_ec(telescope), verbose)
    ...
    def setweightgrid(self, weight=[ ], type='imaging'):
        ...
        are parallelizing at the scripting level.
        """
        return self._swigobj.setweightgrid(_any_ec(weight), _str_ec(type))

    def smooth(self, model=[  ], image=[  ], usefit=True, bmaj=[ ], bmin=[ ], bpa=[ ], normalize=True):
        ...
        not normalized.
        """
        return self._swigobj.smooth(_str_ec(model), _str_ec(image), usefit, _any_ec(bmaj), _any_ec(bmin), _any_ec(bpa), normalize)

    def stop(self):
        """Stop the currently executing function as soon as possible. Note that
        it is not always possible to stop a function.
        """
        return self._swigobj.stop()
    ...
    def uvrange(self, uvmin=float(0.0), uvmax=float(0.0)):
        ...
        """
        return self._swigobj.uvrange(uvmin, uvmax)

    def weight(self, type='natural', rmode='none', noise=[ ], robust=float(0.0), fieldofview=[ ], npixels=int(0), mosaic=False):
        ...
        """
        return self._swigobj.weight(_str_ec(type), _str_ec(rmode), _any_ec(noise), robust, _any_ec(fieldofview), npixels, mosaic)

    def mapextent(self, ref='J2000', movingsource='', pointingcolumntouse='DIRECTION'):
        """TODO: description must be filled
        """
        return _dict_dc(self._swigobj.mapextent(_str_ec(ref), _str_ec(movingsource), _str_ec(pointingcolumntouse)))
    ...
    def pointingsampling(self, pattern='raster', ref='J2000', movingsource='', pointingcolumntouse='DIRECTION', antenna=''):
        ...
        """
        return _dict_dc(self._swigobj.pointingsampling(_str_ec(pattern), _str_ec(ref), _str_ec(movingsource), _str_ec(pointingcolumntouse), _str_ec(antenna)))
