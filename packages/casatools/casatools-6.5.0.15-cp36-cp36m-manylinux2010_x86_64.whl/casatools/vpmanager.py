...
class vpmanager:
    ...
    def setcannedpb(self, telescope='VLA', othertelescope='', dopb=True, commonpb='DEFAULT', dosquint=False, paincrement=[ ], usesymmetricbeam=False):
        ...
        """
        return _dict_dc(self._swigobj.setcannedpb(_str_ec(telescope), _str_ec(othertelescope), dopb, _str_ec(commonpb), dosquint, _any_ec(paincrement), usesymmetricbeam))
    ...
    def setpbairy(self, telescope='VLA', othertelescope='', dopb=True, dishdiam=[ ], blockagediam=[ ], maxrad=[ ], reffreq=[ ], squintdir=[ ], squintreffreq=[ ], dosquint=False, paincrement=[ ], usesymmetricbeam=False):
        ...
        """
        return _dict_dc(self._swigobj.setpbairy(_str_ec(telescope), _str_ec(othertelescope), dopb, _any_ec(dishdiam), _any_ec(blockagediam), _any_ec(maxrad), _any_ec(reffreq), _any_ec(squintdir), _any_ec(squintreffreq), dosquint, _any_ec(paincrement), usesymmetricbeam))
    ...
    def setpbcospoly(self, telescope='VLA', othertelescope='', dopb=True, coeff=[ float(-1) ], scale=[ float(-1) ], maxrad=[ ], reffreq=[ ], isthispb='PB', squintdir=[ ], squintreffreq=[ ], dosquint=False, paincrement=[ ], usesymmetricbeam=False):
        ...
        """
        return _dict_dc(self._swigobj.setpbcospoly(_str_ec(telescope), _str_ec(othertelescope), dopb, coeff, scale, _any_ec(maxrad), _any_ec(reffreq), _str_ec(isthispb), _any_ec(squintdir), _any_ec(squintreffreq), dosquint, _any_ec(paincrement), usesymmetricbeam))
    ...
    def setpbgauss(self, telescope='VLA', othertelescope='', dopb=True, halfwidth=[ ], maxrad=[ ], reffreq=[ ], isthispb='PB', squintdir=[ ], squintreffreq=[ ], dosquint=False, paincrement=[ ], usesymmetricbeam=False):
        ...
        """
        return _dict_dc(self._swigobj.setpbgauss(_str_ec(telescope), _str_ec(othertelescope), dopb, _any_ec(halfwidth), _any_ec(maxrad), _any_ec(reffreq), _str_ec(isthispb), _any_ec(squintdir), _any_ec(squintreffreq), dosquint, _any_ec(paincrement), usesymmetricbeam))
    ...
    def setpbinvpoly(self, telescope='VLA', othertelescope='', dopb=True, coeff=[ float(-1) ], maxrad=[ ], reffreq=[ ], isthispb='PB', squintdir=[ ], squintreffreq=[ ], dosquint=False, paincrement=[ ], usesymmetricbeam=False):
        ...
        """
        return _dict_dc(self._swigobj.setpbinvpoly(_str_ec(telescope), _str_ec(othertelescope), dopb, coeff, _any_ec(maxrad), _any_ec(reffreq), _str_ec(isthispb), _any_ec(squintdir), _any_ec(squintreffreq), dosquint, _any_ec(paincrement), usesymmetricbeam))
    ...
    def setpbnumeric(self, telescope='VLA', othertelescope='', dopb=True, vect=[ float(-1) ], maxrad=[ ], reffreq=[ ], isthispb='PB', squintdir=[ ], squintreffreq=[ ], dosquint=False, paincrement=[ ], usesymmetricbeam=False):
        ...
        """
        return _dict_dc(self._swigobj.setpbnumeric(_str_ec(telescope), _str_ec(othertelescope), dopb, vect, _any_ec(maxrad), _any_ec(reffreq), _str_ec(isthispb), _any_ec(squintdir), _any_ec(squintreffreq), dosquint, _any_ec(paincrement), usesymmetricbeam))
    ...
    def setpbimage(self, telescope='VLA', othertelescope='', dopb=True, realimage='', imagimage='', compleximage='', antnames=[ '*' ]):
        ...
        """
        return _dict_dc(self._swigobj.setpbimage(_str_ec(telescope), _str_ec(othertelescope), dopb, _str_ec(realimage), _str_ec(imagimage), _str_ec(compleximage), _str_ec(antnames)))
    ...
    def setpbpoly(self, telescope='VLA', othertelescope='', dopb=True, coeff=[ float(-1) ], maxrad=[ ], reffreq=[ ], isthispb='PB', squintdir=[ ], squintreffreq=[ ], dosquint=False, paincrement=[ ], usesymmetricbeam=False):
        ...
        """
        return _dict_dc(self._swigobj.setpbpoly(_str_ec(telescope), _str_ec(othertelescope), dopb, coeff, _any_ec(maxrad), _any_ec(reffreq), _str_ec(isthispb), _any_ec(squintdir), _any_ec(squintreffreq), dosquint, _any_ec(paincrement), usesymmetricbeam))
    ...
    def setpbantresptable(self, telescope='', othertelescope='', dopb=True, antresppath=''):
        ...
        """
        return self._swigobj.setpbantresptable(_str_ec(telescope), _str_ec(othertelescope), dopb, _str_ec(antresppath))
    ...
    def setuserdefault(self, vplistnum=int(-1), telescope='', anttype=''):
        ...
        """
        return self._swigobj.setuserdefault(vplistnum, _str_ec(telescope), _str_ec(anttype))

    def getuserdefault(self, telescope='', anttype=''):
        """Get the vp list number of the present default VP/PB for the given parameters.
        """
        return self._swigobj.getuserdefault(_str_ec(telescope), _str_ec(anttype))

    def getanttypes(self, telescope='', obstime=[ ], freq=[ ], obsdirection=[ ]):
        """Get a list of the available antenna types.
        """
        return _str_dc(self._swigobj.getanttypes(_str_ec(telescope), _any_ec(obstime), _any_ec(freq), _any_ec(obsdirection)))
    ...
    def numvps(self, telescope='', obstime=[ ], freq=[ ], obsdirection=[ ]):
        ...
        """
        return self._swigobj.numvps(_str_ec(telescope), _any_ec(obstime), _any_ec(freq), _any_ec(obsdirection))
    ...
    def getvp(self, telescope='', antennatype='', obstime=[ ], freq=[ ], obsdirection='AZEL 0deg 90deg'):
        ...
        """
        return _dict_dc(self._swigobj.getvp(_str_ec(telescope), _str_ec(antennatype), _any_ec(obstime), _any_ec(freq), _any_ec(obsdirection)))
    ...
    def getvps(self, telescope='', antennas=[  ], obstimestart='1970/01/01T00:00:00', obstimeend='1970/01/01T00:00:00', minfreq='1GHz', maxfreq='1GHz', obsdirection='AZEL 0deg 90deg'):
        """Record is empty if no matching vp/pb could be found.
        """
        return _dict_dc(self._swigobj.getvps(_str_ec(telescope), _str_ec(antennas), _any_ec(obstimestart), _any_ec(obstimeend), _any_ec(minfreq), _any_ec(maxfreq), _any_ec(obsdirection)))
    ...
    def createantresp(self, imdir='', starttime='', bandnames=[  ], bandminfreq=[  ], bandmaxfreq=[  ]):
        ...
        """
        return self._swigobj.createantresp(_str_ec(imdir), _str_ec(starttime), _str_ec(bandnames), _str_ec(bandminfreq), _str_ec(bandmaxfreq))
    ...
    def getrespimagename(self, telescope='', starttime='', frequency='', functype='ANY', anttype='', azimuth='0deg', elevation='45deg', rectype='', beamnumber=int(0)):
        ...
        """
        return _str_dc(self._swigobj.getrespimagename(_str_ec(telescope), _str_ec(starttime), _str_ec(frequency), _str_ec(functype), _str_ec(anttype), _str_ec(azimuth), _str_ec(elevation), _str_ec(rectype), beamnumber))
