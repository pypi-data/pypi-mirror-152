...
##################### 6df432cdba5850abeb861ce7ec8b1d64 ##############################
from __future__ import absolute_import 
from .__casac__ import simulator as _simulator
...
class simulator:
    ...
    def open(self, ms=''):
        ...
        """
        return self._swigobj.open(_str_ec(ms))
    ...
    def openfromms(self, ms=''):
        ...
        """
        return self._swigobj.openfromms(_str_ec(ms))
    ...
    def settimes(self, integrationtime=[ ], usehourangle=True, referencetime=[ ]):
        ...
        """
        return self._swigobj.settimes(_any_ec(integrationtime), usehourangle, _any_ec(referencetime))
    ...
    def observe(self, sourcename='', spwname='', starttime=[ ], stoptime=[ ], add_observation=False, state_sig=True, state_ref=False, state_cal=float(0.0), state_load=float(0.0), state_sub_scan=int(0), state_obs_mode='OBSERVE_TARGET.ON_SOURCE', observer='CASA simulator', project='CASA simulation'):
        ...
        """
        return self._swigobj.observe(_str_ec(sourcename), _str_ec(spwname), _any_ec(starttime), _any_ec(stoptime), add_observation, state_sig, state_ref, state_cal, state_load, state_sub_scan, _str_ec(state_obs_mode), _str_ec(observer), _str_ec(project))
    ...
    def observemany(self, sourcenames=[  ], spwname='', starttimes=[ '0s' ], stoptimes=[ '3600s' ], directions=[ '' ], add_observation=False, state_sig=True, state_ref=False, state_cal=float(0.0), state_load=float(0.0), state_sub_scan=int(0), state_obs_mode='OBSERVE_TARGET#ON_SOURCE', observer='CASA simulator', project='CASA simulation'):
        ...
        """
        return self._swigobj.observemany(_str_ec(sourcenames), _str_ec(spwname), _str_ec(starttimes), _str_ec(stoptimes), _str_ec(directions), add_observation, state_sig, state_ref, state_cal, state_load, state_sub_scan, _str_ec(state_obs_mode), _str_ec(observer), _str_ec(project))
    ...
    def setlimits(self, shadowlimit=float(1e-6), elevationlimit=[ ]):
        ...
        """
        return self._swigobj.setlimits(shadowlimit, _any_ec(elevationlimit))
    ...
    def setconfig(self, telescopename='VLA', x=[ float(0) ], y=[ float(0) ], z=[ float(0) ], dishdiameter=[ float(0) ], offset=[ float(0) ], mount=[ 'ALT-AZ' ], antname=[ 'A' ], padname=[ 'P' ], coordsystem='global', referencelocation=[ ]):
        ...
        """
        return self._swigobj.setconfig(_str_ec(telescopename), x, y, z, dishdiameter, offset, _str_ec(mount), _str_ec(antname), _str_ec(padname), _str_ec(coordsystem), _any_ec(referencelocation))
    ...
    def setfeed(self, mode='', x=[ float(0) ], y=[ float(0) ], pol=[ 'R' ]):
        ...
        """
        return self._swigobj.setfeed(_str_ec(mode), x, y, _str_ec(pol))
    ...
    def setfield(self, sourcename='SOURCE', sourcedirection=[ ], calcode='', distance=[ ]):
        ...
        """
        return self._swigobj.setfield(_str_ec(sourcename), _any_ec(sourcedirection), _str_ec(calcode), _any_ec(distance))
    ...
    def setmosaicfield(self, sourcename='SOURCE', calcode='', fieldcenter=[ ], xmosp=int(1), ymosp=int(1), mosspacing=[ ], distance=[ ]):
        ...
        """
        return self._swigobj.setmosaicfield(_str_ec(sourcename), _str_ec(calcode), _any_ec(fieldcenter), xmosp, ymosp, _any_ec(mosspacing), _any_ec(distance))
    ...
    def setspwindow(self, spwname='XBAND', freq=[ ], deltafreq=[ ], freqresolution=[ ], refcode='TOPO', nchannels=int(1), stokes='RR LL'):
        ...
        """
        return self._swigobj.setspwindow(_str_ec(spwname), _any_ec(freq), _any_ec(deltafreq), _any_ec(freqresolution), _str_ec(refcode), nchannels, _str_ec(stokes))
    ...
    def setdata(self, spwid=[ int(0) ], fieldid=[ int(0) ], msselect=''):
        ...
        """
        return self._swigobj.setdata(spwid, fieldid, _str_ec(msselect))
    ...
    def predict(self, imagename=[  ], complist='', incremental=False):
        ...
        """
        return self._swigobj.predict(_str_ec(imagename), _str_ec(complist), incremental)
    ...
    def setoptions(self, ftmachine='ft', cache=int(0), tile=int(16), gridfunction='SF', location=[ ], padding=float(1.3), facets=int(1), maxdata=float(2000.0), wprojplanes=int(1)):
        ...
        """
        return self._swigobj.setoptions(_str_ec(ftmachine), cache, tile, _str_ec(gridfunction), _any_ec(location), padding, facets, maxdata, wprojplanes)
    ...
    def setvp(self, dovp=True, usedefaultvp=True, vptable='', dosquint=True, parangleinc=[ ], skyposthreshold=[ ], pblimit=float(1.0e-2)):
        ...
        """
        return self._swigobj.setvp(dovp, usedefaultvp, _str_ec(vptable), dosquint, _any_ec(parangleinc), _any_ec(skyposthreshold), pblimit)
    ...
    def setbandpass(self, mode='calculate', table='', interval=[ ], amplitude=[ float(0.0) ]):
        ...
        """
        return self._swigobj.setbandpass(_str_ec(mode), _str_ec(table), _any_ec(interval), amplitude)
    ...
    def setapply(self, table='', type='', t=float(0.0), field=[ ], interp='linear', calwt=False, spwmap=[ int(-1) ], opacity=float(0.0)):
        ...
        """
        return self._swigobj.setapply(_str_ec(table), _str_ec(type), t, _any_ec(field), _str_ec(interp), calwt, spwmap, opacity)
    ...
    def setgain(self, mode='fbm', table='', interval=[ ], amplitude=[ float(0.01) ]):
        ...
        """
        return self._swigobj.setgain(_str_ec(mode), _str_ec(table), _any_ec(interval), amplitude)

    def settrop(self, mode='screen', table='', pwv=float(3.0), deltapwv=float(0.15), beta=float(1.1), windspeed=float(7.)):
        """Set up for corruption by the atmosphere - attenuation and increase in
        noise.
        
        """
        return self._swigobj.settrop(_str_ec(mode), _str_ec(table), pwv, deltapwv, beta, windspeed)
    ...
    def setpointingerror(self, epjtablename='', applypointingoffsets=False, dopbcorrection=False):
        ...
        """
        return self._swigobj.setpointingerror(_str_ec(epjtablename), applypointingoffsets, dopbcorrection)
    ...
    def setleakage(self, mode='constant', table='', amplitude=[ float(0.01) ], offset=[ float(0.) ]):
        ...
        """
        return self._swigobj.setleakage(_str_ec(mode), _str_ec(table), amplitude, offset)
    ...
    def oldsetnoise(self, mode='calculate', table='', simplenoise=[ ], antefficiency=float(0.8), correfficiency=float(0.85), spillefficiency=float(0.85), tau=float(0.1), trx=float(50), tatmos=float(230.0), tcmb=float(2.7)):
        ...
        *epsilon_q *epsilon_a *pi *D^2 *sqrt(dnu*dt)``
        ...
        """
        return self._swigobj.oldsetnoise(_str_ec(mode), _str_ec(table), _any_ec(simplenoise), antefficiency, correfficiency, spillefficiency, tau, trx, tatmos, tcmb)
    ...
    def setnoise(self, mode='simplenoise', table='', simplenoise=[ ], pground=[ ], relhum=float(20.0), altitude=[ ], waterheight=[ ], pwv=[ ], tatmos=float(250.0), tau=float(0.1), antefficiency=float(0.8), spillefficiency=float(0.85), correfficiency=float(0.88), trx=float(50), tground=float(270.0), tcmb=float(2.73), OTF=True, senscoeff=float(0.), rxtype=int(0)):
        ...
        *epsilon_q *epsilon_a *pi *D^2 *sqrt(dnu*dt)``
        ...
        """
        return self._swigobj.setnoise(_str_ec(mode), _str_ec(table), _any_ec(simplenoise), _any_ec(pground), relhum, _any_ec(altitude), _any_ec(waterheight), _any_ec(pwv), tatmos, tau, antefficiency, spillefficiency, correfficiency, trx, tground, tcmb, OTF, senscoeff, rxtype)

    def setpa(self, mode='calculate', table='', interval=[ ]):
        """Corrupt phase by the parallactic angle
        
        """
        return self._swigobj.setpa(_str_ec(mode), _str_ec(table), _any_ec(interval))
