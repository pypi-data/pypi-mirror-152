...
##################### f98fed48f3c8d29fc82bed870cd6ed23 ##############################
...
class calibrater:
    _info_group_ = """calibrater"""
    _info_desc_ = """Synthesis calibration (self- and cross-)"""
    ### self
    ...
    def open(self, filename, compress=False, addcorr=True, addmodel=True):
        ...
        other methods.
        """
        return self._swigobj.open(_str_ec(filename), compress, addcorr, addmodel)
    ...
    def selectvis(self, time=[ ], spw=[ ], scan=[ ], field=[ ], intent=[ ], observation=[ ], baseline=[ ], uvrange=[ ], chanmode='none', nchan=int(1), start=int(0), step=int(1), mstart={'value': float(0.0), 'unit': 'km/s'}, mstep={'value': float(0.0), 'unit': 'km/s'}, msselect=''):
        ...
        """
        return self._swigobj.selectvis(_any_ec(time), _any_ec(spw), _any_ec(scan), _any_ec(field), _any_ec(intent), _any_ec(observation), _any_ec(baseline), _any_ec(uvrange), _str_ec(chanmode), nchan, start, step, _quant_ec(mstart), _quant_ec(mstep), _str_ec(msselect))
    ...
    def setmodel(self, modelimage):
        ...
        """
        return self._swigobj.setmodel(_str_ec(modelimage))
    ...
    def setptmodel(self, stokes=[ float(0.0),float(0.0),float(0.0),float(0.0) ]):
        ...
        """
        return self._swigobj.setptmodel(stokes)
    ...
    def setapply(self, type='', t=float(0.0), table='', field=[ ], interp='linear', select='', calwt=False, spwmap=[ int(-1) ], opacity=[ float(0.0) ]):
        ...
        """
        return self._swigobj.setapply(_str_ec(type), t, _str_ec(table), _any_ec(field), _str_ec(interp), _str_ec(select), calwt, spwmap, opacity)

    def setcallib(self, callib={ }):
        """TBD
        """
        return self._swigobj.setcallib(_dict_ec(callib))

    def validatecallib(self, callib={ }):
        """TBD
        """
        return self._swigobj.validatecallib(_dict_ec(callib))

    def setsolve(self, type='MF', t=[ ], table='', append=False, preavg=float(-1.0), phaseonly=False, apmode='AP', refant=[ ], refantmode='flex', minblperant=int(4), solnorm=False, normtype='mean', minsnr=float(0.0), combine='', fillgaps=int(0), cfcache='', painc=float(360.0), fitorder=int(0), fraction=float(0.1), numedge=int(-1), radius='', smooth=True, zerorates=False, globalsolve=True, niter=int(100), delaywindow=[  ], ratewindow=[  ], paramactive=[  ], solmode='', rmsthresh=[  ]):
        ...
        """
        return self._swigobj.setsolve(_str_ec(type), _any_ec(t), _str_ec(table), append, preavg, phaseonly, _str_ec(apmode), _any_ec(refant), _str_ec(refantmode), minblperant, solnorm, _str_ec(normtype), minsnr, _str_ec(combine), fillgaps, _str_ec(cfcache), painc, fitorder, fraction, numedge, _str_ec(radius), smooth, zerorates, globalsolve, niter, delaywindow, ratewindow, paramactive, _str_ec(solmode), rmsthresh)
    ...
    def setsolvegainspline(self, table='', append=False, mode='PHAS', splinetime=float(10800), preavg=float(0.0), npointaver=int(10), phasewrap=float(250), refant=[ ]):
        ...
        """
        return self._swigobj.setsolvegainspline(_str_ec(table), append, _str_ec(mode), splinetime, preavg, npointaver, phasewrap, _any_ec(refant))
    ...
    def setsolvebandpoly(self, table='', append=False, t=[ ], combine='', degamp=int(3), degphase=int(3), visnorm=False, solnorm=True, maskcenter=int(0), maskedge=float(5.0), refant=[ ]):
        ...
        """
        return self._swigobj.setsolvebandpoly(_str_ec(table), append, _any_ec(t), _str_ec(combine), degamp, degphase, visnorm, solnorm, maskcenter, maskedge, _any_ec(refant))
    ...
    def returndict(self):
        ...
        """
        return _dict_dc(self._swigobj.returndict())
    ...
    def initcalset(self, calset=int(0)):
        ...
        purposes is deleted
        """
        return self._swigobj.initcalset(calset)
    ...
    def delmod(self, otf=False, field=[ ], spw=[ ], scr=False):
        ...
        """
        return self._swigobj.delmod(otf, _any_ec(field), _any_ec(spw), scr)
    ...
    def correct(self, applymode=''):
        ...
        """
        return self._swigobj.correct(_str_ec(applymode))
    ...
    def initweights(self, wtmode='nyq', dowtsp=False, tsystable='', gainfield='', interp='', spwmap=[  ]):
        ...
        """
        return self._swigobj.initweights(_str_ec(wtmode), dowtsp, _str_ec(tsystable), _str_ec(gainfield), _str_ec(interp), spwmap)
    ...
    def fluxscale(self, tablein, reference=[ ], tableout='', transfer=[ ], listfile='', append=False, refspwmap=[ int(-1) ], gainthreshold=float(-1.0), antenna='', timerange='', scan='', incremental=False, fitorder=int(1), display=False):
        ...
        """
        return _dict_dc(self._swigobj.fluxscale(_str_ec(tablein), _any_ec(reference), _str_ec(tableout), _any_ec(transfer), _str_ec(listfile), append, refspwmap, gainthreshold, _str_ec(antenna), _str_ec(timerange), _str_ec(scan), incremental, fitorder, display))
    ...
    def accumulate(self, tablein='', incrtable='', tableout='', field=[ ], calfield=[ ], interp='linear', t=float(-1.0), spwmap=[ int(-1) ]):
        ...
        """
        return self._swigobj.accumulate(_str_ec(tablein), _str_ec(incrtable), _str_ec(tableout), _any_ec(field), _any_ec(calfield), _str_ec(interp), t, spwmap)
    ...
    def activityrec(self):
        ...
        """
        return _dict_dc(self._swigobj.activityrec())
    ...
    def smooth(self, tablein, tableout, field=[ ], smoothtype='median', smoothtime=float(60.0)):
        ...
        """
        return self._swigobj.smooth(_str_ec(tablein), _str_ec(tableout), _any_ec(field), _str_ec(smoothtype), smoothtime)
    ...
    def rerefant(self, tablein, tableout, refantmode='flexible', refant=[ ]):
        ...
        """
        return self._swigobj.rerefant(_str_ec(tablein), _str_ec(tableout), _str_ec(refantmode), _any_ec(refant))
    ...
    def listcal(self, caltable, field=[ ], antenna=[ ], spw=[ ], listfile='', pagerows=int(50)):
        ...
        """
        return self._swigobj.listcal(_str_ec(caltable), _any_ec(field), _any_ec(antenna), _any_ec(spw), _str_ec(listfile), pagerows)
    ...
    def posangcal(self, posangcor, tablein, tableout=''):
        ...
        """
        return self._swigobj.posangcal(posangcor, _str_ec(tablein), _str_ec(tableout))
    ...
    def linpolcor(self, tablein='', tableout='', fields=[  ]):
        ...
        """
        return self._swigobj.linpolcor(_str_ec(tablein), _str_ec(tableout), _str_ec(fields))
    ...
    def plotcal(self, antennas, fields, spwids, plottype='AMP', tablename='', polarization=int(1), multiplot=False, nx=int(1), ny=int(1), psfile=''):
        ...
        printer.
        """
        return self._swigobj.plotcal(antennas, fields, spwids, _str_ec(plottype), _str_ec(tablename), polarization, multiplot, nx, ny, _str_ec(psfile))
    ...
    def modelfit(self, vary, niter=int(0), compshape='P', par=[ float(1.0),float(0.0),float(0.0) ], file=''):
        ...
        """
        return self._swigobj.modelfit(vary, niter, _str_ec(compshape), par, _str_ec(file))
    ...
    def createcaltable(self, caltable, partype, caltype, singlechan):
        ...
        """
        return self._swigobj.createcaltable(_str_ec(caltable), _str_ec(partype), _str_ec(caltype), singlechan)
    ...
    def updatecaltable(self, caltable):
        ...
        """
        return self._swigobj.updatecaltable(_str_ec(caltable))
    ...
    def parsecallibfile(self, filein):
        """TBD
        """
        return _dict_dc(self._swigobj.parsecallibfile(_str_ec(filein)))

    def setcorrdepflags(self, corrdepflags):
        """TBD
        """
        return self._swigobj.setcorrdepflags(corrdepflags)
    ...
    def setvi(self, old=False, quiet=False):
        ...
        """
        return self._swigobj.setvi(old, quiet)
