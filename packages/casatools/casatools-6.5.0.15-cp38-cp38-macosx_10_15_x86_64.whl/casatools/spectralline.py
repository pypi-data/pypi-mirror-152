...
from .__casac__ import spectralline as _spectralline
...
class spectralline:
    ...
    def splattotable(self, filenames=[  ], table=''):
        ...
        """
        return _wrap_spectralline(swig_object=self._swigobj.splattotable(_str_ec(filenames), _str_ec(table)))
    ...
    def open(self, table=''):
        ...
        """
        return self._swigobj.open(_str_ec(table))
    ...
    def search(self, outfile='', freqrange=[ float(0) ], species=[ ], reconly=False, chemnames=[ ], qns=[  ], intensity=[ float(-1) ], smu2=[ float(-1) ], loga=[ float(-1) ], el=[ float(-1) ], eu=[ float(-1) ], rrlinclude=True, rrlonly=False, verbose=True, logfile='', append=False):
        ...
        """
        return _wrap_spectralline(swig_object=self._swigobj.search(_str_ec(outfile), freqrange, _any_ec(species), reconly, _any_ec(chemnames), _str_ec(qns), intensity, smu2, loga, el, eu, rrlinclude, rrlonly, verbose, _str_ec(logfile), append))
    ...
    def species(self, verbose=False, logfile='', append=False):
        ...
        """
        return _dict_dc(self._swigobj.species(verbose, _str_ec(logfile), append))

    def chemnames(self, verbose=False, logfile='', append=False):
        """Return the unique chemical names in the associated table as a list.
        
        """
        return _dict_dc(self._swigobj.chemnames(verbose, _str_ec(logfile), append))
