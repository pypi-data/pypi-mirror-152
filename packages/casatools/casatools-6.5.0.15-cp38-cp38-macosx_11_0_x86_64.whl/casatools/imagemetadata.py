...
class imagemetadata:
    ...
    def add(self, key='', value=[ ]):
        ...
        """
        return self._swigobj.add(_str_ec(key), _any_ec(value))
    ...
    def get(self, key=''):
        ...
        """
        return _any_dc(self._swigobj.get(_str_ec(key)))

    def list(self, verbose=True):
        """Get a listing of traditional FITS-like "header" items.
        
        """
        return _dict_dc(self._swigobj.list(verbose))
    ...
    def open(self, infile):
        ...
        """
        return self._swigobj.open(_str_ec(infile))
    ...
    def remove(self, key='', value=[ ]):
        ...
        """
        return self._swigobj.remove(_str_ec(key), _any_ec(value))

    def set(self, key='', value=[ ]):
        """Set a key-value pair if possible.
        
        """
        return self._swigobj.set(_str_ec(key), _any_ec(value))
