...
##################### 77b7abdbc73817b4a9798e90787c88c0 ##############################
...
class ms:
    _info_group_ = """ms"""
    _info_desc_ = """Operations on measurement sets"""
    ### self
    ...
    def open(self, thems='', nomodify=True, lock=False, check=False):
        ...
        """
        return self._swigobj.open(_str_ec(thems), nomodify, lock, check)
    ...
    def nrow(self, selected=False):
        ...
        """
        return self._swigobj.nrow(selected)
    ...
    def getdata(self, items=[  ], ifraxis=False, ifraxisgap=int(0), increment=int(1), average=False):
        ...
        """
        return _dict_dc(self._swigobj.getdata(_str_ec(items), ifraxis, ifraxisgap, increment, average))
    ...
    def putdata(self, items={ }):
        ...
        """
        return self._swigobj.putdata(_dict_ec(items))
    ...
    def fromfits(self, msfile='', fitsfile='', nomodify=True, lock=False, obstype=int(0), host='', forcenewserver=False, antnamescheme='old'):
        ...
        """
        return self._swigobj.fromfits(_str_ec(msfile), _str_ec(fitsfile), nomodify, lock, obstype, _str_ec(host), forcenewserver, _str_ec(antnamescheme))
    ...
    def fromfitsidi(self, msfile='', fitsfile='', nomodify=True, lock=False, obstype=int(0)):
        ...
        """
        return self._swigobj.fromfitsidi(_str_ec(msfile), _str_ec(fitsfile), nomodify, lock, obstype)
    ...
    def tofits(self, fitsfile='', column='corrected', field=[ ], spw=[ ], baseline=[ ], time='', scan=[ ], uvrange=[ ], taql='', writesyscal=False, multisource=False, combinespw=False, writestation=False, padwithflags=False, overwrite=False):
        ...
        """
        return self._swigobj.tofits(_str_ec(fitsfile), _str_ec(column), _any_ec(field), _any_ec(spw), _any_ec(baseline), _str_ec(time), _any_ec(scan), _any_ec(uvrange), _str_ec(taql), writesyscal, multisource, combinespw, writestation, padwithflags, overwrite)

    def listfits(self, fitsfile):
        """List HDU and typical data rows in a uvfits file
        
        """
        return self._swigobj.listfits(_str_ec(fitsfile))
    ...
    def asdmref(self, abspath=''):
        ...
        """
        return _str_dc(self._swigobj.asdmref(_str_ec(abspath)))
    ...
    def concatenate(self, msfile='', freqtol=[ ], dirtol=[ ], weightscale=float(1.), handling=int(0), destmsfile='', respectname=False):
        ...
        """
        return self._swigobj.concatenate(_str_ec(msfile), _any_ec(freqtol), _any_ec(dirtol), weightscale, handling, _str_ec(destmsfile), respectname)
    ...
    def testconcatenate(self, msfile='', freqtol=[ ], dirtol=[ ], respectname=False):
        ...
        """
        return self._swigobj.testconcatenate(_str_ec(msfile), _any_ec(freqtol), _any_ec(dirtol), respectname)
    ...
    def virtconcatenate(self, msfile='', auxfilename='', freqtol=[ ], dirtol=[ ], weightscale=float(1.), respectname=True):
        ...
        """
        return self._swigobj.virtconcatenate(_str_ec(msfile), _str_ec(auxfilename), _any_ec(freqtol), _any_ec(dirtol), weightscale, respectname)

    def createmultims(self, outputTableName, tables, subtables, nomodify=True, lock=False, copysubtables=False, omitsubtables=[  ]):
        """
        """
        return self._swigobj.createmultims(_str_ec(outputTableName), _str_ec(tables), _str_ec(subtables), nomodify, lock, copysubtables, _str_ec(omitsubtables))
    ...
    def split(self, outputms='', field=[ ], spw=[ ], step=[ int(1) ], baseline=[ ], timebin=[ ], time='', scan=[ ], uvrange=[ ], taql='', whichcol='DATA', tileshape=[ ], subarray=[ ], combine='', correlation='', intent='', obs=''):
        ...
        """
        return self._swigobj.split(_str_ec(outputms), _any_ec(field), _any_ec(spw), step, _any_ec(baseline), _any_ec(timebin), _str_ec(time), _any_ec(scan), _any_ec(uvrange), _str_ec(taql), _str_ec(whichcol), _any_ec(tileshape), _any_ec(subarray), _str_ec(combine), _str_ec(correlation), _str_ec(intent), _str_ec(obs))
    ...
    def partition(self, outputms='', field=[ ], spw=[ ], baseline=[ ], timebin=[ ], time='', scan=[ ], uvrange=[ ], taql='', whichcol='DATA', tileshape=[ ], subarray=[ ], combine='', intent='', obs=''):
        ...
        """
        return self._swigobj.partition(_str_ec(outputms), _any_ec(field), _any_ec(spw), _any_ec(baseline), _any_ec(timebin), _str_ec(time), _any_ec(scan), _any_ec(uvrange), _str_ec(taql), _str_ec(whichcol), _any_ec(tileshape), _any_ec(subarray), _str_ec(combine), _str_ec(intent), _str_ec(obs))
    ...
    def getscansummary(self):
        ...
        """
        return _dict_dc(self._swigobj.getscansummary())
    ...
    def getspectralwindowinfo(self):
        ...
        """
        return _dict_dc(self._swigobj.getspectralwindowinfo())

    def getreferencedtables(self):
        """
        """
        return _str_dc(self._swigobj.getreferencedtables())
    ...
    def getfielddirmeas(self, dircolname='PHASE_DIR', fieldid=int(0), time=float(0), format='measure'):
        ...
        """
        return _any_dc(self._swigobj.getfielddirmeas(_str_ec(dircolname), fieldid, time, _str_ec(format)))
    ...
    def writehistory(self, message='', parms='', origin='MSHistoryHandler::addMessage()', msname='', app='ms'):
        ...
        """
        return self._swigobj.writehistory(_str_ec(message), _str_ec(parms), _str_ec(origin), _str_ec(msname), _str_ec(app))

    def writehistory_batch(self, messages=[  ], parms='', origin='MSHistoryHandler::addMessage()', msname='', app='ms'):
        ...
        """
        return self._swigobj.writehistory_batch(_str_ec(messages), _str_ec(parms), _str_ec(origin), _str_ec(msname), _str_ec(app))

    def statistics(self, column='', complex_value='', useflags=True, useweights=False, spw='', field='', baseline='', uvrange='', time='', correlation='', scan='', intent='', array='', obs='', reportingaxes='', timeaverage=False, timebin='0s', timespan='', maxuvwdistance=float(0.0), doquantiles=True):
        ...
        """
        return _dict_dc(self._swigobj.statistics(_str_ec(column), _str_ec(complex_value), useflags, useweights, _str_ec(spw), _str_ec(field), _str_ec(baseline), _str_ec(uvrange), _str_ec(time), _str_ec(correlation), _str_ec(scan), _str_ec(intent), _str_ec(array), _str_ec(obs), _str_ec(reportingaxes), timeaverage, _str_ec(timebin), _str_ec(timespan), maxuvwdistance, doquantiles))
    ...
    def statisticsold(self, column='', complex_value='', useflags=True, spw='', field='', baseline='', uvrange='', time='', correlation='', scan='', array='', obs=''):
        ...
        """
        return _dict_dc(self._swigobj.statisticsold(_str_ec(column), _str_ec(complex_value), useflags, _str_ec(spw), _str_ec(field), _str_ec(baseline), _str_ec(uvrange), _str_ec(time), _str_ec(correlation), _str_ec(scan), _str_ec(array), _str_ec(obs)))
    ...
    def range(self, items=[  ], useflags=True, blocksize=int(10)):
        ...
        """
        return _dict_dc(self._swigobj.range(_str_ec(items), useflags, blocksize))
    ...
    def lister(self, options='', datacolumn='data', field='', spw='', antenna='', timerange='', correlation='', scan='', feed='', array='', observation='', uvrange='', average='', showflags=False, msselect='', pagerows=int(50), listfile=''):
        ...
        """
        return self._swigobj.lister(_str_ec(options), _str_ec(datacolumn), _str_ec(field), _str_ec(spw), _str_ec(antenna), _str_ec(timerange), _str_ec(correlation), _str_ec(scan), _str_ec(feed), _str_ec(array), _str_ec(observation), _str_ec(uvrange), _str_ec(average), showflags, _str_ec(msselect), pagerows, _str_ec(listfile))

    def metadata(self, cachesize=float(50)):
        """Get the MS metadata associated with this MS.
        """
        return _wrap_msmetadata(swig_object=self._swigobj.metadata(cachesize))
    ...
    def msselect(self, items={ }, onlyparse=False):
        ...
        """
        return self._swigobj.msselect(_dict_ec(items), onlyparse)
    ...
    def msselectedindices(self):
        ...
        """
        return _dict_dc(self._swigobj.msselectedindices())
    ...
    def msseltoindex(self, vis='', spw=[ ], field=[ ], baseline=[ ], time=[ ], scan=[ ], uvrange=[ ], observation=[ ], polarization=[ ], taql=''):
        ...
        """
        return _dict_dc(self._swigobj.msseltoindex(_str_ec(vis), _any_ec(spw), _any_ec(field), _any_ec(baseline), _any_ec(time), _any_ec(scan), _any_ec(uvrange), _any_ec(observation), _any_ec(polarization), _str_ec(taql)))
    ...
    def selectinit(self, datadescid=int(0), reset=False):
        ...
        """
        return self._swigobj.selectinit(datadescid, reset)
    ...
    def select(self, items={ }):
        ...
        """
        return self._swigobj.select(_dict_ec(items))
    ...
    def selecttaql(self, msselect=''):
        ...
        """
        return self._swigobj.selecttaql(_str_ec(msselect))
    ...
    def selectchannel(self, nchan=int(1), start=int(0), width=int(1), inc=int(1)):
        ...
        """
        return self._swigobj.selectchannel(nchan, start, width, inc)
    ...
    def selectpolarization(self, wantedpol=[  ]):
        ...
        """
        return self._swigobj.selectpolarization(_str_ec(wantedpol))

    def statwt(self, combine='', timebin=int(1), slidetimebin=False, chanbin='spw', minsamp=int(2), statalg='classic', fence=float(-1), center='mean', lside=True, zscore=float(-1), maxiter=int(-1), fitspw='', excludechans=False, wtrange=[  ], preview=False, datacolumn='corrected'):
        ...
        """
        return _dict_dc(self._swigobj.statwt(_str_ec(combine), _any_ec(timebin), slidetimebin, _any_ec(chanbin), minsamp, _str_ec(statalg), fence, _str_ec(center), lside, zscore, maxiter, _str_ec(fitspw), excludechans, wtrange, preview, _str_ec(datacolumn)))

    def oldstatwt(self, dorms=False, byantenna=True, sepacs=True, fitspw=[ ], fitcorr=[ ], combine='', timebin=[ ], minsamp=int(3), field=[ ], spw=[ ], antenna='', timerange='', scan=[ ], intent='', array=[ ], correlation='', obs='', datacolumn='corrected_data'):
        """NOT IMPLEMENTED YET.
        ...
        """
        return self._swigobj.oldstatwt(dorms, byantenna, sepacs, _any_ec(fitspw), _any_ec(fitcorr), _str_ec(combine), _any_ec(timebin), minsamp, _any_ec(field), _any_ec(spw), _any_ec(antenna), _str_ec(timerange), _any_ec(scan), _str_ec(intent), _any_ec(array), _str_ec(correlation), _str_ec(obs), _str_ec(datacolumn))
    ...
    def regridspw(self, outframe='LSRK', mode='chan', restfreq=float(-3E30), interpolation='LINEAR', start=float(-3E30), center=float(-3E30), bandwidth=float(-1.), chanwidth=float(-1.), hanning=True):
        ...
        """
        return self._swigobj.regridspw(_str_ec(outframe), _str_ec(mode), restfreq, _str_ec(interpolation), start, center, bandwidth, chanwidth, hanning)
    ...
    def cvel(self, mode='channel', nchan=int(-1), start=[ ], width=[ ], interp='linear', phasec=[ ], restfreq=[ ], outframe='', veltype='radio', hanning=True):
        ...
        """
        return self._swigobj.cvel(_str_ec(mode), nchan, _any_ec(start), _any_ec(width), _str_ec(interp), _any_ec(phasec), _any_ec(restfreq), _str_ec(outframe), _str_ec(veltype), hanning)
    ...
    def hanningsmooth(self, datacolumn='corrected'):
        ...
        """
        return self._swigobj.hanningsmooth(_str_ec(datacolumn))
    ...
    def cvelfreqs(self, spwids=[ int(0) ], fieldids=[ int(0) ], obstime='', mode='channel', nchan=int(-1), start=[ ], width=[ ], phasec=[ ], restfreq=[ ], outframe='', veltype='radio', verbose=True):
        ...
        """
        return self._swigobj.cvelfreqs(spwids, fieldids, _str_ec(obstime), _str_ec(mode), nchan, _any_ec(start), _any_ec(width), _any_ec(phasec), _any_ec(restfreq), _str_ec(outframe), _str_ec(veltype), verbose)
    ...
    def contsub(self, outputms='', fitspw=[ ], fitorder=int(1), combine='', spw='*', unionspw='*', field='', scan='', intent='', correlation='', obs='', whichcol='CORRECTED_DATA'):
        ...
        """
        return self._swigobj.contsub(_str_ec(outputms), _any_ec(fitspw), fitorder, _str_ec(combine), _any_ec(spw), _any_ec(unionspw), _any_ec(field), _any_ec(scan), _str_ec(intent), _str_ec(correlation), _str_ec(obs), _str_ec(whichcol))
    ...
    def continuumsub(self, field=[ ], fitspw=[ ], spw=[ ], solint=[ ], fitorder=int(0), mode='subtract'):
        ...
        """
        return self._swigobj.continuumsub(_any_ec(field), _any_ec(fitspw), _any_ec(spw), _any_ec(solint), fitorder, _str_ec(mode))
    ...
    def uvsub(self, reverse=False):
        ...
        """
        return self._swigobj.uvsub(reverse)

    def addephemeris(self, id=int(-1), ephemerisname='', comment='', field=[ ]):
        """
        """
        return self._swigobj.addephemeris(id, _str_ec(ephemerisname), _str_ec(comment), _any_ec(field))
    ...
    def timesort(self, newmsname=''):
        ...
        """
        return self._swigobj.timesort(_str_ec(newmsname))
    ...
    def sort(self, newmsname='', columns=[  ]):
        ...
        """
        return self._swigobj.sort(_str_ec(newmsname), _str_ec(columns))
    ...
    def iterinit(self, columns=[  ], interval=float(0.0), maxrows=int(0), adddefaultsortcolumns=True):
        ...
        """
        return self._swigobj.iterinit(_str_ec(columns), interval, maxrows, adddefaultsortcolumns)
    ...
    def ngetdata(self, items=[  ], ifraxis=False, ifraxisgap=int(0), increment=int(1), average=False):
        ...
        """
        return _dict_dc(self._swigobj.ngetdata(_str_ec(items), ifraxis, ifraxisgap, increment, average))
    ...
    def niterinit(self, columns=[  ], interval=float(0.0), maxrows=int(0), adddefaultsortcolumns=True):
        ...
        """
        return self._swigobj.niterinit(_str_ec(columns), interval, maxrows, adddefaultsortcolumns)
    ...
    def nrowold(self, selected=False):
        ...
        """
        return self._swigobj.nrowold(selected)
    ...
    def rangeold(self, items=[  ], useflags=True, blocksize=int(10)):
        ...
        """
        return _dict_dc(self._swigobj.rangeold(_str_ec(items), useflags, blocksize))
    ...
    def selectinitold(self, datadescid=int(0), reset=False):
        ...
        """
        return self._swigobj.selectinitold(datadescid, reset)
    ...
    def selectold(self, items={ }):
        ...
        """
        return self._swigobj.selectold(_dict_ec(items))
    ...
    def selecttaqlold(self, msselect=''):
        ...
        """
        return self._swigobj.selecttaqlold(_str_ec(msselect))
    ...
    def selectchannelold(self, nchan=int(1), start=int(0), width=int(1), inc=int(1)):
        ...
        """
        return self._swigobj.selectchannelold(nchan, start, width, inc)
    ...
    def selectpolarizationold(self, wantedpol=[  ]):
        ...
        """
        return self._swigobj.selectpolarizationold(_str_ec(wantedpol))
    ...
    def getdataold(self, items=[  ], ifraxis=False, ifraxisgap=int(0), increment=int(1), average=False):
        ...
        """
        return _dict_dc(self._swigobj.getdataold(_str_ec(items), ifraxis, ifraxisgap, increment, average))
    ...
    def putdataold(self, items={ }):
        ...
        """
        return self._swigobj.putdataold(_dict_ec(items))
    ...
    def iterinitold(self, columns=[  ], interval=float(0.0), maxrows=int(0), adddefaultsortcolumns=True):
        ...
        """
        return self._swigobj.iterinitold(_str_ec(columns), interval, maxrows, adddefaultsortcolumns)
    ...
    def iteroriginold(self):
        ...
        """
        return self._swigobj.iteroriginold()
    ...
    def iternextold(self):
        ...
        """
        return self._swigobj.iternextold()
    ...
    def iterendold(self):
        ...
        """
        return self._swigobj.iterendold()
    ...
    def continuumsubold(self, field=[ ], fitspw=[ ], spw=[ ], solint=[ ], fitorder=int(0), mode='subtract'):
        ...
        """
        return self._swigobj.continuumsubold(_any_ec(field), _any_ec(fitspw), _any_ec(spw), _any_ec(solint), fitorder, _str_ec(mode))
