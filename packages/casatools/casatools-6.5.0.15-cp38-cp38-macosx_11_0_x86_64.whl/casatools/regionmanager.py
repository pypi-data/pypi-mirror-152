...
class regionmanager:
    ...
    def absreltype(self, absrelvalue=int(0)):
        ...
        """
        return _str_dc(self._swigobj.absreltype(absrelvalue))
    ...
    def box(self, blc=[ float(0) ], trc=[ float(-1) ], inc=[ float(1) ], absrel='abs', frac=False, comment=''):
        ...
        ({stfaf absrel='relcen'}).
        """
        return _dict_dc(self._swigobj.box(blc, trc, inc, _str_ec(absrel), frac, _str_ec(comment)))
    ...
    def frombcs(self, csys={ }, shape=[ int(0) ], box='', chans='', stokes='', stokescontrol='a', region=[ ]):
        ...
        can be permanent.
        """
        return _dict_dc(self._swigobj.frombcs(_dict_ec(csys), shape, _str_ec(box), _str_ec(chans), _str_ec(stokes), _str_ec(stokescontrol), _any_ec(region)))
    ...
    def complement(self, region=[ ], comment=''):
        ...
        """
        return _dict_dc(self._swigobj.complement(_any_ec(region), _str_ec(comment)))
    ...
    def concatenation(self, box=[ ], regions=[ ], comment=''):
        ...
        """
        return _dict_dc(self._swigobj.concatenation(_any_ec(box), _any_ec(regions), _str_ec(comment)))
    ...
    def deletefromtable(self, tablename='', regionname=''):
        ...
        namesintable.
        """
        return self._swigobj.deletefromtable(_str_ec(tablename), _str_ec(regionname))
    ...
    def difference(self, region1={ }, region2={ }, comment=''):
        ...
        """
        return _dict_dc(self._swigobj.difference(_dict_ec(region1), _dict_ec(region2), _str_ec(comment)))
    ...
    def selectedchannels(self, specification='', shape=[ int(0) ]):
        ...
        """
        return self._swigobj.selectedchannels(_str_ec(specification), shape)
    ...
    def fromtextfile(self, filename='', shape=[ int(0) ], csys={ }):
        ...
        """
        return _dict_dc(self._swigobj.fromtextfile(_str_ec(filename), shape, _dict_ec(csys)))
    ...
    def fromtext(self, text='', shape=[ int(1) ], csys={ }):
        ...
        """
        return _dict_dc(self._swigobj.fromtext(_str_ec(text), shape, _dict_ec(csys)))
    ...
    def fromfiletorecord(self, filename='', verbose=True, regionname=''):
        ...
        image analysis tool.
        """
        return _dict_dc(self._swigobj.fromfiletorecord(_str_ec(filename), verbose, _str_ec(regionname)))
    ...
    def tofile(self, filename='', region={ }):
        ...
        """
        return self._swigobj.tofile(_str_ec(filename), _dict_ec(region))
    ...
    def fromrecordtotable(self, tablename='', regionname=[ ], regionrec={ }, asmask=False, verbose=True):
        ...
        """
        return _str_dc(self._swigobj.fromrecordtotable(_str_ec(tablename), _any_ec(regionname), _dict_ec(regionrec), asmask, verbose))
    ...
    def fromtabletorecord(self, tablename='', regionname=[ ], verbose=True):
        ...
        """
        return _dict_dc(self._swigobj.fromtabletorecord(_str_ec(tablename), _any_ec(regionname), verbose))
    ...
    def intersection(self, regions=[ ], comment=''):
        ...
        (see examples).
        """
        return _dict_dc(self._swigobj.intersection(_any_ec(regions), _str_ec(comment)))
    ...
    def ispixelregion(self, region={ }):
        ...
        """
        return self._swigobj.ispixelregion(_dict_ec(region))
    ...
    def isworldregion(self, region={ }):
        ...
        For any other glish variable it returns F.
        """
        return self._swigobj.isworldregion(_dict_ec(region))
    ...
    def namesintable(self, tablename=''):
        ...
        aipspp table on disk (any kind of table).
        """
        return _str_dc(self._swigobj.namesintable(_str_ec(tablename)))
    ...
    def setcoordinates(self, csys={ }):
        ...
        """
        return self._swigobj.setcoordinates(_dict_ec(csys))
    ...
    def makeunion(self, regions=[ ], comment=''):
        ...
        (see examples).
        """
        return _dict_dc(self._swigobj.makeunion(_any_ec(regions), _str_ec(comment)))
    ...
    def wbox(self, blc=[ ], trc=[ ], pixelaxes=[ int(-1) ], csys={ }, absrel='abs', comment=''):
        ...
        """
        return _dict_dc(self._swigobj.wbox(_any_ec(blc), _any_ec(trc), pixelaxes, _dict_ec(csys), _str_ec(absrel), _str_ec(comment)))
    ...
    def wpolygon(self, x=[ ], y=[ ], pixelaxes=[ int(-1) ], csys={ }, absrel='abs', comment=''):
        ...
        interface of the regionmanager.
        """
        return _dict_dc(self._swigobj.wpolygon(_any_ec(x), _any_ec(y), pixelaxes, _dict_ec(csys), _str_ec(absrel), _str_ec(comment)))
