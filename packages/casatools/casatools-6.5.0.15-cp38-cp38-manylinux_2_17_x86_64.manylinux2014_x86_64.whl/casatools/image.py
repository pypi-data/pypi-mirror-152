...
##################### 61c4e19db2e3dfb92cedf5624c981cfb ##############################
...
class image:
    ...
    def newimage(self, infile):
        ...
        """
        return _wrap_image(swig_object=self._swigobj.newimage(_str_ec(infile)))
    ...
    def newimagefromfile(self, infile):
        ...
        """
        return _wrap_image(swig_object=self._swigobj.newimagefromfile(_str_ec(infile)))
    ...
    def imagecalc(self, outfile='', pixels='', overwrite=False, imagemd='', prec='float'):
        ...
        """
        return _wrap_image(swig_object=self._swigobj.imagecalc(_str_ec(outfile), _str_ec(pixels), overwrite, _str_ec(imagemd), _str_ec(prec)))
    ...
    def collapse(self, function='', axes=[ ], outfile='', region='', box='', chans='', stokes='', mask='', overwrite=False, stretch=False):
        ...
        """
        return _wrap_image(swig_object=self._swigobj.collapse(_str_ec(function), _any_ec(axes), _str_ec(outfile), _any_ec(region), _str_ec(box), _str_ec(chans), _str_ec(stokes), _str_ec(mask), overwrite, stretch))
    ...
    def decimate(self, outfile='', axis=int(0), factor=int(1), method='copy', region='', mask='', overwrite=False, stretch=False):
        ...
        """
        return _wrap_image(swig_object=self._swigobj.decimate(_str_ec(outfile), axis, factor, _str_ec(method), _any_ec(region), _str_ec(mask), overwrite, stretch))
    ...
    def imageconcat(self, outfile='', infiles=[ ], axis=int(-1), relax=False, tempclose=True, overwrite=False, reorder=False, mode='paged'):
        ...
        """
        return _wrap_image(swig_object=self._swigobj.imageconcat(_str_ec(outfile), _any_ec(infiles), axis, relax, tempclose, overwrite, reorder, _str_ec(mode)))
    ...
    def fromarray(self, outfile='', pixels=[ ], csys={ }, linear=False, overwrite=False, log=True, type='f'):
        ...
        """
        return self._swigobj.fromarray(_str_ec(outfile), _any_ec(pixels), _dict_ec(csys), linear, overwrite, log, _str_ec(type))
    ...
    def fromcomplist(self, outfile='', shape=[  ], cl='', csys={ }, overwrite=False, log=True, cache=True):
        ...
        """
        return self._swigobj.fromcomplist(_str_ec(outfile), shape, _any_ec(cl), _dict_ec(csys), overwrite, log, cache)
    ...
    def fromfits(self, outfile='', infile='', whichrep=int(0), whichhdu=int(0), zeroblanks=False, overwrite=False):
        ...
        """
        return self._swigobj.fromfits(_str_ec(outfile), _str_ec(infile), whichrep, whichhdu, zeroblanks, overwrite)
    ...
    def fromimage(self, outfile='', infile='', region=[ ], mask='', dropdeg=False, overwrite=False):
        ...
        """
        return self._swigobj.fromimage(_str_ec(outfile), _str_ec(infile), _any_ec(region), _any_ec(mask), dropdeg, overwrite)
    ...
    def fromshape(self, outfile='', shape=[ int(0) ], csys={ }, linear=False, overwrite=False, log=True, type='f'):
        ...
        """
        return self._swigobj.fromshape(_str_ec(outfile), shape, _dict_ec(csys), linear, overwrite, log, _str_ec(type))
    ...
    def maketestimage(self, outfile='', overwrite=False):
        ...
        """
        return self._swigobj.maketestimage(_str_ec(outfile), overwrite)
    ...
    def deviation(self, outfile='', region='', mask='', overwrite=False, stretch=False, grid=[ int(1),int(1) ], anchor='ref', xlength='1pix', ylength='1pix', interp='cubic', stattype='sigma', statalg='classic', zscore=float(-1), maxiter=int(-1)):
        ...
        """
        return _wrap_image(swig_object=self._swigobj.deviation(_str_ec(outfile), _any_ec(region), _str_ec(mask), overwrite, stretch, grid, _any_ec(anchor), _any_ec(xlength), _any_ec(ylength), _str_ec(interp), _str_ec(stattype), _str_ec(statalg), zscore, maxiter))
    ...
    def adddegaxes(self, outfile='', direction=False, spectral=False, stokes='', linear=False, tabular=False, overwrite=False, silent=False):
        ...
        temporary image is deleted.
        """
        return _wrap_image(swig_object=self._swigobj.adddegaxes(_str_ec(outfile), direction, spectral, _str_ec(stokes), linear, tabular, overwrite, silent))
    ...
    def addnoise(self, type='normal', pars=[ float(0.0),float(1.0) ], region={ }, zero=False, seeds=[  ]):
        ...
        """
        return self._swigobj.addnoise(_str_ec(type), pars, _any_ec(region), zero, seeds)
    ...
    def convolve(self, outfile='', kernel=[ ], scale=float(-1.0), region={ }, mask='', overwrite=False, stretch=False):
        ...
        """
        return _wrap_image(swig_object=self._swigobj.convolve(_str_ec(outfile), _any_ec(kernel), scale, _any_ec(region), _any_ec(mask), overwrite, stretch))
    ...
    def boundingbox(self, region={ }):
        ...
        """
        return _dict_dc(self._swigobj.boundingbox(_any_ec(region)))
    ...
    def boxcar(self, outfile='', region={ }, mask=[ ], axis=int(-1), width=int(2), drop=True, dmethod='copy', overwrite=False, stretch=False):
        ...
        """
        return _wrap_image(swig_object=self._swigobj.boxcar(_str_ec(outfile), _any_ec(region), _any_ec(mask), axis, width, drop, _str_ec(dmethod), overwrite, stretch))

    def brightnessunit(self):
        """This function gets the image brightness unit. Both float and complex
        valued images are supported.
        """
        return _str_dc(self._swigobj.brightnessunit())
    ...
    def calc(self, pixels, verbose=True):
        ...
        putregion.
        """
        return self._swigobj.calc(_str_ec(pixels), verbose)
    ...
    def calcmask(self, mask='', name='', asdefault=True):
        ...
        """
        return self._swigobj.calcmask(_str_ec(mask), _str_ec(name), asdefault)
    ...
    def continuumsub(self, outline='', outcont='continuumsub.im', region={ }, channels=[ int(-1) ], pol='', fitorder=int(0), overwrite=False):
        ...
        """
        return _wrap_image(swig_object=self._swigobj.continuumsub(_str_ec(outline), _str_ec(outcont), _any_ec(region), channels, _str_ec(pol), fitorder, overwrite))
    ...
    def convertflux(self, value=[ ], major=[ ], minor=[ ], type='Gaussian', topeak=True, channel=int(-1), polarization=int(-1)):
        ...
        """
        return _dict_dc(self._swigobj.convertflux(_any_ec(value), _any_ec(major), _any_ec(minor), _str_ec(type), topeak, channel, polarization))
    ...
    def convolve2d(self, outfile='', axes=[ int(0),int(1) ], type='gaussian', major='0deg', minor='0deg', pa='0deg', scale=float(-1), region={ }, mask='', overwrite=False, stretch=False, targetres=False, beam={ }):
        ...
        sepconvolve.
        """
        return _wrap_image(swig_object=self._swigobj.convolve2d(_str_ec(outfile), axes, _str_ec(type), _any_ec(major), _any_ec(minor), _any_ec(pa), scale, _any_ec(region), _any_ec(mask), overwrite, stretch, targetres, _dict_ec(beam)))
    ...
    def coordmeasures(self, pixel=[ float(-1) ], dframe='cl', sframe='cl'):
        ...
        """
        return _dict_dc(self._swigobj.coordmeasures(pixel, _str_ec(dframe), _str_ec(sframe)))
    ...
    def decompose(self, region={ }, mask='', simple=False, threshold=float(-1), ncontour=int(11), minrange=int(1), naxis=int(2), fit=True, maxrms=float(-1), maxretry=int(-1), maxiter=int(256), convcriteria=float(0.0001), stretch=False):
        ...
        """
        return _dict_dc(self._swigobj.decompose(_any_ec(region), _any_ec(mask), simple, threshold, ncontour, minrange, naxis, fit, maxrms, maxretry, maxiter, convcriteria, stretch))
    ...
    def deconvolvecomponentlist(self, complist, channel=int(-1), polarization=int(-1)):
        ...
        restoringbeam.
        """
        return _dict_dc(self._swigobj.deconvolvecomponentlist(_dict_ec(complist), channel, polarization))
    ...
    def deconvolvefrombeam(self, source=[ ], beam=[ ]):
        ...
        """
        return _dict_dc(self._swigobj.deconvolvefrombeam(_any_ec(source), _any_ec(beam)))
    ...
    def beamforconvolvedsize(self, source=[ ], convolved=[ ]):
        ...
        """
        return _dict_dc(self._swigobj.beamforconvolvedsize(_any_ec(source), _any_ec(convolved)))
    ...
    def commonbeam(self):
        ...
        """
        return _dict_dc(self._swigobj.commonbeam())
    ...
    def removefile(self, file):
        ...
        """
        return self._swigobj.removefile(_str_ec(file))
    ...
    def fft(self, real='', imag='', amp='', phase='', axes=[ int(-1) ], region={ }, mask='', stretch=False, complex=''):
        ...
        """
        return self._swigobj.fft(_str_ec(real), _str_ec(imag), _str_ec(amp), _str_ec(phase), axes, _any_ec(region), _any_ec(mask), stretch, _str_ec(complex))
    ...
    def findsources(self, nmax=int(20), cutoff=float(0.1), region={ }, mask='', point=True, width=int(5), negfind=False):
        ...
        """
        return _dict_dc(self._swigobj.findsources(nmax, cutoff, _any_ec(region), _any_ec(mask), point, width, negfind))
    ...
    def fitprofile(self, box='', region='', chans='', stokes='', axis=int(-1), mask='', ngauss=int(1), poly=int(-1), estimates='', minpts=int(1), multifit=False, model='', residual='', amp='', amperr='', center='', centererr='', fwhm='', fwhmerr='', integral='', integralerr='', stretch=False, logresults=True, pampest=[  ], pcenterest=[  ], pfwhmest=[  ], pfix='', gmncomps=int(0), gmampcon=[  ], gmcentercon=[  ], gmfwhmcon=[  ], gmampest=[ float(0.0) ], gmcenterest=[ float(0.0) ], gmfwhmest=[ float(0.0) ], gmfix='', spxtype='', spxest=[  ], spxfix=[  ], div=[ ], spxsol='', spxerr='', logfile='', append=True, pfunc='', goodamprange=[ float(0.0) ], goodcenterrange=[ float(0.0) ], goodfwhmrange=[ float(0.0) ], sigma='', outsigma='', planes=[  ]):
        ...
        """
        return _dict_dc(self._swigobj.fitprofile(_str_ec(box), _any_ec(region), _str_ec(chans), _str_ec(stokes), axis, _any_ec(mask), ngauss, poly, _str_ec(estimates), minpts, multifit, _str_ec(model), _str_ec(residual), _str_ec(amp), _str_ec(amperr), _str_ec(center), _str_ec(centererr), _str_ec(fwhm), _str_ec(fwhmerr), _str_ec(integral), _str_ec(integralerr), stretch, logresults, _any_ec(pampest), _any_ec(pcenterest), _any_ec(pfwhmest), _any_ec(pfix), _any_ec(gmncomps), _any_ec(gmampcon), _any_ec(gmcentercon), _any_ec(gmfwhmcon), gmampest, gmcenterest, gmfwhmest, _any_ec(gmfix), _str_ec(spxtype), spxest, spxfix, _any_ec(div), _str_ec(spxsol), _str_ec(spxerr), _str_ec(logfile), append, _any_ec(pfunc), goodamprange, goodcenterrange, goodfwhmrange, _any_ec(sigma), _str_ec(outsigma), planes))
    ...
    def fitcomponents(self, box='', region=[ ], chans=[ ], stokes='', mask='', includepix=[ float(-1) ], excludepix=[ float(-1) ], residual='', model='', estimates='', logfile='', append=True, newestimates='', complist='', overwrite=False, dooff=False, offset=float(0.0), fixoffset=False, stretch=False, rms='', noisefwhm='', summary=''):
        ...
        """
        return _dict_dc(self._swigobj.fitcomponents(_str_ec(box), _any_ec(region), _any_ec(chans), _str_ec(stokes), _any_ec(mask), includepix, excludepix, _str_ec(residual), _str_ec(model), _str_ec(estimates), _str_ec(logfile), append, _str_ec(newestimates), _str_ec(complist), overwrite, dooff, offset, fixoffset, stretch, _any_ec(rms), _any_ec(noisefwhm), _str_ec(summary)))
    ...
    def fromrecord(self, record, outfile=''):
        ...
        """
        return self._swigobj.fromrecord(_dict_ec(record), _str_ec(outfile))
    ...
    def getchunk(self, blc=[ int(-1) ], trc=[ int(-1) ], inc=[ int(1) ], axes=[ int(-1) ], list=False, dropdeg=False, getmask=False):
        ...
        the pixel values.
        """
        return _any_dc(self._swigobj.getchunk(blc, trc, inc, axes, list, dropdeg, getmask))
    ...
    def getregion(self, region={ }, axes=[ int(-1) ], mask='', list=False, dropdeg=False, getmask=False, stretch=False):
        ...
        """
        return _any_dc(self._swigobj.getregion(_any_ec(region), axes, _any_ec(mask), list, dropdeg, getmask, stretch))
    ...
    def getprofile(self, axis=int(-1), function='mean', region={ }, mask='', unit='', stretch=False, spectype='default', restfreq='', frame='', logfile=''):
        ...
        """
        return _dict_dc(self._swigobj.getprofile(axis, _str_ec(function), _any_ec(region), _str_ec(mask), _str_ec(unit), stretch, _str_ec(spectype), _any_ec(restfreq), _str_ec(frame), _str_ec(logfile)))
    ...
    def getslice(self, x, y, axes=[ int(0),int(1) ], coord=[ int(-1) ], npts=int(0), method='linear'):
        ...
        """
        return _dict_dc(self._swigobj.getslice(x, y, axes, coord, npts, _str_ec(method)))
    ...
    def hanning(self, outfile='', region={ }, mask='', axis=int(-10), drop=True, overwrite=False, stretch=False, dmethod='copy'):
        ...
        convolve.
        """
        return _wrap_image(swig_object=self._swigobj.hanning(_str_ec(outfile), _any_ec(region), _any_ec(mask), axis, drop, overwrite, stretch, _str_ec(dmethod)))
    ...
    def histograms(self, axes=[ int(-1) ], region={ }, mask='', nbins=int(25), includepix=[ float(-1) ], cumu=False, log=False, stretch=False):
        ...
        """
        return _dict_dc(self._swigobj.histograms(axes, _any_ec(region), _any_ec(mask), nbins, includepix, cumu, log, stretch))
    ...
    def history(self, list=True):
        ...
        """
        return _str_dc(self._swigobj.history(list))
    ...
    def insert(self, infile='', region={ }, locate=[ float(-1) ], verbose=False):
        ...
        """
        return self._swigobj.insert(_str_ec(infile), _any_ec(region), locate, verbose)
    ...
    def makecomplex(self, outfile, imag, region={ }, overwrite=False):
        ...
        """
        return self._swigobj.makecomplex(_str_ec(outfile), _str_ec(imag), _any_ec(region), overwrite)
    ...
    def maskhandler(self, op='default', name=[  ]):
        ...
        'myimage:mask2'.
        """
        return _str_dc(self._swigobj.maskhandler(_str_ec(op), _str_ec(name)))
    ...
    def miscinfo(self):
        ...
        """
        return _dict_dc(self._swigobj.miscinfo())
    ...
    def modify(self, model, region={ }, mask='', subtract=True, list=True, stretch=False):
        ...
        density will be closer to the expected value for images with smaller pixels.
        """
        return self._swigobj.modify(_dict_ec(model), _any_ec(region), _any_ec(mask), subtract, list, stretch)
    ...
    def maxfit(self, region={ }, point=True, width=int(5), negfind=False, list=True):
        ...
        """
        return _dict_dc(self._swigobj.maxfit(_any_ec(region), point, width, negfind, list))
    ...
    def moments(self, moments=[ int(0) ], axis=int(-10), region={ }, mask='', method=[  ], smoothaxes=[ int(-1) ], smoothtypes=[ ], smoothwidths=[ float(0.0) ], includepix=[ float(-1) ], excludepix=[ float(-1) ], peaksnr=float(3.0), stddev=float(0.0), doppler='RADIO', outfile='', smoothout='', overwrite=False, drop=True, stretch=False):
        ...
        """
        return _wrap_image(swig_object=self._swigobj.moments(moments, axis, _any_ec(region), _any_ec(mask), _str_ec(method), smoothaxes, _any_ec(smoothtypes), smoothwidths, includepix, excludepix, peaksnr, stddev, _str_ec(doppler), _str_ec(outfile), _str_ec(smoothout), overwrite, drop, stretch))
    ...
    def name(self, strippath=False):
        ...
        """
        return _str_dc(self._swigobj.name(strippath))
    ...
    def open(self, infile, cache=True):
        ...
        """
        return self._swigobj.open(_str_ec(infile), cache)
    ...
    def pad(self, outfile='', npixels=int(1), value=float(0), padmask=False, overwrite=False, region={ }, box='', chans='', stokes='', mask='', stretch=False, wantreturn=True):
        ...
        """
        return _wrap_image(swig_object=self._swigobj.pad(_str_ec(outfile), npixels, value, padmask, overwrite, _any_ec(region), _str_ec(box), _str_ec(chans), _str_ec(stokes), _str_ec(mask), stretch, wantreturn))
    ...
    def crop(self, outfile='', axes=[  ], overwrite=False, region={ }, box='', chans='', stokes='', mask='', stretch=False, wantreturn=True):
        ...
        """
        return _wrap_image(swig_object=self._swigobj.crop(_str_ec(outfile), axes, overwrite, _any_ec(region), _str_ec(box), _str_ec(chans), _str_ec(stokes), _str_ec(mask), stretch, wantreturn))
    ...
    def pixelvalue(self, pixel=[ int(-1) ]):
        ...
        """
        return _dict_dc(self._swigobj.pixelvalue(pixel))
    ...
    def putchunk(self, pixels=[ ], blc=[ int(-1) ], inc=[ int(1) ], list=False, locking=True, replicate=False):
        ...
        pixel values.
        """
        return self._swigobj.putchunk(_any_ec(pixels), blc, inc, list, locking, replicate)
    ...
    def putregion(self, pixels=[ ], pixelmask=[ ], region={ }, list=False, usemask=True, locking=True, replicate=False):
        ...
        """
        return self._swigobj.putregion(_any_ec(pixels), _any_ec(pixelmask), _any_ec(region), list, usemask, locking, replicate)
    ...
    def rebin(self, outfile, bin, region='', mask='', dropdeg=False, overwrite=False, stretch=False, crop=False):
        ...
        temporary image is deleted.
        """
        return _wrap_image(swig_object=self._swigobj.rebin(_str_ec(outfile), bin, _any_ec(region), _any_ec(mask), dropdeg, overwrite, stretch, crop))
    ...
    def regrid(self, outfile='', shape=[ int(-1) ], csys={ }, axes=[ int(-1) ], region={ }, mask='', method='linear', decimate=int(10), replicate=False, doref=True, dropdeg=False, overwrite=False, force=False, asvelocity=False, stretch=False):
        ...
        """
        return _wrap_image(swig_object=self._swigobj.regrid(_str_ec(outfile), shape, _dict_ec(csys), axes, _any_ec(region), _any_ec(mask), _str_ec(method), decimate, replicate, doref, dropdeg, overwrite, force, asvelocity, stretch))
    ...
    def transpose(self, outfile='', order=[ ]):
        ...
        """
        return _wrap_image(swig_object=self._swigobj.transpose(_str_ec(outfile), _any_ec(order)))
    ...
    def rotate(self, outfile='', shape=[ int(-1) ], pa=[ ], region={ }, mask='', method='cubic', decimate=int(0), replicate=False, dropdeg=False, overwrite=False, stretch=False):
        ...
        """
        return _wrap_image(swig_object=self._swigobj.rotate(_str_ec(outfile), shape, _any_ec(pa), _any_ec(region), _any_ec(mask), _str_ec(method), decimate, replicate, dropdeg, overwrite, stretch))
    ...
    def rotatebeam(self, angle=[ ]):
        ...
        """
        return self._swigobj.rotatebeam(_any_ec(angle))
    ...
    def rename(self, name, overwrite=False):
        ...
        result.
        """
        return self._swigobj.rename(_str_ec(name), overwrite)
    ...
    def replacemaskedpixels(self, pixels=[ ], region={ }, mask='', update=False, list=False, stretch=False):
        ...
        """
        return self._swigobj.replacemaskedpixels(_any_ec(pixels), _any_ec(region), _any_ec(mask), update, list, stretch)
    ...
    def restoringbeam(self, channel=int(-1), polarization=int(-1)):
        ...
        setrestoringbeam.
        """
        return _dict_dc(self._swigobj.restoringbeam(channel, polarization))
    ...
    def sepconvolve(self, outfile='', axes=[ int(-1) ], types=[ '' ], widths=[ ], scale=float(-1), region={ }, mask='', overwrite=False, stretch=False):
        ...
        hanning.
        """
        return _wrap_image(swig_object=self._swigobj.sepconvolve(_str_ec(outfile), axes, _str_ec(types), _any_ec(widths), scale, _any_ec(region), _any_ec(mask), overwrite, stretch))
    ...
    def set(self, pixels=[ ], pixelmask=int(-1), region={ }, list=False):
        ...
        """
        return self._swigobj.set(_any_ec(pixels), pixelmask, _any_ec(region), list)
    ...
    def setbrightnessunit(self, unit):
        ...
        brightnessunit.
        """
        return self._swigobj.setbrightnessunit(_str_ec(unit))
    ...
    def setcoordsys(self, csys):
        ...
        """
        return self._swigobj.setcoordsys(_dict_ec(csys))
    ...
    def sethistory(self, origin='', history=[  ]):
        ...
        history.
        """
        return self._swigobj.sethistory(_str_ec(origin), _str_ec(history))
    ...
    def setmiscinfo(self, info):
        ...
        """
        return self._swigobj.setmiscinfo(_dict_ec(info))
    ...
    def setrestoringbeam(self, major=[ ], minor=[ ], pa=[ ], beam={ }, remove=False, log=True, channel=int(-1), polarization=int(-1), imagename=''):
        ...
        """
        return self._swigobj.setrestoringbeam(_any_ec(major), _any_ec(minor), _any_ec(pa), _dict_ec(beam), remove, log, channel, polarization, _str_ec(imagename))
    ...
    def statistics(self, axes=[ int(-1) ], region='', mask='', includepix=[ float(-1) ], excludepix=[ float(-1) ], list=False, force=False, disk=False, robust=False, verbose=False, stretch=False, logfile='', append=True, algorithm='classic', fence=float(-1), center='mean', lside=True, zscore=float(-1), maxiter=int(-1), clmethod='auto', niter=int(3)):
        ...
        """
        return _dict_dc(self._swigobj.statistics(axes, _any_ec(region), _any_ec(mask), includepix, excludepix, list, force, disk, robust, verbose, stretch, _str_ec(logfile), append, _str_ec(algorithm), fence, _str_ec(center), lside, zscore, maxiter, _str_ec(clmethod), niter))
    ...
    def twopointcorrelation(self, outfile='', region={ }, mask='', axes=[ int(-1) ], method='structurefunction', overwrite=False, stretch=False):
        ...
        """
        return self._swigobj.twopointcorrelation(_str_ec(outfile), _any_ec(region), _any_ec(mask), axes, _str_ec(method), overwrite, stretch)
    ...
    def subimage(self, outfile='', region='', mask='', dropdeg=False, overwrite=False, list=True, stretch=False, wantreturn=True, keepaxes=[  ]):
        ...
        error will result.
        """
        return _wrap_image(swig_object=self._swigobj.subimage(_str_ec(outfile), _any_ec(region), _any_ec(mask), dropdeg, overwrite, list, stretch, wantreturn, keepaxes))
    ...
    def summary(self, doppler='RADIO', list=True, pixelorder=True, verbose=False):
        ...
        """
        return _dict_dc(self._swigobj.summary(_str_ec(doppler), list, pixelorder, verbose))
    ...
    def tofits(self, outfile='', velocity=False, optical=True, bitpix=int(-32), minpix=float(1), maxpix=float(-1), region={ }, mask='', overwrite=False, dropdeg=False, deglast=False, dropstokes=False, stokeslast=True, wavelength=False, airwavelength=False, stretch=False, history=True):
        ...
        """
        return self._swigobj.tofits(_str_ec(outfile), velocity, optical, bitpix, minpix, maxpix, _any_ec(region), _any_ec(mask), overwrite, dropdeg, deglast, dropstokes, stokeslast, wavelength, airwavelength, stretch, history)
    ...
    def topixel(self, value=[ ]):
        ...
        """
        return _dict_dc(self._swigobj.topixel(_any_ec(value)))
    ...
    def toworld(self, value=[ ], format='n', dovelocity=True):
        ...
        """
        return _dict_dc(self._swigobj.toworld(_any_ec(value), _str_ec(format), dovelocity))
    ...
    def newimagefromarray(self, outfile='', pixels=[ ], csys={ }, linear=False, overwrite=False, log=True, type='f'):
        ...
        value of 0.0 at its center pixel. The increment of each axis will be 1.0 km.
        """
        return _wrap_image(swig_object=self._swigobj.newimagefromarray(_str_ec(outfile), _any_ec(pixels), _dict_ec(csys), linear, overwrite, log, _str_ec(type)))
    ...
    def newimagefromfits(self, outfile='', infile='', whichrep=int(0), whichhdu=int(0), zeroblanks=False, overwrite=False):
        ...
        need to replace masked pixel values after you have created the image.
        """
        return _wrap_image(swig_object=self._swigobj.newimagefromfits(_str_ec(outfile), _str_ec(infile), whichrep, whichhdu, zeroblanks, overwrite))
    ...
    def newimagefromimage(self, infile='', outfile='', region={ }, mask='', dropdeg=False, overwrite=False):
        ...
        See also the subimage function.
        """
        return _wrap_image(swig_object=self._swigobj.newimagefromimage(_str_ec(infile), _str_ec(outfile), _any_ec(region), _any_ec(mask), dropdeg, overwrite))
    ...
    def newimagefromshape(self, outfile='', shape=[ int(0) ], csys={ }, linear=False, overwrite=False, log=True, type='f'):
        ...
        linear coordinates.
        """
        return _wrap_image(swig_object=self._swigobj.newimagefromshape(_str_ec(outfile), shape, _dict_ec(csys), linear, overwrite, log, _str_ec(type)))
    ...
    def pbcor(self, pbimage='', outfile='', overwrite=False, box='', region={ }, chans='', stokes='', mask='', mode='divide', cutoff=float(-1.0), stretch=False):
        ...
        """
        return _wrap_image(swig_object=self._swigobj.pbcor(_any_ec(pbimage), _str_ec(outfile), overwrite, _str_ec(box), _any_ec(region), _str_ec(chans), _str_ec(stokes), _str_ec(mask), _str_ec(mode), cutoff, stretch))
    ...
    def pixeltype(self):
        ...
        """
        return _str_dc(self._swigobj.pixeltype())
    ...
    def pv(self, outfile='', start=[ ], end=[ ], center=[ ], length=[ ], pa=[ ], width=int(1), unit='arcsec', overwrite=False, region={ }, chans='', stokes='', mask='', stretch=False, wantreturn=True):
        ...
        """
        return _wrap_image(swig_object=self._swigobj.pv(_str_ec(outfile), _any_ec(start), _any_ec(end), _any_ec(center), _any_ec(length), _any_ec(pa), _any_ec(width), _str_ec(unit), overwrite, _any_ec(region), _str_ec(chans), _str_ec(stokes), _str_ec(mask), stretch, wantreturn))
    ...
    def makearray(self, v=float(0.0), shape=[ int(0) ]):
        ...
        """
        return _any_dc(self._swigobj.makearray(v, shape))
    ...
    def isconform(self, other):
        ...
        """
        return self._swigobj.isconform(_str_ec(other))
