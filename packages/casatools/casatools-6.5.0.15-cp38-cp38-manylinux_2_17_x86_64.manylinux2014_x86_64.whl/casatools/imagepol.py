...
class imagepol:
    _info_group_ = """images"""
    _info_desc_ = """Polarimetric analysis of images"""
    ### self
    ...
    def imagepoltestimage(self, outfile='imagepol.iquv', rm=[ float(0.0) ], pa0=float(0.0), sigma=float(0.01), nx=int(32), ny=int(32), nf=int(32), f0=float(1.4e9), bw=float(128.0e6)):
        ...
        """
        return self._swigobj.imagepoltestimage(_str_ec(outfile), rm, pa0, sigma, nx, ny, nf, f0, bw)
    ...
    def complexlinpol(self, outfile):
        ...
        """
        return self._swigobj.complexlinpol(_str_ec(outfile))
    ...
    def complexfraclinpol(self, outfile):
        ...
        Table tool can access Complex images.
        """
        return self._swigobj.complexfraclinpol(_str_ec(outfile))
    ...
    def depolratio(self, infile, debias=False, clip=float(10.0), sigma=float(-1), outfile=''):
        ...
        sigmadepolratio.
        """
        return _wrap_image(swig_object=self._swigobj.depolratio(_str_ec(infile), debias, clip, sigma, _str_ec(outfile)))
    ...
    def fourierrotationmeasure(self, complex='', amp='', pa='', real='', imag='', zerolag0=False):
        ...
        """
        return self._swigobj.fourierrotationmeasure(_str_ec(complex), _str_ec(amp), _str_ec(pa), _str_ec(real), _str_ec(imag), zerolag0)
    ...
    def fraclinpol(self, debias=False, clip=float(10.0), sigma=float(-1), outfile=''):
        ...
        """
        return _wrap_image(swig_object=self._swigobj.fraclinpol(debias, clip, sigma, _str_ec(outfile)))
    ...
    def fractotpol(self, debias=False, clip=float(10.0), sigma=float(-1), outfile=''):
        ...
        """
        return _wrap_image(swig_object=self._swigobj.fractotpol(debias, clip, sigma, _str_ec(outfile)))
    ...
    def linpolint(self, debias=False, clip=float(10.0), sigma=float(-1), outfile='', region='', mask='', stretch=False):
        ...
        """
        return _wrap_image(swig_object=self._swigobj.linpolint(debias, clip, sigma, _str_ec(outfile), _any_ec(region), _str_ec(mask), stretch))
    ...
    def linpolposang(self, outfile='', region='', mask='', stretch=False):
        ...
        """
        return _wrap_image(swig_object=self._swigobj.linpolposang(_str_ec(outfile), _any_ec(region), _str_ec(mask), stretch))
    ...
    def makecomplex(self, complex, real='', imag='', amp='', phase=''):
        ...
        parts are formed.
        """
        return self._swigobj.makecomplex(_str_ec(complex), _str_ec(real), _str_ec(imag), _str_ec(amp), _str_ec(phase))
    ...
    def open(self, image={ }):
        ...
        """
        return self._swigobj.open(_any_ec(image))
    ...
    def pol(self, which, debias=False, clip=float(10.0), sigma=float(-1), outfile=''):
        ...
        """
        return _wrap_image(swig_object=self._swigobj.pol(_str_ec(which), debias, clip, sigma, _str_ec(outfile)))
    ...
    def rotationmeasure(self, rm='', rmerr='', pa0='', pa0err='', nturns='', chisq='', sigma=float(-1), rmfg=float(0.0), rmmax=float(0.0), maxpaerr=float(1e30), plotter='', nx=int(5), ny=int(5)):
        ...
        """
        return self._swigobj.rotationmeasure(_str_ec(rm), _str_ec(rmerr), _str_ec(pa0), _str_ec(pa0err), _str_ec(nturns), _str_ec(chisq), sigma, rmfg, rmmax, maxpaerr, _str_ec(plotter), nx, ny)
    ...
    def sigma(self, clip=float(10.0)):
        ...
        """
        return self._swigobj.sigma(clip)
    ...
    def sigmadepolratio(self, infile, debias=False, clip=float(10.0), sigma=float(-1), outfile=''):
        ...
        depolratio.
        """
        return _wrap_image(swig_object=self._swigobj.sigmadepolratio(_str_ec(infile), debias, clip, sigma, _str_ec(outfile)))
    ...
    def sigmafraclinpol(self, clip=float(10.0), sigma=float(-1), outfile=''):
        ...
        """
        return _wrap_image(swig_object=self._swigobj.sigmafraclinpol(clip, sigma, _str_ec(outfile)))
    ...
    def sigmafractotpol(self, clip=float(10.0), sigma=float(-1), outfile=''):
        ...
        with outliers from the mean clipped at the specified level.
        """
        return _wrap_image(swig_object=self._swigobj.sigmafractotpol(clip, sigma, _str_ec(outfile)))
    ...
    def sigmalinpolint(self, clip=float(10.0), sigma=float(-1), outfile=''):
        ...
        with outliers from the mean clipped at the specified level.
        """
        return self._swigobj.sigmalinpolint(clip, sigma, _str_ec(outfile))
    ...
    def sigmalinpolposang(self, clip=float(10.0), sigma=float(-1), outfile=''):
        ...
        with outliers from the mean clipped at the specified level.
        """
        return _wrap_image(swig_object=self._swigobj.sigmalinpolposang(clip, sigma, _str_ec(outfile)))
    ...
    def sigmastokes(self, which, clip=float(10.0)):
        ...
        """
        return self._swigobj.sigmastokes(_str_ec(which), clip)
    ...
    def sigmastokesi(self, clip=float(10.0)):
        ...
        level.
        """
        return self._swigobj.sigmastokesi(clip)
    ...
    def sigmastokesq(self, clip=float(10.0)):
        ...
        level.
        """
        return self._swigobj.sigmastokesq(clip)
    ...
    def sigmastokesu(self, clip=float(10.0)):
        ...
        are clipped at the specified level.
        """
        return self._swigobj.sigmastokesu(clip)
    ...
    def sigmastokesv(self, clip=float(10.0)):
        ...
        are clipped at the specified level.
        """
        return self._swigobj.sigmastokesv(clip)
    ...
    def sigmatotpolint(self, clip=float(10.0), sigma=float(-1)):
        ...
        with outliers from the mean clipped at the specified level.
        """
        return self._swigobj.sigmatotpolint(clip, sigma)
    ...
    def totpolint(self, debias=False, clip=float(10.0), sigma=float(-1), outfile='', region='', mask='', stretch=False):
        ...
        then sigma is computed.
        """
        return _wrap_image(swig_object=self._swigobj.totpolint(debias, clip, sigma, _str_ec(outfile), _any_ec(region), _str_ec(mask), stretch))
