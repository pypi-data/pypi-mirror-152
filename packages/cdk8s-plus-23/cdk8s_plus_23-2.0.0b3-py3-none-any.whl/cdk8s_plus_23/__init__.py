...
@jsii.data_type(
    jsii_type="cdk8s-plus-23.ExposeDeploymentViaServiceOptions",
    jsii_struct_bases=[],
    name_mapping={
        "name": "name",
        "port": "port",
...
@jsii.data_type(
    jsii_type="cdk8s-plus-23.GroupProps",
    jsii_struct_bases=[],
...
class Namespaces(metaclass=jsii.JSIIMeta, jsii_type="cdk8s-plus-23.Namespaces"):
...
@jsii.data_type(
    jsii_type="cdk8s-plus-23.PodSelectOptions",
    jsii_struct_bases=[],
    name_mapping={
...
class Pods(metaclass=jsii.JSIIMeta, jsii_type="cdk8s-plus-23.Pods"):
...
@jsii.data_type(
    jsii_type="cdk8s-plus-23.ServicePortOptions",
    jsii_struct_bases=[],
    name_mapping={
        "name": "name",
        "node_port": "nodePort",
...
class User(metaclass=jsii.JSIIMeta, jsii_type="cdk8s-plus-23.User"):
    '''Represents a user.'''
...
@jsii.data_type(
    jsii_type="cdk8s-plus-23.UserProps",
    jsii_struct_bases=[],
    name_mapping={"name": "name"},
)
class UserProps:
...
class Volume(metaclass=jsii.JSIIMeta, jsii_type="cdk8s-plus-23.Volume"):
...
@jsii.implements(ISubject)
class Group(metaclass=jsii.JSIIMeta, jsii_type="cdk8s-plus-23.Group"):
    '''Represents a group.'''
