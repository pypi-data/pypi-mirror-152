...
@jsii.data_type(
    jsii_type="cdk8s-plus-24.ExposeDeploymentViaServiceOptions",
    jsii_struct_bases=[],
    name_mapping={
        "name": "name",
        "port": "port",
...
@jsii.data_type(
    jsii_type="cdk8s-plus-24.GroupProps",
    jsii_struct_bases=[],
...
class Namespaces(metaclass=jsii.JSIIMeta, jsii_type="cdk8s-plus-24.Namespaces"):
...
@jsii.data_type(
    jsii_type="cdk8s-plus-24.PodSelectOptions",
    jsii_struct_bases=[],
    name_mapping={
...
class Pods(metaclass=jsii.JSIIMeta, jsii_type="cdk8s-plus-24.Pods"):
...
@jsii.data_type(
    jsii_type="cdk8s-plus-24.ServicePortOptions",
    jsii_struct_bases=[],
    name_mapping={
        "name": "name",
        "node_port": "nodePort",
...
class User(metaclass=jsii.JSIIMeta, jsii_type="cdk8s-plus-24.User"):
    '''Represents a user.'''
...
@jsii.data_type(
    jsii_type="cdk8s-plus-24.UserProps",
    jsii_struct_bases=[],
    name_mapping={"name": "name"},
)
class UserProps:
...
class Volume(metaclass=jsii.JSIIMeta, jsii_type="cdk8s-plus-24.Volume"):
...
@jsii.implements(ISubject)
class Group(metaclass=jsii.JSIIMeta, jsii_type="cdk8s-plus-24.Group"):
    '''Represents a group.'''
