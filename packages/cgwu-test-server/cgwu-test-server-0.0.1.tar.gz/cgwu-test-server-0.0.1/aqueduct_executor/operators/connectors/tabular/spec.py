...
from aqueduct_executor.operators.utils.storages import config as sconfig
...
def unwrap_connector_config(cls, connector_config, values):
    ...
    if connector_name == common.Name.SALESFORCE:
        return {
            "access_token": connector_config["token"]["access_token"],
            "instance_url": connector_config["public_conf"]["instance_url"],
        }
