...
from aqueduct_executor.operators.utils.storages.parse import parse_storage
...
def setup_connector(
    ...
    elif connector_name == common.Name.SALESFORCE:
        from aqueduct_executor.operators.connectors.tabular.salesforce import (
            SalesforceConnector as OpConnector,
        )
