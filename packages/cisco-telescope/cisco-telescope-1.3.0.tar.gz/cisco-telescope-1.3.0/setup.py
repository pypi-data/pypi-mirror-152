...
['Flask>=2.1.2,<3.0.0',
 ...
 'cisco-opentelemetry-specifications>=0.0.17,<0.0.18',
 ...
 'opentelemetry-distro>=0.31b0,<0.32',
 'opentelemetry-exporter-otlp-proto-grpc>=1.11.1,<2.0.0',
 'opentelemetry-exporter-otlp-proto-http>=1.11.1,<2.0.0',
 'opentelemetry-exporter-otlp>=1.11.1,<2.0.0',
 'opentelemetry-instrumentation-aiohttp-client>=0.31b0,<0.32',
 'opentelemetry-instrumentation-fastapi>=0.31b0,<0.32',
 'opentelemetry-instrumentation-flask>=0.31b0,<0.32',
 'opentelemetry-instrumentation-grpc>=0.31b0,<0.32',
 'opentelemetry-instrumentation-httpx>=0.31b0,<0.32',
 'opentelemetry-instrumentation-requests>=0.31b0,<0.32',
 'opentelemetry-util-http>=0.31b0,<0.32',
