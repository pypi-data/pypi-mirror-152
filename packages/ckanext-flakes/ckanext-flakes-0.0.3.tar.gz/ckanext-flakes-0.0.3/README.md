...
3. Add `flakes` to the `ckan.plugins` setting in your CKAN
...
**TODO:** Document any optional config settings here. For example:
	...
	# (optional, default: 24).
	ckanext.flakes.some_setting = some_default_value
...
## Releasing a new version of ckanext-flakes

If ckanext-flakes should be available on PyPI you can follow these steps to publish a new version:
