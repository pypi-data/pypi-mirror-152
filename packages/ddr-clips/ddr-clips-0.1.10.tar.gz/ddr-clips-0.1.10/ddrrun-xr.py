...
def main():
    ...
    parser.add_option("--action", dest="action", type="string", default='/guest-share/ddr/ddr-action.1',
                      help="Relative path to the file containing the external application facts")
    parser.add_option("--log", dest="log", type="string", default='/guest-share/ddr/ddr-log',
