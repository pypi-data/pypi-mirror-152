...
def time_string(ts, color=False, base=10, isoformat=False):
...
def main(argv=None):
    ...
    parser.add_argument('--iso8601', default=False, action='store_true',
                        help="iso8601 like format: YYY:M:W:DTH:MM:SSZ")
