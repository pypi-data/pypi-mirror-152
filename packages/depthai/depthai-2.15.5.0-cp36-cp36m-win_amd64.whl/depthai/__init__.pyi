...
class DeviceBase:
    ...
    def setIrFloodLightBrightness(self, mA: float, mask: int = ...) -> None: ...
    def setIrLaserDotProjectorBrightness(self, mA: float, mask: int = ...) -> None: ...
...
class Node:
    ...
    class Input:
        ...
        waitForMessage: Node.Input.Type
        def __init__(self, *args, **kwargs) -> None: ...
        def getBlocking(self) -> bool: ...
