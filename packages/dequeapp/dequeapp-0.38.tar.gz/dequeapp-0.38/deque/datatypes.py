        ...
        if isinstance(data, list):
            ...
            if isinstance(data, PILImage.Image):
                ...
                if not isinstance(box_data, dict):
                    raise ValueError("box_data must be of type dict. The key can be string and value can be a list of boxes with dimensions described as min_x, min_y, max_x, max_y ")
