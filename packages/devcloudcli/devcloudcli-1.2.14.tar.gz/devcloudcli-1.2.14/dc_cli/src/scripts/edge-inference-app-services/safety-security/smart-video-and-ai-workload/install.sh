...
if (source /etc/environment && sudo systemctl daemon-reload && export no_proxy="localhost,127.0.0.1"); then
        echo "Proxy updation successful"
else
        echo "Proxy updation failed"
