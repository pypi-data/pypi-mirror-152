...
class Notifications(BaseMailRequest):
    ...
    def update_notification(
        ...
        response = requests.post(
            settings.UPDATE_NOTIFICATION_API_URL.format(notification_id=notification_id),
            headers=get_headers(_api_key),
            json={
                "site_domain": site_domain,
                "object_id": object_id,
    ...
    def delete_notification(
        ...
        response = requests.delete(
            settings.DELETE_NOTIFICATION_API_URL.format(notification_id=notification_id),
            headers=get_headers(_api_key),
            json={
                "id": id,
                "site_domain": site_domain,
    ...
    def delete_topic(
        ...
        response = requests.delete(
            settings.DELETE_TOPIC_API_URL.format(topic_id=id),
            headers=get_headers(_api_key),
            json={
                "site_domain": site_domain,
            },
