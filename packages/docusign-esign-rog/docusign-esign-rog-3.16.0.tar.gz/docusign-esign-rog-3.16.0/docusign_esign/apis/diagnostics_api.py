...
class DiagnosticsApi(object):
    ...
    def delete_request_logs(self, **kwargs):
        ...
        if kwargs.get('callback'):
            return self.delete_request_logs_with_http_info(**kwargs)
        else:
            (data) = self.delete_request_logs_with_http_info(**kwargs)
            return data
    ...
    def delete_request_logs_with_http_info(self, **kwargs):
        ...
        resource_path = '/v2.1/diagnostics/request_logs'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_request_log(self, request_log_id, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_request_log_with_http_info(request_log_id, **kwargs)
        else:
            (data) = self.get_request_log_with_http_info(request_log_id, **kwargs)
            return data
    ...
    def get_request_log_with_http_info(self, request_log_id, **kwargs):
        ...
        if ('request_log_id' not in params) or (params['request_log_id'] is None):
            raise ValueError("Missing the required parameter `request_log_id` when calling `get_request_log`")


        collection_formats = {}

        resource_path = '/v2.1/diagnostics/request_logs/{requestLogId}'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_request_log_settings(self, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_request_log_settings_with_http_info(**kwargs)
        else:
            (data) = self.get_request_log_settings_with_http_info(**kwargs)
            return data
    ...
    def get_request_log_settings_with_http_info(self, **kwargs):
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_request_log_settings" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        resource_path = '/v2.1/diagnostics/settings'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_resources_with_http_info(self, **kwargs):
        ...
        resource_path = '/v2.1'.replace('{format}', 'json')
        path_params = {}
        ...
        return self.api_client.call_api(resource_path, 'GET',
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='ResourceInformation',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
    ...
    def get_service(self, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_service_with_http_info(**kwargs)
        else:
            (data) = self.get_service_with_http_info(**kwargs)
            return data
    ...
    def list_request_logs(self, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.list_request_logs_with_http_info(**kwargs)
        else:
            (data) = self.list_request_logs_with_http_info(**kwargs)
            return data
    ...
    def update_request_log_settings(self, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.update_request_log_settings_with_http_info(**kwargs)
        else:
            (data) = self.update_request_log_settings_with_http_info(**kwargs)
            return data
