...
class SigningGroupsApi(object):
    ...
    def create_list_with_http_info(self, account_id, **kwargs):
        ...
        resource_path = '/v2.1/accounts/{accountId}/signing_groups'.replace('{format}', 'json')
        path_params = {}
    ...
    def delete_users_with_http_info(self, account_id, signing_group_id, **kwargs):
        ...
        resource_path = '/v2.1/accounts/{accountId}/signing_groups/{signingGroupId}/users'.replace('{format}', 'json')
        path_params = {}
        if 'account_id' in params:
            path_params['accountId'] = params['account_id']
    ...
    def get_with_http_info(self, account_id, signing_group_id, **kwargs):
        ...
        resource_path = '/v2.1/accounts/{accountId}/signing_groups/{signingGroupId}'.replace('{format}', 'json')
        path_params = {}
        if 'account_id' in params:
            path_params['accountId'] = params['account_id']
        if 'signing_group_id' in params:
