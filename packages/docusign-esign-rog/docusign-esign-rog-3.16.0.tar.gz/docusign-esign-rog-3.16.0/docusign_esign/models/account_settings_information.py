...
class AccountSettingsInformation(object):
    ...
    def __init__(self, _configuration=None, **kwargs):  # noqa: E501
        ...
        setattr(self, "_{}".format('access_code_format'), kwargs.get('access_code_format', None))
        setattr(self, "_{}".format('account_date_time_format'), kwargs.get('account_date_time_format', None))
        setattr(self, "_{}".format('account_date_time_format_metadata'), kwargs.get('account_date_time_format_metadata', None))
        setattr(self, "_{}".format('account_default_language'), kwargs.get('account_default_language', None))
        setattr(self, "_{}".format('account_default_language_metadata'), kwargs.get('account_default_language_metadata', None))
        ...
        setattr(self, "_{}".format('allow_consumer_disclosure_override'), kwargs.get('allow_consumer_disclosure_override', None))
        ...
        setattr(self, "_{}".format('allow_e_note_e_original_metadata'), kwargs.get('allow_e_note_e_original_metadata', None))
        setattr(self, "_{}".format('allow_envelope_correct'), kwargs.get('allow_envelope_correct', None))
        setattr(self, "_{}".format('allow_envelope_correct_metadata'), kwargs.get('allow_envelope_correct_metadata', None))
        setattr(self, "_{}".format('allow_envelope_custody_transfer'), kwargs.get('allow_envelope_custody_transfer', None))
        setattr(self, "_{}".format('allow_envelope_custody_transfer_metadata'), kwargs.get('allow_envelope_custody_transfer_metadata', None))
        setattr(self, "_{}".format('allow_envelope_custom_fields'), kwargs.get('allow_envelope_custom_fields', None))
        setattr(self, "_{}".format('allow_envelope_custom_fields_metadata'), kwargs.get('allow_envelope_custom_fields_metadata', None))
        setattr(self, "_{}".format('allow_envelope_publish_reporting'), kwargs.get('allow_envelope_publish_reporting', None))
        setattr(self, "_{}".format('allow_envelope_publish_reporting_metadata'), kwargs.get('allow_envelope_publish_reporting_metadata', None))
        setattr(self, "_{}".format('allow_envelope_reporting'), kwargs.get('allow_envelope_reporting', None))
        setattr(self, "_{}".format('allow_envelope_reporting_metadata'), kwargs.get('allow_envelope_reporting_metadata', None))
        setattr(self, "_{}".format('allow_expression'), kwargs.get('allow_expression', None))
        setattr(self, "_{}".format('allow_expression_metadata'), kwargs.get('allow_expression_metadata', None))
        setattr(self, "_{}".format('allow_express_signer_certificate'), kwargs.get('allow_express_signer_certificate', None))
        setattr(self, "_{}".format('allow_express_signer_certificate_metadata'), kwargs.get('allow_express_signer_certificate_metadata', None))
        setattr(self, "_{}".format('allow_extended_sending_resource_file'), kwargs.get('allow_extended_sending_resource_file', None))
        setattr(self, "_{}".format('allow_extended_sending_resource_file_metadata'), kwargs.get('allow_extended_sending_resource_file_metadata', None))
        setattr(self, "_{}".format('allow_external_linked_accounts'), kwargs.get('allow_external_linked_accounts', None))
        ...
        setattr(self, "_{}".format('allow_member_time_zone_metadata'), kwargs.get('allow_member_time_zone_metadata', None))
        setattr(self, "_{}".format('allow_merge_fields'), kwargs.get('allow_merge_fields', None))
        setattr(self, "_{}".format('allow_merge_fields_metadata'), kwargs.get('allow_merge_fields_metadata', None))
        setattr(self, "_{}".format('allow_multiple_brand_profiles'), kwargs.get('allow_multiple_brand_profiles', None))
        setattr(self, "_{}".format('allow_multiple_brand_profiles_metadata'), kwargs.get('allow_multiple_brand_profiles_metadata', None))
        setattr(self, "_{}".format('allow_multiple_signer_attachments'), kwargs.get('allow_multiple_signer_attachments', None))
        setattr(self, "_{}".format('allow_multiple_signer_attachments_metadata'), kwargs.get('allow_multiple_signer_attachments_metadata', None))
        setattr(self, "_{}".format('allow_non_us_phone_auth'), kwargs.get('allow_non_us_phone_auth', None))
        setattr(self, "_{}".format('allow_non_us_phone_auth_metadata'), kwargs.get('allow_non_us_phone_auth_metadata', None))
        setattr(self, "_{}".format('allow_ocr_of_envelope_documents'), kwargs.get('allow_ocr_of_envelope_documents', None))
        ...
        setattr(self, "_{}".format('allow_phone_auth_override_metadata'), kwargs.get('allow_phone_auth_override_metadata', None))
        setattr(self, "_{}".format('allow_private_signing_groups'), kwargs.get('allow_private_signing_groups', None))
        setattr(self, "_{}".format('allow_private_signing_groups_metadata'), kwargs.get('allow_private_signing_groups_metadata', None))
        setattr(self, "_{}".format('allow_recipient_connect'), kwargs.get('allow_recipient_connect', None))
        setattr(self, "_{}".format('allow_recipient_connect_metadata'), kwargs.get('allow_recipient_connect_metadata', None))
        setattr(self, "_{}".format('allow_reminders'), kwargs.get('allow_reminders', None))
        setattr(self, "_{}".format('allow_reminders_metadata'), kwargs.get('allow_reminders_metadata', None))
        setattr(self, "_{}".format('allow_remote_notary'), kwargs.get('allow_remote_notary', None))
        setattr(self, "_{}".format('allow_remote_notary_metadata'), kwargs.get('allow_remote_notary_metadata', None))
        setattr(self, "_{}".format('allow_resource_file_branding'), kwargs.get('allow_resource_file_branding', None))
        ...
        setattr(self, "_{}".format('allow_send_to_intermediary_metadata'), kwargs.get('allow_send_to_intermediary_metadata', None))
        setattr(self, "_{}".format('allow_server_templates'), kwargs.get('allow_server_templates', None))
        setattr(self, "_{}".format('allow_server_templates_metadata'), kwargs.get('allow_server_templates_metadata', None))
        setattr(self, "_{}".format('allow_set_embedded_recipient_start_url'), kwargs.get('allow_set_embedded_recipient_start_url', None))
        setattr(self, "_{}".format('allow_set_embedded_recipient_start_url_metadata'), kwargs.get('allow_set_embedded_recipient_start_url_metadata', None))
        setattr(self, "_{}".format('allow_shared_tabs'), kwargs.get('allow_shared_tabs', None))
        setattr(self, "_{}".format('allow_shared_tabs_metadata'), kwargs.get('allow_shared_tabs_metadata', None))
        setattr(self, "_{}".format('allow_signature_stamps'), kwargs.get('allow_signature_stamps', None))
        setattr(self, "_{}".format('allow_signature_stamps_metadata'), kwargs.get('allow_signature_stamps_metadata', None))
        setattr(self, "_{}".format('allow_sign_document_from_home_page'), kwargs.get('allow_sign_document_from_home_page', None))
        setattr(self, "_{}".format('allow_sign_document_from_home_page_metadata'), kwargs.get('allow_sign_document_from_home_page_metadata', None))
        setattr(self, "_{}".format('allow_signer_reassign'), kwargs.get('allow_signer_reassign', None))
        setattr(self, "_{}".format('allow_signer_reassign_metadata'), kwargs.get('allow_signer_reassign_metadata', None))
        setattr(self, "_{}".format('allow_signer_reassign_override'), kwargs.get('allow_signer_reassign_override', None))
        setattr(self, "_{}".format('allow_signer_reassign_override_metadata'), kwargs.get('allow_signer_reassign_override_metadata', None))
        setattr(self, "_{}".format('allow_signing_extensions'), kwargs.get('allow_signing_extensions', None))
        setattr(self, "_{}".format('allow_signing_extensions_metadata'), kwargs.get('allow_signing_extensions_metadata', None))
        setattr(self, "_{}".format('allow_signing_groups'), kwargs.get('allow_signing_groups', None))
        setattr(self, "_{}".format('allow_signing_groups_metadata'), kwargs.get('allow_signing_groups_metadata', None))
        setattr(self, "_{}".format('allow_signing_insights'), kwargs.get('allow_signing_insights', None))
        setattr(self, "_{}".format('allow_signing_insights_metadata'), kwargs.get('allow_signing_insights_metadata', None))
        setattr(self, "_{}".format('allow_signing_radio_deselect'), kwargs.get('allow_signing_radio_deselect', None))
        setattr(self, "_{}".format('allow_signing_radio_deselect_metadata'), kwargs.get('allow_signing_radio_deselect_metadata', None))
        setattr(self, "_{}".format('allow_sign_now'), kwargs.get('allow_sign_now', None))
        setattr(self, "_{}".format('allow_sign_now_metadata'), kwargs.get('allow_sign_now_metadata', None))
        setattr(self, "_{}".format('allow_sms_delivery'), kwargs.get('allow_sms_delivery', None))
        setattr(self, "_{}".format('allow_sms_delivery_metadata'), kwargs.get('allow_sms_delivery_metadata', None))
        setattr(self, "_{}".format('allow_social_id_login'), kwargs.get('allow_social_id_login', None))
        ...
        setattr(self, "_{}".format('anchor_tag_versioned_placement_metadata_enabled'), kwargs.get('anchor_tag_versioned_placement_metadata_enabled', None))
        setattr(self, "_{}".format('attach_completed_envelope'), kwargs.get('attach_completed_envelope', None))
        setattr(self, "_{}".format('attach_completed_envelope_metadata'), kwargs.get('attach_completed_envelope_metadata', None))
        setattr(self, "_{}".format('authentication_check'), kwargs.get('authentication_check', None))
        setattr(self, "_{}".format('authentication_check_metadata'), kwargs.get('authentication_check_metadata', None))
        setattr(self, "_{}".format('auto_nav_rule'), kwargs.get('auto_nav_rule', None))
        setattr(self, "_{}".format('auto_nav_rule_metadata'), kwargs.get('auto_nav_rule_metadata', None))
        setattr(self, "_{}".format('auto_provision_signer_account'), kwargs.get('auto_provision_signer_account', None))
        setattr(self, "_{}".format('auto_provision_signer_account_metadata'), kwargs.get('auto_provision_signer_account_metadata', None))
        setattr(self, "_{}".format('bcc_email_archive'), kwargs.get('bcc_email_archive', None))
        setattr(self, "_{}".format('bcc_email_archive_metadata'), kwargs.get('bcc_email_archive_metadata', None))
        setattr(self, "_{}".format('beta_switch_configuration'), kwargs.get('beta_switch_configuration', None))
        setattr(self, "_{}".format('beta_switch_configuration_metadata'), kwargs.get('beta_switch_configuration_metadata', None))
        ...
        setattr(self, "_{}".format('can_self_brand_send'), kwargs.get('can_self_brand_send', None))
        setattr(self, "_{}".format('can_self_brand_send_metadata'), kwargs.get('can_self_brand_send_metadata', None))
        setattr(self, "_{}".format('can_self_brand_sign'), kwargs.get('can_self_brand_sign', None))
        setattr(self, "_{}".format('can_self_brand_sign_metadata'), kwargs.get('can_self_brand_sign_metadata', None))
        setattr(self, "_{}".format('can_use_salesforce_o_auth'), kwargs.get('can_use_salesforce_o_auth', None))
        ...
        setattr(self, "_{}".format('comments_allow_envelope_override_metadata'), kwargs.get('comments_allow_envelope_override_metadata', None))
        setattr(self, "_{}".format('conditional_fields_enabled'), kwargs.get('conditional_fields_enabled', None))
        setattr(self, "_{}".format('conditional_fields_enabled_metadata'), kwargs.get('conditional_fields_enabled_metadata', None))
        setattr(self, "_{}".format('consumer_disclosure_frequency'), kwargs.get('consumer_disclosure_frequency', None))
        ...
        setattr(self, "_{}".format('disable_mobile_push_notifications_metadata'), kwargs.get('disable_mobile_push_notifications_metadata', None))
        setattr(self, "_{}".format('disable_mobile_sending'), kwargs.get('disable_mobile_sending', None))
        setattr(self, "_{}".format('disable_mobile_sending_metadata'), kwargs.get('disable_mobile_sending_metadata', None))
        setattr(self, "_{}".format('disable_multiple_sessions'), kwargs.get('disable_multiple_sessions', None))
        setattr(self, "_{}".format('disable_multiple_sessions_metadata'), kwargs.get('disable_multiple_sessions_metadata', None))
        setattr(self, "_{}".format('disable_purge_notifications_for_sender_metadata'), kwargs.get('disable_purge_notifications_for_sender_metadata', None))
        setattr(self, "_{}".format('disable_signer_cert_view'), kwargs.get('disable_signer_cert_view', None))
        setattr(self, "_{}".format('disable_signer_cert_view_metadata'), kwargs.get('disable_signer_cert_view_metadata', None))
        setattr(self, "_{}".format('disable_signer_history_view'), kwargs.get('disable_signer_history_view', None))
        setattr(self, "_{}".format('disable_signer_history_view_metadata'), kwargs.get('disable_signer_history_view_metadata', None))
        setattr(self, "_{}".format('disable_style_signature'), kwargs.get('disable_style_signature', None))
        setattr(self, "_{}".format('disable_style_signature_metadata'), kwargs.get('disable_style_signature_metadata', None))
        setattr(self, "_{}".format('disable_upload_signature'), kwargs.get('disable_upload_signature', None))
        setattr(self, "_{}".format('disable_upload_signature_metadata'), kwargs.get('disable_upload_signature_metadata', None))
        setattr(self, "_{}".format('disable_user_sharing'), kwargs.get('disable_user_sharing', None))
        setattr(self, "_{}".format('disable_user_sharing_metadata'), kwargs.get('disable_user_sharing_metadata', None))
        setattr(self, "_{}".format('display_beta_switch'), kwargs.get('display_beta_switch', None))
        setattr(self, "_{}".format('display_beta_switch_metadata'), kwargs.get('display_beta_switch_metadata', None))
        setattr(self, "_{}".format('document_conversion_restrictions'), kwargs.get('document_conversion_restrictions', None))
        setattr(self, "_{}".format('document_conversion_restrictions_metadata'), kwargs.get('document_conversion_restrictions_metadata', None))
        setattr(self, "_{}".format('document_retention'), kwargs.get('document_retention', None))
        setattr(self, "_{}".format('document_retention_metadata'), kwargs.get('document_retention_metadata', None))
        ...
        setattr(self, "_{}".format('enable_advanced_power_forms_metadata'), kwargs.get('enable_advanced_power_forms_metadata', None))
        setattr(self, "_{}".format('enable_agreement_actions_for_clm'), kwargs.get('enable_agreement_actions_for_clm', None))
        ...
        setattr(self, "_{}".format('enable_pdfa_conversion_metadata'), kwargs.get('enable_pdfa_conversion_metadata', None))
        setattr(self, "_{}".format('enable_power_form'), kwargs.get('enable_power_form', None))
        setattr(self, "_{}".format('enable_power_form_direct'), kwargs.get('enable_power_form_direct', None))
        setattr(self, "_{}".format('enable_power_form_direct_metadata'), kwargs.get('enable_power_form_direct_metadata', None))
        setattr(self, "_{}".format('enable_power_form_metadata'), kwargs.get('enable_power_form_metadata', None))
        setattr(self, "_{}".format('enable_recipient_domain_validation'), kwargs.get('enable_recipient_domain_validation', None))
        setattr(self, "_{}".format('enable_recipient_domain_validation_metadata'), kwargs.get('enable_recipient_domain_validation_metadata', None))
        setattr(self, "_{}".format('enable_recipient_may_provide_phone_number'), kwargs.get('enable_recipient_may_provide_phone_number', None))
        setattr(self, "_{}".format('enable_recipient_may_provide_phone_number_metadata'), kwargs.get('enable_recipient_may_provide_phone_number_metadata', None))
        setattr(self, "_{}".format('enable_report_links'), kwargs.get('enable_report_links', None))
        setattr(self, "_{}".format('enable_report_links_metadata'), kwargs.get('enable_report_links_metadata', None))
        setattr(self, "_{}".format('enable_require_sign_on_paper'), kwargs.get('enable_require_sign_on_paper', None))
        setattr(self, "_{}".format('enable_require_sign_on_paper_metadata'), kwargs.get('enable_require_sign_on_paper_metadata', None))
        setattr(self, "_{}".format('enable_reserved_domain'), kwargs.get('enable_reserved_domain', None))
        ...
        setattr(self, "_{}".format('enable_sending_tags_font_settings_metadata'), kwargs.get('enable_sending_tags_font_settings_metadata', None))
        setattr(self, "_{}".format('enable_send_to_agent'), kwargs.get('enable_send_to_agent', None))
        setattr(self, "_{}".format('enable_send_to_agent_metadata'), kwargs.get('enable_send_to_agent_metadata', None))
        setattr(self, "_{}".format('enable_send_to_intermediary'), kwargs.get('enable_send_to_intermediary', None))
        setattr(self, "_{}".format('enable_send_to_intermediary_metadata'), kwargs.get('enable_send_to_intermediary_metadata', None))
        setattr(self, "_{}".format('enable_send_to_manage'), kwargs.get('enable_send_to_manage', None))
        setattr(self, "_{}".format('enable_send_to_manage_metadata'), kwargs.get('enable_send_to_manage_metadata', None))
        ...
        setattr(self, "_{}".format('enable_sign_on_paper_metadata'), kwargs.get('enable_sign_on_paper_metadata', None))
        ...
        setattr(self, "_{}".format('enable_sign_with_notary'), kwargs.get('enable_sign_with_notary', None))
        setattr(self, "_{}".format('enable_sign_with_notary_metadata'), kwargs.get('enable_sign_with_notary_metadata', None))
        setattr(self, "_{}".format('enable_smart_contracts'), kwargs.get('enable_smart_contracts', None))
        setattr(self, "_{}".format('enable_smart_contracts_metadata'), kwargs.get('enable_smart_contracts_metadata', None))
        setattr(self, "_{}".format('enable_sms_authentication'), kwargs.get('enable_sms_authentication', None))
        ...
        setattr(self, "_{}".format('express_send_metadata'), kwargs.get('express_send_metadata', None))
        setattr(self, "_{}".format('external_document_sources'), kwargs.get('external_document_sources', None))
        setattr(self, "_{}".format('external_signature_pad_type'), kwargs.get('external_signature_pad_type', None))
        ...
        setattr(self, "_{}".format('hide_pricing_metadata'), kwargs.get('hide_pricing_metadata', None))
        setattr(self, "_{}".format('id_check_configurations'), kwargs.get('id_check_configurations', None))
        setattr(self, "_{}".format('id_check_expire'), kwargs.get('id_check_expire', None))
        setattr(self, "_{}".format('id_check_expire_days'), kwargs.get('id_check_expire_days', None))
        setattr(self, "_{}".format('id_check_expire_days_metadata'), kwargs.get('id_check_expire_days_metadata', None))
        setattr(self, "_{}".format('id_check_expire_metadata'), kwargs.get('id_check_expire_metadata', None))
        setattr(self, "_{}".format('id_check_expire_minutes'), kwargs.get('id_check_expire_minutes', None))
        setattr(self, "_{}".format('id_check_expire_minutes_metadata'), kwargs.get('id_check_expire_minutes_metadata', None))
        ...
        setattr(self, "_{}".format('in_person_id_check_question_metadata'), kwargs.get('in_person_id_check_question_metadata', None))
        setattr(self, "_{}".format('in_person_signing_enabled'), kwargs.get('in_person_signing_enabled', None))
        setattr(self, "_{}".format('in_person_signing_enabled_metadata'), kwargs.get('in_person_signing_enabled_metadata', None))
        setattr(self, "_{}".format('in_session_enabled'), kwargs.get('in_session_enabled', None))
        ...
        setattr(self, "_{}".format('require_decline_reason_metadata'), kwargs.get('require_decline_reason_metadata', None))
        setattr(self, "_{}".format('require_external_user_management'), kwargs.get('require_external_user_management', None))
        setattr(self, "_{}".format('require_external_user_management_metadata'), kwargs.get('require_external_user_management_metadata', None))
        setattr(self, "_{}".format('require_signer_certificate_type'), kwargs.get('require_signer_certificate_type', None))
        setattr(self, "_{}".format('require_signer_certificate_type_metadata'), kwargs.get('require_signer_certificate_type_metadata', None))
        setattr(self, "_{}".format('rsa_verid_account_name'), kwargs.get('rsa_verid_account_name', None))
        ...
        setattr(self, "_{}".format('self_signed_recipient_email_document_user_override_metadata'), kwargs.get('self_signed_recipient_email_document_user_override_metadata', None))
        setattr(self, "_{}".format('sender_can_sign_in_each_location'), kwargs.get('sender_can_sign_in_each_location', None))
        setattr(self, "_{}".format('sender_can_sign_in_each_location_metadata'), kwargs.get('sender_can_sign_in_each_location_metadata', None))
        setattr(self, "_{}".format('sender_must_authenticate_signing'), kwargs.get('sender_must_authenticate_signing', None))
        setattr(self, "_{}".format('sender_must_authenticate_signing_metadata'), kwargs.get('sender_must_authenticate_signing_metadata', None))
        setattr(self, "_{}".format('sending_tags_font_color'), kwargs.get('sending_tags_font_color', None))
        setattr(self, "_{}".format('sending_tags_font_color_metadata'), kwargs.get('sending_tags_font_color_metadata', None))
        setattr(self, "_{}".format('sending_tags_font_name'), kwargs.get('sending_tags_font_name', None))
        ...
        setattr(self, "_{}".format('session_timeout_metadata'), kwargs.get('session_timeout_metadata', None))
        setattr(self, "_{}".format('set_recip_email_lang'), kwargs.get('set_recip_email_lang', None))
        setattr(self, "_{}".format('set_recip_email_lang_metadata'), kwargs.get('set_recip_email_lang_metadata', None))
        setattr(self, "_{}".format('set_recip_sign_lang'), kwargs.get('set_recip_sign_lang', None))
        setattr(self, "_{}".format('set_recip_sign_lang_metadata'), kwargs.get('set_recip_sign_lang_metadata', None))
        setattr(self, "_{}".format('shared_template_folders'), kwargs.get('shared_template_folders', None))
        setattr(self, "_{}".format('shared_template_folders_metadata'), kwargs.get('shared_template_folders_metadata', None))
        setattr(self, "_{}".format('show_complete_dialog_in_embedded_session'), kwargs.get('show_complete_dialog_in_embedded_session', None))
        setattr(self, "_{}".format('show_complete_dialog_in_embedded_session_metadata'), kwargs.get('show_complete_dialog_in_embedded_session_metadata', None))
        setattr(self, "_{}".format('show_conditional_routing_on_send'), kwargs.get('show_conditional_routing_on_send', None))
        setattr(self, "_{}".format('show_conditional_routing_on_send_metadata'), kwargs.get('show_conditional_routing_on_send_metadata', None))
        setattr(self, "_{}".format('show_initial_conditional_fields'), kwargs.get('show_initial_conditional_fields', None))
        setattr(self, "_{}".format('show_initial_conditional_fields_metadata'), kwargs.get('show_initial_conditional_fields_metadata', None))
        setattr(self, "_{}".format('show_localized_watermarks'), kwargs.get('show_localized_watermarks', None))
        setattr(self, "_{}".format('show_localized_watermarks_metadata'), kwargs.get('show_localized_watermarks_metadata', None))
        setattr(self, "_{}".format('show_masked_fields_when_downloading_document_as_sender'), kwargs.get('show_masked_fields_when_downloading_document_as_sender', None))
        setattr(self, "_{}".format('show_masked_fields_when_downloading_document_as_sender_metadata'), kwargs.get('show_masked_fields_when_downloading_document_as_sender_metadata', None))
        setattr(self, "_{}".format('show_tutorials'), kwargs.get('show_tutorials', None))
        setattr(self, "_{}".format('show_tutorials_metadata'), kwargs.get('show_tutorials_metadata', None))
        setattr(self, "_{}".format('signature_providers'), kwargs.get('signature_providers', None))
        setattr(self, "_{}".format('signature_providers_metadata'), kwargs.get('signature_providers_metadata', None))
        setattr(self, "_{}".format('sign_date_format'), kwargs.get('sign_date_format', None))
        setattr(self, "_{}".format('sign_date_format_metadata'), kwargs.get('sign_date_format_metadata', None))
        setattr(self, "_{}".format('sign_date_time_account_language_override'), kwargs.get('sign_date_time_account_language_override', None))
        setattr(self, "_{}".format('sign_date_time_account_language_override_metadata'), kwargs.get('sign_date_time_account_language_override_metadata', None))
        setattr(self, "_{}".format('sign_date_time_account_timezone_override'), kwargs.get('sign_date_time_account_timezone_override', None))
        setattr(self, "_{}".format('sign_date_time_account_timezone_override_metadata'), kwargs.get('sign_date_time_account_timezone_override_metadata', None))
        setattr(self, "_{}".format('signer_attach_certificate_to_envelope_pdf'), kwargs.get('signer_attach_certificate_to_envelope_pdf', None))
        setattr(self, "_{}".format('signer_attach_certificate_to_envelope_pdf_metadata'), kwargs.get('signer_attach_certificate_to_envelope_pdf_metadata', None))
        setattr(self, "_{}".format('signer_attach_concat'), kwargs.get('signer_attach_concat', None))
        setattr(self, "_{}".format('signer_attach_concat_metadata'), kwargs.get('signer_attach_concat_metadata', None))
        setattr(self, "_{}".format('signer_can_create_account'), kwargs.get('signer_can_create_account', None))
        setattr(self, "_{}".format('signer_can_create_account_metadata'), kwargs.get('signer_can_create_account_metadata', None))
        setattr(self, "_{}".format('signer_can_sign_on_mobile'), kwargs.get('signer_can_sign_on_mobile', None))
        setattr(self, "_{}".format('signer_can_sign_on_mobile_metadata'), kwargs.get('signer_can_sign_on_mobile_metadata', None))
        setattr(self, "_{}".format('signer_in_session_use_envelope_complete_email'), kwargs.get('signer_in_session_use_envelope_complete_email', None))
        setattr(self, "_{}".format('signer_in_session_use_envelope_complete_email_metadata'), kwargs.get('signer_in_session_use_envelope_complete_email_metadata', None))
        setattr(self, "_{}".format('signer_login_requirements'), kwargs.get('signer_login_requirements', None))
        setattr(self, "_{}".format('signer_login_requirements_metadata'), kwargs.get('signer_login_requirements_metadata', None))
        setattr(self, "_{}".format('signer_must_have_account'), kwargs.get('signer_must_have_account', None))
        setattr(self, "_{}".format('signer_must_have_account_metadata'), kwargs.get('signer_must_have_account_metadata', None))
        setattr(self, "_{}".format('signer_must_login_to_sign'), kwargs.get('signer_must_login_to_sign', None))
        setattr(self, "_{}".format('signer_must_login_to_sign_metadata'), kwargs.get('signer_must_login_to_sign_metadata', None))
        setattr(self, "_{}".format('signer_show_secure_field_initial_values'), kwargs.get('signer_show_secure_field_initial_values', None))
        setattr(self, "_{}".format('signer_show_secure_field_initial_values_metadata'), kwargs.get('signer_show_secure_field_initial_values_metadata', None))
        setattr(self, "_{}".format('signing_session_timeout'), kwargs.get('signing_session_timeout', None))
        setattr(self, "_{}".format('signing_session_timeout_metadata'), kwargs.get('signing_session_timeout_metadata', None))
        setattr(self, "_{}".format('signing_ui_version'), kwargs.get('signing_ui_version', None))
        setattr(self, "_{}".format('signing_ui_version_metadata'), kwargs.get('signing_ui_version_metadata', None))
        setattr(self, "_{}".format('sign_time_format'), kwargs.get('sign_time_format', None))
        setattr(self, "_{}".format('sign_time_format_metadata'), kwargs.get('sign_time_format_metadata', None))
        setattr(self, "_{}".format('sign_time_show_am_pm'), kwargs.get('sign_time_show_am_pm', None))
        setattr(self, "_{}".format('sign_time_show_am_pm_metadata'), kwargs.get('sign_time_show_am_pm_metadata', None))
        setattr(self, "_{}".format('simplified_sending_enabled'), kwargs.get('simplified_sending_enabled', None))
        setattr(self, "_{}".format('simplified_sending_enabled_metadata'), kwargs.get('simplified_sending_enabled_metadata', None))
        setattr(self, "_{}".format('single_sign_on_enabled'), kwargs.get('single_sign_on_enabled', None))
        setattr(self, "_{}".format('single_sign_on_enabled_metadata'), kwargs.get('single_sign_on_enabled_metadata', None))
        setattr(self, "_{}".format('skip_auth_completed_envelopes'), kwargs.get('skip_auth_completed_envelopes', None))
        setattr(self, "_{}".format('skip_auth_completed_envelopes_metadata'), kwargs.get('skip_auth_completed_envelopes_metadata', None))
        setattr(self, "_{}".format('social_id_recip_auth'), kwargs.get('social_id_recip_auth', None))
        setattr(self, "_{}".format('social_id_recip_auth_metadata'), kwargs.get('social_id_recip_auth_metadata', None))
        setattr(self, "_{}".format('specify_document_visibility'), kwargs.get('specify_document_visibility', None))
        setattr(self, "_{}".format('specify_document_visibility_metadata'), kwargs.get('specify_document_visibility_metadata', None))
        setattr(self, "_{}".format('start_in_advanced_correct'), kwargs.get('start_in_advanced_correct', None))
        setattr(self, "_{}".format('start_in_advanced_correct_metadata'), kwargs.get('start_in_advanced_correct_metadata', None))
        ...
        setattr(self, "_{}".format('suppress_certificate_enforcement'), kwargs.get('suppress_certificate_enforcement', None))
        setattr(self, "_{}".format('suppress_certificate_enforcement_metadata'), kwargs.get('suppress_certificate_enforcement_metadata', None))
        setattr(self, "_{}".format('tab_account_settings'), kwargs.get('tab_account_settings', None))
        setattr(self, "_{}".format('timezone_offset_api'), kwargs.get('timezone_offset_api', None))
        setattr(self, "_{}".format('timezone_offset_api_metadata'), kwargs.get('timezone_offset_api_metadata', None))
        ...
        setattr(self, "_{}".format('use_consumer_disclosure_metadata'), kwargs.get('use_consumer_disclosure_metadata', None))
        ...
        setattr(self, "_{}".format('use_derived_keys'), kwargs.get('use_derived_keys', None))
        ...
        setattr(self, "_{}".format('validations_brand_metadata'), kwargs.get('validations_brand_metadata', None))
        setattr(self, "_{}".format('validations_cadence'), kwargs.get('validations_cadence', None))
        setattr(self, "_{}".format('validations_cadence_metadata'), kwargs.get('validations_cadence_metadata', None))
        setattr(self, "_{}".format('validations_enabled'), kwargs.get('validations_enabled', None))
        setattr(self, "_{}".format('validations_enabled_metadata'), kwargs.get('validations_enabled_metadata', None))
        setattr(self, "_{}".format('validations_report'), kwargs.get('validations_report', None))
        setattr(self, "_{}".format('validations_report_metadata'), kwargs.get('validations_report_metadata', None))
        setattr(self, "_{}".format('water_mark_enabled'), kwargs.get('water_mark_enabled', None))
        setattr(self, "_{}".format('water_mark_enabled_metadata'), kwargs.get('water_mark_enabled_metadata', None))
        setattr(self, "_{}".format('write_reminder_to_envelope_history'), kwargs.get('write_reminder_to_envelope_history', None))
        setattr(self, "_{}".format('write_reminder_to_envelope_history_metadata'), kwargs.get('write_reminder_to_envelope_history_metadata', None))
        setattr(self, "_{}".format('wurfl_min_allowable_screen_size'), kwargs.get('wurfl_min_allowable_screen_size', None))
        setattr(self, "_{}".format('wurfl_min_allowable_screen_size_metadata'), kwargs.get('wurfl_min_allowable_screen_size_metadata', None))
