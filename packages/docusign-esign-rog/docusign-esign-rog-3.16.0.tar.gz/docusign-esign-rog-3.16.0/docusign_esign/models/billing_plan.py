...
class BillingPlan(object):
    ...
    def __init__(self, _configuration=None, **kwargs):  # noqa: E501
        ...
        setattr(self, "_{}".format('app_store_products'), kwargs.get('app_store_products', None))
        setattr(self, "_{}".format('currency_plan_prices'), kwargs.get('currency_plan_prices', None))
