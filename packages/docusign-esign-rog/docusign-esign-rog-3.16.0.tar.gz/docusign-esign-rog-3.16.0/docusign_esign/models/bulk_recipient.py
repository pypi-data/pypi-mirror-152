...
class BulkRecipient(object):
    ...
    def __init__(self, _configuration=None, **kwargs):  # noqa: E501
        ...
        setattr(self, "_{}".format('identification'), kwargs.get('identification', None))
        setattr(self, "_{}".format('name'), kwargs.get('name', None))
        setattr(self, "_{}".format('note'), kwargs.get('note', None))
        setattr(self, "_{}".format('phone_number'), kwargs.get('phone_number', None))
        setattr(self, "_{}".format('recipient_signature_provider_info'), kwargs.get('recipient_signature_provider_info', None))
        setattr(self, "_{}".format('row_number'), kwargs.get('row_number', None))
        setattr(self, "_{}".format('tab_labels'), kwargs.get('tab_labels', None))
