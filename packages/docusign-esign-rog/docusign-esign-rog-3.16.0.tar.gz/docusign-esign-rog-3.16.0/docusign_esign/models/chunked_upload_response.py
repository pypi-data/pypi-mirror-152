...
class ChunkedUploadResponse(object):
    ...
    def __init__(self, _configuration=None, **kwargs):  # noqa: E501
        ...
        setattr(self, "_{}".format('checksum'), kwargs.get('checksum', None))
        setattr(self, "_{}".format('chunked_upload_id'), kwargs.get('chunked_upload_id', None))
        setattr(self, "_{}".format('chunked_upload_parts'), kwargs.get('chunked_upload_parts', None))
        setattr(self, "_{}".format('chunked_upload_uri'), kwargs.get('chunked_upload_uri', None))
        setattr(self, "_{}".format('committed'), kwargs.get('committed', None))
        setattr(self, "_{}".format('expiration_date_time'), kwargs.get('expiration_date_time', None))
        setattr(self, "_{}".format('max_chunked_upload_parts'), kwargs.get('max_chunked_upload_parts', None))
        setattr(self, "_{}".format('max_total_size'), kwargs.get('max_total_size', None))
        setattr(self, "_{}".format('total_size'), kwargs.get('total_size', None))
