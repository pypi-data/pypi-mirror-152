...
class ConnectLog(object):
    ...
    def __init__(self, _configuration=None, **kwargs):  # noqa: E501
        ...
        setattr(self, "_{}".format('connect_debug_log'), kwargs.get('connect_debug_log', None))
        ...
        setattr(self, "_{}".format('failure_id'), kwargs.get('failure_id', None))
        setattr(self, "_{}".format('failure_uri'), kwargs.get('failure_uri', None))
        setattr(self, "_{}".format('last_try'), kwargs.get('last_try', None))
        setattr(self, "_{}".format('log_id'), kwargs.get('log_id', None))
        setattr(self, "_{}".format('log_uri'), kwargs.get('log_uri', None))
        setattr(self, "_{}".format('retry_count'), kwargs.get('retry_count', None))
        setattr(self, "_{}".format('retry_uri'), kwargs.get('retry_uri', None))
