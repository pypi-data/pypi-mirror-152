...
class DateStampProperties(object):
    ...
    def __init__(self, _configuration=None, **kwargs):  # noqa: E501
        ...
        setattr(self, "_{}".format('date_area_height'), kwargs.get('date_area_height', None))
        setattr(self, "_{}".format('date_area_width'), kwargs.get('date_area_width', None))
        setattr(self, "_{}".format('date_area_x'), kwargs.get('date_area_x', None))
        setattr(self, "_{}".format('date_area_y'), kwargs.get('date_area_y', None))
