...
class EnvelopeDefinition(object):
    ...
    def __init__(self, _configuration=None, **kwargs):  # noqa: E501
        ...
        setattr(self, "_{}".format('accessibility'), kwargs.get('accessibility', None))
        ...
        setattr(self, "_{}".format('allow_recipient_recursion'), kwargs.get('allow_recipient_recursion', None))
        ...
        setattr(self, "_{}".format('attachments'), kwargs.get('attachments', None))
        ...
        setattr(self, "_{}".format('composite_templates'), kwargs.get('composite_templates', None))
        ...
        setattr(self, "_{}".format('event_notification'), kwargs.get('event_notification', None))
        setattr(self, "_{}".format('event_notifications'), kwargs.get('event_notifications', None))
        ...
        setattr(self, "_{}".format('recipient_view_request'), kwargs.get('recipient_view_request', None))
