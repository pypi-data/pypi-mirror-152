...
class EnvelopeFormData(object):
    ...
    def __init__(self, _configuration=None, **kwargs):  # noqa: E501
        ...
        setattr(self, "_{}".format('prefill_form_data'), kwargs.get('prefill_form_data', None))
        setattr(self, "_{}".format('recipient_form_data'), kwargs.get('recipient_form_data', None))
