...
class EnvelopeTemplate(object):
    ...
    def __init__(self, _configuration=None, **kwargs):  # noqa: E501
        ...
        setattr(self, "_{}".format('auto_match_specified_by_user'), kwargs.get('auto_match_specified_by_user', None))
        ...
        setattr(self, "_{}".format('favorited_by_me'), kwargs.get('favorited_by_me', None))
        ...
        setattr(self, "_{}".format('password_protected'), kwargs.get('password_protected', None))
