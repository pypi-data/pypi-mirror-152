...
class ExternalDocumentSources(object):
    ...
    def __init__(self, _configuration=None, **kwargs):  # noqa: E501
        ...
        setattr(self, "_{}".format('boxnet_enabled'), kwargs.get('boxnet_enabled', None))
        setattr(self, "_{}".format('boxnet_metadata'), kwargs.get('boxnet_metadata', None))
        setattr(self, "_{}".format('dropbox_enabled'), kwargs.get('dropbox_enabled', None))
        setattr(self, "_{}".format('dropbox_metadata'), kwargs.get('dropbox_metadata', None))
        setattr(self, "_{}".format('google_drive_enabled'), kwargs.get('google_drive_enabled', None))
        setattr(self, "_{}".format('google_drive_metadata'), kwargs.get('google_drive_metadata', None))
        setattr(self, "_{}".format('one_drive_enabled'), kwargs.get('one_drive_enabled', None))
        setattr(self, "_{}".format('one_drive_metadata'), kwargs.get('one_drive_metadata', None))
        setattr(self, "_{}".format('salesforce_enabled'), kwargs.get('salesforce_enabled', None))
        setattr(self, "_{}".format('salesforce_metadata'), kwargs.get('salesforce_metadata', None))
