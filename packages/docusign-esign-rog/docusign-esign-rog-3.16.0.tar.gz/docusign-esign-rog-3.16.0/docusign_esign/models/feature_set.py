...
class FeatureSet(object):
    ...
    def __init__(self, _configuration=None, **kwargs):  # noqa: E501
        ...
        setattr(self, "_{}".format('currency_feature_set_prices'), kwargs.get('currency_feature_set_prices', None))
        setattr(self, "_{}".format('envelope_fee'), kwargs.get('envelope_fee', None))
        setattr(self, "_{}".format('feature_set_id'), kwargs.get('feature_set_id', None))
