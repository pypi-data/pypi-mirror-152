...
class Filter(object):
    ...
    def __init__(self, _configuration=None, **kwargs):  # noqa: E501
        ...
        setattr(self, "_{}".format('action_required'), kwargs.get('action_required', None))
        setattr(self, "_{}".format('expires'), kwargs.get('expires', None))
        setattr(self, "_{}".format('folder_ids'), kwargs.get('folder_ids', None))
        setattr(self, "_{}".format('from_date_time'), kwargs.get('from_date_time', None))
        setattr(self, "_{}".format('is_template'), kwargs.get('is_template', None))
        setattr(self, "_{}".format('order'), kwargs.get('order', None))
        setattr(self, "_{}".format('order_by'), kwargs.get('order_by', None))
        setattr(self, "_{}".format('search_target'), kwargs.get('search_target', None))
        setattr(self, "_{}".format('search_text'), kwargs.get('search_text', None))
        setattr(self, "_{}".format('status'), kwargs.get('status', None))
        setattr(self, "_{}".format('to_date_time'), kwargs.get('to_date_time', None))
