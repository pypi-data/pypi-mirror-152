...
class RecipientAdditionalNotification(object):
    ...
    def __init__(self, _configuration=None, **kwargs):  # noqa: E501
        ...
        setattr(self, "_{}".format('secondary_delivery_method'), kwargs.get('secondary_delivery_method', None))
        setattr(self, "_{}".format('secondary_delivery_method_metadata'), kwargs.get('secondary_delivery_method_metadata', None))
        setattr(self, "_{}".format('secondary_delivery_status'), kwargs.get('secondary_delivery_status', None))
