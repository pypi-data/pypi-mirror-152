...
class RecipientPhoneAuthentication(object):
    ...
    def __init__(self, _configuration=None, **kwargs):  # noqa: E501
        ...
        setattr(self, "_{}".format('recip_may_provide_number'), kwargs.get('recip_may_provide_number', None))
        setattr(self, "_{}".format('recip_may_provide_number_metadata'), kwargs.get('recip_may_provide_number_metadata', None))
        setattr(self, "_{}".format('record_voice_print'), kwargs.get('record_voice_print', None))
        setattr(self, "_{}".format('record_voice_print_metadata'), kwargs.get('record_voice_print_metadata', None))
        ...
        setattr(self, "_{}".format('validate_recip_provided_number'), kwargs.get('validate_recip_provided_number', None))
        setattr(self, "_{}".format('validate_recip_provided_number_metadata'), kwargs.get('validate_recip_provided_number_metadata', None))
