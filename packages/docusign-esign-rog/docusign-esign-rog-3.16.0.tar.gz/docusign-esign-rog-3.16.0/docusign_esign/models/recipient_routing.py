...
class RecipientRouting(object):
    ...
    def __init__(self, _configuration=None, **kwargs):  # noqa: E501
        """RecipientRouting - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(RecipientRouting, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RecipientRouting):
            return False
