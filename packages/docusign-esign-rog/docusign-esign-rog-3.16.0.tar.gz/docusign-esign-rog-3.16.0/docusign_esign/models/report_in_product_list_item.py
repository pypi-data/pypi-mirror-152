...
class ReportInProductListItem(object):
    ...
    def __init__(self, _configuration=None, **kwargs):  # noqa: E501
        ...
        setattr(self, "_{}".format('get_uri'), kwargs.get('get_uri', None))
        ...
        setattr(self, "_{}".format('schedule_create_date'), kwargs.get('schedule_create_date', None))
        setattr(self, "_{}".format('schedule_end_date'), kwargs.get('schedule_end_date', None))
        setattr(self, "_{}".format('schedule_id'), kwargs.get('schedule_id', None))
        setattr(self, "_{}".format('schedule_renew_duration_days'), kwargs.get('schedule_renew_duration_days', None))
