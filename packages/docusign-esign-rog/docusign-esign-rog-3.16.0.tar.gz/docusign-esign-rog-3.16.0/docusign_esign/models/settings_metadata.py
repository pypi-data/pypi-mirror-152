...
class SettingsMetadata(object):
    ...
    def __init__(self, _configuration=None, **kwargs):  # noqa: E501
        ...
        setattr(self, "_{}".format('ui_hint'), kwargs.get('ui_hint', None))
        setattr(self, "_{}".format('ui_order'), kwargs.get('ui_order', None))
        setattr(self, "_{}".format('ui_type'), kwargs.get('ui_type', None))
