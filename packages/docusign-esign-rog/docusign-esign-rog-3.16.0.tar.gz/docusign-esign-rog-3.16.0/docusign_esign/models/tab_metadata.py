...
class TabMetadata(object):
    ...
    def __init__(self, _configuration=None, **kwargs):  # noqa: E501
        ...
        setattr(self, "_{}".format('anchor'), kwargs.get('anchor', None))
        ...
        setattr(self, "_{}".format('collaborative'), kwargs.get('collaborative', None))
        setattr(self, "_{}".format('conceal_value_on_document'), kwargs.get('conceal_value_on_document', None))
        setattr(self, "_{}".format('created_by_display_name'), kwargs.get('created_by_display_name', None))
        ...
        setattr(self, "_{}".format('editable'), kwargs.get('editable', None))
        ...
        setattr(self, "_{}".format('included_in_email'), kwargs.get('included_in_email', None))
        setattr(self, "_{}".format('initial_value'), kwargs.get('initial_value', None))
        ...
        setattr(self, "_{}".format('last_modified_by_display_name'), kwargs.get('last_modified_by_display_name', None))
        setattr(self, "_{}".format('last_modified_by_user_id'), kwargs.get('last_modified_by_user_id', None))
        ...
        setattr(self, "_{}".format('payment_item_description'), kwargs.get('payment_item_description', None))
        setattr(self, "_{}".format('payment_item_name'), kwargs.get('payment_item_name', None))
