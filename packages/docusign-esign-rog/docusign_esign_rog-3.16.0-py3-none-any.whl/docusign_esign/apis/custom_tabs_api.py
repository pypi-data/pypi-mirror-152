...
class CustomTabsApi(object):
    ...
    def create_with_http_info(self, account_id, **kwargs):
        ...
        resource_path = '/v2.1/accounts/{accountId}/tab_definitions'.replace('{format}', 'json')
        path_params = {}
    ...
    def delete_with_http_info(self, account_id, custom_tab_id, **kwargs):
        ...
        resource_path = '/v2.1/accounts/{accountId}/tab_definitions/{customTabId}'.replace('{format}', 'json')
        path_params = {}
        if 'account_id' in params:
            path_params['accountId'] = params['account_id']
