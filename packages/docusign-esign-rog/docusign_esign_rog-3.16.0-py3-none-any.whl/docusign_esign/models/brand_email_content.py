...
class BrandEmailContent(object):
    ...
    def __init__(self, _configuration=None, **kwargs):  # noqa: E501
        ...
        setattr(self, "_{}".format('content'), kwargs.get('content', None))
        setattr(self, "_{}".format('email_content_type'), kwargs.get('email_content_type', None))
        setattr(self, "_{}".format('email_to_link'), kwargs.get('email_to_link', None))
