...
class DiagnosticsSettingsInformation(object):
    ...
    def __init__(self, _configuration=None, **kwargs):  # noqa: E501
        ...
        setattr(self, "_{}".format('api_request_logging'), kwargs.get('api_request_logging', None))
        setattr(self, "_{}".format('api_request_log_max_entries'), kwargs.get('api_request_log_max_entries', None))
        setattr(self, "_{}".format('api_request_log_remaining_entries'), kwargs.get('api_request_log_remaining_entries', None))
