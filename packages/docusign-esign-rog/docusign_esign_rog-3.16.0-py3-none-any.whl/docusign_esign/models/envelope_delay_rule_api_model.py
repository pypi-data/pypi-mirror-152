...
class EnvelopeDelayRuleApiModel(object):
    ...
    def __init__(self, _configuration=None, **kwargs):  # noqa: E501
        """EnvelopeDelayRuleApiModel - a model defined in Swagger"""  # noqa: E501
    ...
    def delay(self):
        ...
        :return: The delay of this EnvelopeDelayRuleApiModel.  # noqa: E501
        :rtype: str
        """
        return self._delay
    ...
    def delay(self, delay):
        """Sets the delay of this EnvelopeDelayRuleApiModel.

        A string timespan duration represented as d.hh:mm:ss where the d component is days, hh is hours measured on a 24-hour clock, mm is minutes and ss is seconds, indicating the expected delay for this envelope rule. The maximum delay is 30 days.  # noqa: E501

        :param delay: The delay of this EnvelopeDelayRuleApiModel.  # noqa: E501
        :type: str
        """
    ...
    def resume_date(self):
        ...
        :return: The resume_date of this EnvelopeDelayRuleApiModel.  # noqa: E501
        :rtype: str
        """
    ...
    def resume_date(self, resume_date):
        """Sets the resume_date of this EnvelopeDelayRuleApiModel.

        A string formatted as an ISO 8601 DATETIME with TimeZone specified, indicating the expected resumeDate for this envelope rule. The specified datetime must occur in the future relative to the current UTC time hen the request is made. The maximum resumeDate must not exceed 30 days in the future.  # noqa: E501

        :param resume_date: The resume_date of this EnvelopeDelayRuleApiModel.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(EnvelopeDelayRuleApiModel, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EnvelopeDelayRuleApiModel):
            return False
