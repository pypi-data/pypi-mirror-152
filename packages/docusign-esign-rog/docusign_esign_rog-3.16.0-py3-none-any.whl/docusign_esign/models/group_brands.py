...
class GroupBrands(object):
    ...
    def __init__(self, _configuration=None, **kwargs):  # noqa: E501
        ...
        setattr(self, "_{}".format('recipient_brand_id_default'), kwargs.get('recipient_brand_id_default', None))
        setattr(self, "_{}".format('sender_brand_id_default'), kwargs.get('sender_brand_id_default', None))
        setattr(self, "_{}".format('brand_options'), kwargs.get('brand_options', None))
