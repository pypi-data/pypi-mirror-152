...
class PaymentGatewayAccountSetting(object):
    ...
    def __init__(self, _configuration=None, **kwargs):  # noqa: E501
        ...
        setattr(self, "_{}".format('api_fields'), kwargs.get('api_fields', None))
        setattr(self, "_{}".format('authorization_code'), kwargs.get('authorization_code', None))
        setattr(self, "_{}".format('credential_status'), kwargs.get('credential_status', None))
        setattr(self, "_{}".format('merchant_id'), kwargs.get('merchant_id', None))
