...
class RecipientNamesResponse(object):
    ...
    def __init__(self, _configuration=None, **kwargs):  # noqa: E501
        ...
        setattr(self, "_{}".format('multiple_users'), kwargs.get('multiple_users', None))
        setattr(self, "_{}".format('recipient_names'), kwargs.get('recipient_names', None))
        setattr(self, "_{}".format('reserved_recipient_email'), kwargs.get('reserved_recipient_email', None))
