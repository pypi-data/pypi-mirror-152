...
class SignerEmailNotifications(object):
    ...
    def __init__(self, _configuration=None, **kwargs):  # noqa: E501
        ...
        setattr(self, "_{}".format('agent_notification'), kwargs.get('agent_notification', None))
        setattr(self, "_{}".format('carbon_copy_notification'), kwargs.get('carbon_copy_notification', None))
        setattr(self, "_{}".format('certified_delivery_notification'), kwargs.get('certified_delivery_notification', None))
        ...
        setattr(self, "_{}".format('document_markup_activation'), kwargs.get('document_markup_activation', None))
        setattr(self, "_{}".format('envelope_activation'), kwargs.get('envelope_activation', None))
        setattr(self, "_{}".format('envelope_complete'), kwargs.get('envelope_complete', None))
        setattr(self, "_{}".format('envelope_corrected'), kwargs.get('envelope_corrected', None))
        setattr(self, "_{}".format('envelope_declined'), kwargs.get('envelope_declined', None))
        setattr(self, "_{}".format('envelope_voided'), kwargs.get('envelope_voided', None))
        setattr(self, "_{}".format('fax_received'), kwargs.get('fax_received', None))
        ...
        setattr(self, "_{}".format('reassigned_signer'), kwargs.get('reassigned_signer', None))
        setattr(self, "_{}".format('when_signing_group_member'), kwargs.get('when_signing_group_member', None))
