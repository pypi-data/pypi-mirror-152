...
class SmartSectionDisplaySettings(object):
    ...
    def __init__(self, _configuration=None, **kwargs):  # noqa: E501
        ...
        setattr(self, "_{}".format('cell_style'), kwargs.get('cell_style', None))
        setattr(self, "_{}".format('collapsible_settings'), kwargs.get('collapsible_settings', None))
        setattr(self, "_{}".format('display'), kwargs.get('display', None))
        setattr(self, "_{}".format('display_label'), kwargs.get('display_label', None))
        ...
        setattr(self, "_{}".format('hide_label_when_opened'), kwargs.get('hide_label_when_opened', None))
        setattr(self, "_{}".format('inline_outer_style'), kwargs.get('inline_outer_style', None))
        setattr(self, "_{}".format('label_when_opened'), kwargs.get('label_when_opened', None))
        setattr(self, "_{}".format('pre_label'), kwargs.get('pre_label', None))
        setattr(self, "_{}".format('scroll_to_top_when_opened'), kwargs.get('scroll_to_top_when_opened', None))
        setattr(self, "_{}".format('table_style'), kwargs.get('table_style', None))
