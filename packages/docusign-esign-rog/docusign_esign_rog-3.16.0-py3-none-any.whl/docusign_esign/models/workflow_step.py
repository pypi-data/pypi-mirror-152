...
class WorkflowStep(object):
    ...
    def __init__(self, _configuration=None, **kwargs):  # noqa: E501
        ...
        setattr(self, "_{}".format('triggered_date'), kwargs.get('triggered_date', None))
        setattr(self, "_{}".format('trigger_on_item'), kwargs.get('trigger_on_item', None))
        setattr(self, "_{}".format('workflow_step_id'), kwargs.get('workflow_step_id', None))
