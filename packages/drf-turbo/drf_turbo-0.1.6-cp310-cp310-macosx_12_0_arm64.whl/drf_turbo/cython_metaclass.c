...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "drf_turbo.cython_metaclass",
        "sources": [
            "drf_turbo/cython_metaclass.pyx"
        ]
    },
    "module_name": "drf_turbo.cython_metaclass"
}
END: Cython Metadata */
...
#define __PYX_HAVE__drf_turbo__cython_metaclass
#define __PYX_HAVE_API__drf_turbo__cython_metaclass
/* Early includes */
...
static struct PyModuleDef __pyx_moduledef = {
    ...
    "cython_metaclass",
    __pyx_k_Metaclasses_for_Cython_extensio, /* m_doc */
  #if CYTHON_PEP489_MULTI_PHASE_INIT
    0, /* m_size */
  #else
    -1, /* m_size */
...
if (!__Pyx_RefNanny) {
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("cython_metaclass", __pyx_methods, __pyx_k_Metaclasses_for_Cython_extensio, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_drf_turbo__cython_metaclass) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "drf_turbo.cython_metaclass")) {
      if (unlikely(PyDict_SetItemString(modules, "drf_turbo.cython_metaclass", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "drf_turbo/cython_metaclass.pyx":1
 * """             # <<<<<<<<<<<<<<
 * Metaclasses for Cython extension types
 * 
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init drf_turbo.cython_metaclass", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init drf_turbo.cython_metaclass");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
