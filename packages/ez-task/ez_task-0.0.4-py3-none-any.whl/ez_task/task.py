...
class Task():
    def __init__(self, target: Callable, daemon=True, manager: TaskManager = None, use_gatherer=True) -> None:
        """
        ...
        self._target = target
        self.process: Process = Process(target=Task._call_function, args=(self._internal_connection, self._target), daemon=daemon)
        self.process.start()
