...
def color_attribute_add(name: str = "Color",
    ...
    :type domain: typing.Union[int, str]
    :param data_type: Data Type, Type of data stored in attribute * FLOAT_COLOR Color -- RGBA color 32-bit floating-point values. * BYTE_COLOR Byte Color -- RGBA color with 8-bit positive integer values.
    :type data_type: typing.Union[int, str]
