...
class fmiEventInfo(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    iterationConverged = property(_fmippim.fmiEventInfo_iterationConverged_get, _fmippim.fmiEventInfo_iterationConverged_set)
    stateValueReferencesChanged = property(_fmippim.fmiEventInfo_stateValueReferencesChanged_get, _fmippim.fmiEventInfo_stateValueReferencesChanged_set)
    stateValuesChanged = property(_fmippim.fmiEventInfo_stateValuesChanged_get, _fmippim.fmiEventInfo_stateValuesChanged_set)
    terminateSimulation = property(_fmippim.fmiEventInfo_terminateSimulation_get, _fmippim.fmiEventInfo_terminateSimulation_set)
    upcomingTimeEvent = property(_fmippim.fmiEventInfo_upcomingTimeEvent_get, _fmippim.fmiEventInfo_upcomingTimeEvent_set)
    nextEventTime = property(_fmippim.fmiEventInfo_nextEventTime_get, _fmippim.fmiEventInfo_nextEventTime_set)

    def __init__(self):
        _fmippim.fmiEventInfo_swiginit(self, _fmippim.new_fmiEventInfo())
    __swig_destroy__ = _fmippim.delete_fmiEventInfo

# Register fmiEventInfo in _fmippim:
_fmippim.fmiEventInfo_swigregister(fmiEventInfo)
...
class fmi2EventInfo(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    newDiscreteStatesNeeded = property(_fmippim.fmi2EventInfo_newDiscreteStatesNeeded_get, _fmippim.fmi2EventInfo_newDiscreteStatesNeeded_set)
    terminateSimulation = property(_fmippim.fmi2EventInfo_terminateSimulation_get, _fmippim.fmi2EventInfo_terminateSimulation_set)
    nominalsOfContinuousStatesChanged = property(_fmippim.fmi2EventInfo_nominalsOfContinuousStatesChanged_get, _fmippim.fmi2EventInfo_nominalsOfContinuousStatesChanged_set)
    valuesOfContinuousStatesChanged = property(_fmippim.fmi2EventInfo_valuesOfContinuousStatesChanged_get, _fmippim.fmi2EventInfo_valuesOfContinuousStatesChanged_set)
    nextEventTimeDefined = property(_fmippim.fmi2EventInfo_nextEventTimeDefined_get, _fmippim.fmi2EventInfo_nextEventTimeDefined_set)
    nextEventTime = property(_fmippim.fmi2EventInfo_nextEventTime_get, _fmippim.fmi2EventInfo_nextEventTime_set)

    def __init__(self):
        _fmippim.fmi2EventInfo_swiginit(self, _fmippim.new_fmi2EventInfo())
    __swig_destroy__ = _fmippim.delete_fmi2EventInfo

# Register fmi2EventInfo in _fmippim:
_fmippim.fmi2EventInfo_swigregister(fmi2EventInfo)
