...
class GraphDbConnection(GraphDbConnectionInterface):
    def __init__(
        ...
        self.driver_writer = traversal().withRemote(
    ...
    def close(self):
        ...
        :return: none
        """
        self.driver_writer.close()
        self.driver_reader.close()
