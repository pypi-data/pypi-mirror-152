# Modified based on the official implementation by Vân Anh Huynh-Thu
...
def GENIE3(expr_data,gene_names=None,regulators='all',tree_method='RF',K='sqrt',ntrees=1000,nthreads=1, verbose=0):
