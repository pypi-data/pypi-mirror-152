...
REQUIREMENTS = {
    "Cycle": {
        "endDate": "",
        "products": [
            {"@type": "Product", "term.termType": "animalProduct", "term.units": "kg dressed carcass weight"}
        ],
        "site": {
            "@type": "Site",
            "country": ""
...
TERM_ID = 'dressedCarcassWeightPerHead'
...
def _should_run(cycle: dict):
    ...
    products = _filter_list_term_unit(products, Units.KG_DRESSED_CARCASS_WEIGHT)
