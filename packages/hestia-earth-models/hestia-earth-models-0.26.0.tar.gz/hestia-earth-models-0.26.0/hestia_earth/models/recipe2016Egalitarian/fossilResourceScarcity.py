...
REQUIREMENTS = {
    "ImpactAssessment": {
        "cycle": {
            "@type": "Cycle",
            "inputs": {"@type": "Product", "term.termType": "fuel"}
        }
    }
}
RETURNS = {
...
LOOKUP_COLUMN = 'oilEqEgalitarianFossilResourceScarcityReCiPe2016'
...
def run(impact_assessment: dict):
    ...
    fuel_values = convert_value_from_cycle(
        product, cycle_lookup_value(TERM_ID, cycle.get('inputs', []), TermTermType.FUEL, LOOKUPS['fuel']), None
    )
