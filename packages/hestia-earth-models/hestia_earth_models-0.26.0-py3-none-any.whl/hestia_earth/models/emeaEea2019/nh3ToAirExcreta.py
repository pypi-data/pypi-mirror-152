...
REQUIREMENTS = {
    "Cycle": {
        "inputs": [
            {"@type": "Input", "term.termType": "excreta", "term.units": "kg N"}
        ],
        "products": [
            {"@type": "Product", "term.termType": ["animalProduct", "liveAnimal", "liveAquaticSpecies"]}
        ],
        "practices": [
            {"@type": "Practice", "term.termType": "excretaManagement"}
        ]
    }
}
LOOKUPS = {
    "excretaManagement-animalProduct-NH3_EF_2019": "primary product @id",
    "excretaManagement-liveAnimal-NH3_EF_2019": "primary product @id",
    "excretaManagement-liveAquaticSpecies-NH3_EF_2019": "primary product @id"
}
RETURNS = {
    "Emission": [{
        "value": "",
...
def _should_run(cycle: dict):
    ...
    should_run = all([excretaKgTAN, NH3_N_EF is not None]) or term_type_complete
