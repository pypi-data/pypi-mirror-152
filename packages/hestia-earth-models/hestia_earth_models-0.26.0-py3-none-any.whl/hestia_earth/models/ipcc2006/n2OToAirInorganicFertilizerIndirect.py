...
REQUIREMENTS = {
    "Cycle": {
        ...
        "emissions": [
            {"@type": "Emission", "term.@id": "no3ToGroundwaterInorganicFertilizer"},
            {"@type": "Emission", "term.@id": "nh3ToAirInorganicFertilizer"},
            {"@type": "Emission", "term.@id": "noxToAirInorganicFertilizer"}
        ]
    }
}
RETURNS = {
