    ...
    `}},{kind:"method",key:"firstUpdated",value:function(e){v(y(i.prototype),"firstUpdated",this).call(this,e),(0,a.O)()}},{kind:"method",key:"_computeDeviceName",value:function(e,t){const i=e.find((e=>e.id===t));return i?(0,o.jL)(i,this.hass):`<${this.hass.localize("ui.panel.config.integrations.config_entry.unknown_via_device")}>`}},{kind:"get",static:!0,key:"styles",value:function(){return[s.Qx,r.iv`
      ...
      `;const f=(0,m.jL)(p,this.hass),u=this._integrations(p,this.entries),v=this._entities(this.deviceId,this.entities),y=this._entitiesByCategory(v),g=this._batteryEntity(v),b=this._batteryChargingEntity(v),w=g?this.hass.states[g.entity_id]:void 0,k=w&&"binary_sensor"===(0,l.N)(w),_=b?this.hass.states[b.entity_id]:void 0,P=this._computeArea(this.areas,p),$=[],x=[],D=[...this._deviceActions||[]];Array.isArray(this._diagnosticDownloadLinks)&&D.push(...this._diagnosticDownloadLinks),this._deleteButtons&&D.push(...this._deleteButtons);const z=D.shift();return p.disabled_by&&$.push(t.dy`
          ...
          ${"user"===p.disabled_by?t.dy`
              ...
              `:""}
        `),this._renderIntegrationInfo(p,u,$,x),t.dy`
      <hass-tabs-subpage
        .hass=${this.hass}
        .narrow=${this.narrow}
      ...
      >
        ...
        <div class="container">
          <div class="header fullwidth">
            ${this.narrow?"":t.dy`
                ...
                <div class="header-right">
                  ...
                  ${u.length?t.dy`
                          <img
                            src=${(0,E.X1)({domain:u[0].domain,type:"logo",darkOptimized:null===(e=this.hass.themes)||void 0===e?void 0:e.darkMode})}
          ...
          <div class="column">
              ${x.length?t.dy` <div class="fullwidth">${x}</div> `:""}
              <ha-device-info-card
                .hass=${this.hass}
                .areas=${this.areas}
            ...
            ${(0,s.p)(this.hass,"automation")?t.dy`
                    <ha-card outlined>
                      ...
                      ${null!==(i=this._related)&&void 0!==i&&null!==(r=i.automation)&&void 0!==r&&r.length?t.dy`
                            <div class="items">
            ...
            ${(0,s.p)(this.hass,"scene")&&v.length?t.dy`
              ...
              ${(0,s.p)(this.hass,"script")?t.dy`
                      <ha-card outlined>
                        ...
                        ${null!==(d=this._related)&&void 0!==d&&null!==(h=d.script)&&void 0!==h&&h.length?t.dy`
                              <div class="items">
          ...
          <div class="column">
            ${["control","sensor","config","diagnostic"].map((e=>y[e].length>0||0===v.length&&"control"===e?t.dy`
