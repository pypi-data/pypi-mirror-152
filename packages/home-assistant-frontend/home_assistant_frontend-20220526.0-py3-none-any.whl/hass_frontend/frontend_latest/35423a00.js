    ...
    `}},{kind:"method",key:"firstUpdated",value:function(e){y(v(i.prototype),"firstUpdated",this).call(this,e),(0,s.O)()}},{kind:"method",key:"_computeDeviceName",value:function(e,t){const i=e.find((e=>e.id===t));return i?(0,o.jL)(i,this.hass):`<${this.hass.localize("ui.panel.config.integrations.config_entry.unknown_via_device")}>`}},{kind:"get",static:!0,key:"styles",value:function(){return[a.Qx,r.iv`
      ...
      `;const f=(0,m.jL)(p,this.hass),y=this._integrations(p,this.entries),v=this._entities(this.deviceId,this.entities),g=this._entitiesByCategory(v),b=this._batteryEntity(v),w=this._batteryChargingEntity(v),k=b?this.hass.states[b.entity_id]:void 0,_=k&&"binary_sensor"===(0,l.N)(k),$=w?this.hass.states[w.entity_id]:void 0,D=this._computeArea(this.areas,p),x=[],z=[...this._deviceActions||[]];Array.isArray(this._diagnosticDownloadLinks)&&z.push(...this._diagnosticDownloadLinks),this._deleteButtons&&z.push(...this._deleteButtons);const P=z.shift();p.disabled_by&&x.push(t.dy`
          ...
          ${"user"===p.disabled_by?t.dy`
              ...
              `:""}
        `),this._renderIntegrationInfo(p,y,x);const A=(0,a.p)(this.hass,"automation")?t.dy`
          <ha-card outlined>
