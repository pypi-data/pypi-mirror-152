# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/athena_experiment_manager.ipynb (unless otherwise specified).
...
class AthenaExperimentManager (ExperimentManager):
    ...
    def run_experiment (self, parameters={}, path_results='./results'):
        ...
        if frequency_range == '400Hz':
            ...
            path_data='/datadrive/aihub-athena-reliability-analysis/remote_data/separate_labels_old_data/YK_YT_3kHz_data'
        else:
