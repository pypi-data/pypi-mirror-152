...
class AutoAI(BaseExperiment):
    ...
    def optimizer(self,
        ...
        pipeline_types = None
        supporting_features_at_forecasting = None

        if 'supporting_features' in kwargs:
            supporting_features = kwargs.pop('supporting_features')

        if 'pipeline_types' in kwargs:
            pipeline_types = kwargs.pop('pipeline_types')

        if 'supporting_features_at_forecasting' in kwargs:
            supporting_features_at_forecasting = kwargs.pop('supporting_features_at_forecasting')
        ...
        if self._workspace is None and kwargs.get('t_shirt_size'):
            ...
            optimizer = RemoteAutoPipelines(
                ...
                supporting_features_at_forecasting=supporting_features_at_forecasting,
