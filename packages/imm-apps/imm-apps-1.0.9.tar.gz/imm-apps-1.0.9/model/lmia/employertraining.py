...
class EmployerTrainingModel(CommonModel):
    ...
    def __init__(self,excels=None,output_excel_file=None):
        if output_excel_file:
            excels=self.getExcels(["excel/er.xlsx","excel/pa.xlsx","recruitment.xlsx","lmia.xlsx",'rep.xlsx'])
        else:
    ...
    def makeDocx(self,output_docx):
        template_path=os.path.abspath(os.path.join(DATADIR,"word/lmia_employer_training.docx"))        
