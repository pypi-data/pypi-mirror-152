...
def calculate_shutin_interval(
    ...
    Args:
        shut_valve: Shut-in valve signal.
...
def calculate_threshold(shut_valve: pd.Series):
    """The valve threshold refers to the threshold between valve open and close states. The threshold is calculated as a mean of two histogram peaks (max values). The histogram should have two peaks indicating two states.
