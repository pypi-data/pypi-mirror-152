...
def register(
    ...
    Args:
        ...
        deprecated: Flag is function is deprecated. Default: False
        changelog: Description on what has changed since the previous version. Default: None
    """
...
def get_changelog(func: Callable[..., Any]) -> Optional[str]:
    """Return changelog of this version. If the function is not registered, None is returned"""
