...
class AllReduceOp(_ods_ir.OpView):
  ...
  def __init__(self, result, operand, replica_groups, channel_handle, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class CholeskyOp(_ods_ir.OpView):
  ...
  def __init__(self, a, lower, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class CompareOp(_ods_ir.OpView):
  ...
  def __init__(self, lhs, rhs, comparison_direction, compare_type, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class ConstOp(_ods_ir.OpView):
  ...
  def __init__(self, value, *, loc=None, ip=None):
    ...
    _ods_context = _ods_get_default_loc_context(loc)
    results = _ods_ir.InferTypeOpInterface(ConstOp).inferReturnTypes(
        operands=operands,
        attributes=_ods_ir.DictAttr.get(attributes, context=_ods_context),
        context=_ods_context,
        loc=loc)
...
class CosOp(_ods_ir.OpView):
  ...
  def __init__(self, operand, *, loc=None, ip=None):
    ...
    operands.append(_get_op_result_or_value(operand))
    _ods_context = _ods_get_default_loc_context(loc)
    results = _ods_ir.InferTypeOpInterface(CosOp).inferReturnTypes(
        operands=operands,
        attributes=_ods_ir.DictAttr.get(attributes, context=_ods_context),
        context=_ods_context,
        loc=loc)
...
class CustomCallOp(_ods_ir.OpView):
  ...
  def __init__(self, result, operands_, call_target_name, has_side_effect, backend_config, api_version, called_computations, operand_layouts, result_layouts, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class DotOp(_ods_ir.OpView):
  ...
  def __init__(self, lhs, rhs, precision_config, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class DynamicBroadcastInDimOp(_ods_ir.OpView):
  ...
  def __init__(self, result, operand, output_dimensions, broadcast_dimensions, known_expanding_dimensions, known_nonexpanding_dimensions, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class OutfeedOp(_ods_ir.OpView):
  ...
  def __init__(self, result, operands_, token, outfeed_config, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class PrintOp(_ods_ir.OpView):
  ...
  def __init__(self, output, operand, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class ReduceWindowOp(_ods_ir.OpView):
  ...
  def __init__(self, result, operands_, init_values, window_dimensions, window_strides, base_dilations, window_dilations, padding, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class SendOp(_ods_ir.OpView):
  ...
  def __init__(self, result, operands_, token, channel_handle, is_host_transfer, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class SinOp(_ods_ir.OpView):
  ...
  def __init__(self, operand, *, loc=None, ip=None):
    ...
    operands.append(_get_op_result_or_value(operand))
    _ods_context = _ods_get_default_loc_context(loc)
    results = _ods_ir.InferTypeOpInterface(SinOp).inferReturnTypes(
        operands=operands,
        attributes=_ods_ir.DictAttr.get(attributes, context=_ods_context),
        context=_ods_context,
        loc=loc)
