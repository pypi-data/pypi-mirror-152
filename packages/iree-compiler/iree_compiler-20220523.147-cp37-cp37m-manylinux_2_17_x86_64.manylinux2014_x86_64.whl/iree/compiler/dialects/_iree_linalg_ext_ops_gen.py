...
class EndPerformConcurrentlyOp(_ods_ir.OpView):
  OPERATION_NAME = "iree_linalg_ext.end_perform_concurrently"
...
@_ods_cext.register_operation(_Dialect)
@_ods_extend_opview_class(_ods_ext_module)
class HALExecutableEntryPointOp(_ods_ir.OpView):
  OPERATION_NAME = "iree_linalg_ext.hal.executable.entry_point"
  ...
  @builtins.property
  def workgroup_count_region(self):
    return self.regions[0]

@_ods_cext.register_operation(_Dialect)
@_ods_extend_opview_class(_ods_ext_module)
class HALInterfaceWorkgroupCountOp(_ods_ir.OpView):
  OPERATION_NAME = "iree_linalg_ext.hal.interface.workgroup.count"
  ...
  def __init__(self, dimension, *, loc=None, ip=None):
    ...
    results = _ods_ir.InferTypeOpInterface(HALInterfaceWorkgroupCountOp).inferReturnTypes(
        operands=operands,
...
@_ods_cext.register_operation(_Dialect)
@_ods_extend_opview_class(_ods_ext_module)
class HALInterfaceWorkgroupIDOp(_ods_ir.OpView):
  OPERATION_NAME = "iree_linalg_ext.hal.interface.workgroup.id"
  ...
  def __init__(self, dimension, *, loc=None, ip=None):
    ...
    attributes["dimension"] = dimension
    _ods_context = _ods_get_default_loc_context(loc)
    results = _ods_ir.InferTypeOpInterface(HALInterfaceWorkgroupIDOp).inferReturnTypes(
        operands=operands,
        attributes=_ods_ir.DictAttr.get(attributes, context=_ods_context),
        context=_ods_context,
        loc=loc)
...
@_ods_cext.register_operation(_Dialect)
@_ods_extend_opview_class(_ods_ext_module)
class HALReturnOp(_ods_ir.OpView):
  OPERATION_NAME = "iree_linalg_ext.hal.return"
...
class InParallelOp(_ods_ir.OpView):
  OPERATION_NAME = "iree_linalg_ext.in_parallel"
...
class ParallelInsertSliceOp(_ods_ir.OpView):
  OPERATION_NAME = "iree_linalg_ext.parallel_insert_slice"
...
class PerformConcurrentlyOp(_ods_ir.OpView):
  OPERATION_NAME = "iree_linalg_ext.perform_concurrently"
...
class ScatterOp(_ods_ir.OpView):
  ...
  def __init__(self, results_, inputs, outputs, unique_indices, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class TileOp(_ods_ir.OpView):
  OPERATION_NAME = "iree_linalg_ext.tile"
  ...
  @builtins.property
  def tiled_dim(self):
    return _ods_ir.IntegerAttr(self.operation.attributes["tiled_dim"])

  @tiled_dim.setter
  def tiled_dim(self, value):
    if value is None:
      raise ValueError("'None' not allowed as value for mandatory attributes")
    self.operation.attributes["tiled_dim"] = value
...
@_ods_cext.register_operation(_Dialect)
@_ods_extend_opview_class(_ods_ext_module)
class TileYieldOp(_ods_ir.OpView):
  OPERATION_NAME = "iree_linalg_ext.tile_yield"
