...
class BroadcastAddOp(_ods_ir.OpView):
  ...
  def __init__(self, lhs, rhs, broadcast_dimensions, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
    ...
    if broadcast_dimensions is not None: attributes["broadcast_dimensions"] = broadcast_dimensions
    _ods_context = _ods_get_default_loc_context(loc)
...
class BroadcastCompareOp(_ods_ir.OpView):
  ...
  def __init__(self, lhs, rhs, broadcast_dimensions, comparison_direction, compare_type, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
