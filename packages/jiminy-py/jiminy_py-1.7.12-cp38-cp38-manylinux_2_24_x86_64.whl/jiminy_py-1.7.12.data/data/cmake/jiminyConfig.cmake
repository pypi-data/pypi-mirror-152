...
# Make sure the right version of pinocchio, and eigen are available
find_package(pinocchio 2.5.6 EXACT REQUIRED NO_MODULE NO_CMAKE_SYSTEM_PATH)
find_package(hpp-fcl 1.7.1 REQUIRED NO_MODULE NO_CMAKE_SYSTEM_PATH)
...
list(APPEND jiminy_OPTIONS ${jiminy_OPTIONS} )
if("" MATCHES "AVX[0-9]+")
    list(APPEND jiminy_OPTIONS /wd9002 /fp:contract)
