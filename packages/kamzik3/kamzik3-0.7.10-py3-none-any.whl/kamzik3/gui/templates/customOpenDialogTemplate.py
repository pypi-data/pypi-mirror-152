...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        sizePolicy.setHeightForWidth(
            self.input_category.sizePolicy().hasHeightForWidth()
        )
        ...
        self.input_category.setSizeAdjustPolicy(
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.table_directory_content.sizePolicy().hasHeightForWidth()
        )
        self.table_directory_content.setSizePolicy(sizePolicy)
        self.table_directory_content.setSelectionMode(
            QtWidgets.QAbstractItemView.SingleSelection
        )
        self.table_directory_content.setSelectionBehavior(
        ...
        self.buttonBox.setStandardButtons(
            QtWidgets.QDialogButtonBox.Cancel | QtWidgets.QDialogButtonBox.Open
        )
        ...
        self.table_directory_content.doubleClicked["QModelIndex"].connect(
            Dialog.slot_file_selected
        )
        self.button_up.clicked.connect(Dialog.slot_dir_up)
        self.input_directory.currentIndexChanged["QString"].connect(
            Dialog.slot_change_path
        )
