...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        sizePolicy.setHeightForWidth(
            self.input_max_selected_rows.sizePolicy().hasHeightForWidth()
        )
        ...
        self.input_header_items.setSelectionMode(
            QtWidgets.QAbstractItemView.MultiSelection
        )
        self.input_header_items.setSelectionBehavior(
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(
            QtGui.QPixmap(":/icons/icons/viewList.png"),
            QtGui.QIcon.Normal,
            QtGui.QIcon.Off,
        )
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(
            QtGui.QPixmap(":/icons/icons/viewZoom.png"),
            QtGui.QIcon.Normal,
            QtGui.QIcon.Off,
        )
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.tabs_view_tools.sizePolicy().hasHeightForWidth()
        )
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.input_from_dt.sizePolicy().hasHeightForWidth()
        )
        ...
        self.mdi_area.setSizeAdjustPolicy(
        ...
        self.input_max_selected_rows.valueChanged["int"].connect(
            Form.slot_set_max_selected_rows
        )
        ...
        self.input_header_items.pressed["QModelIndex"].connect(
            Form.slot_selection_changed
        )
        self.input_master_row.currentTextChanged["QString"].connect(
            Form.slot_master_row_changed
        )
        self.splitter.splitterMoved["int", "int"].connect(Form.slot_splitter_moved)
        self.input_view_scale_plots.toggled["bool"].connect(
            self.input_view_plot_height.setDisabled
        )
        ...
        self.input_view_plot_height.editingFinished.connect(
            Form.slot_set_list_min_height
        )
    ...
    def retranslateUi(self, Form):
        ...
        self.input_view_scale_plots.setText(
            _translate("Form", "Scale plots to fit windows")
        )
        self.input_view_plot_height.setSuffix(_translate("Form", " %"))
        self.input_view_plot_height.setPrefix(_translate("Form", "Plot height: "))
        self.tabs_tools.setTabText(
            self.tabs_tools.indexOf(self.tab), _translate("Form", "View")
        )
        ...
        self.tabs_tools.setTabText(
            self.tabs_tools.indexOf(self.tab_2), _translate("Form", "Export")
        )
        ...
        self.tabs_tools.setTabText(
            self.tabs_tools.indexOf(self.tab_3), _translate("Form", "Settings")
        )
