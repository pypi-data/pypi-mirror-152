...
results = predict.predict_test(model.predict, 200)

print(results[0])

tab = predict.predict_N2N(model.predict, 200)
print(tab)

acc = predict.calculate_classification_accuracy(function=model.predict, batch_size=200)
