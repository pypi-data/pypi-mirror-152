...
class MangoStickyRice:
    ...
    '''
    def __init__(self):
        self.youtubeurl = 'https://www.youtube.com/watch?v=t5hfE9uzo_o'
        self.youttubeurl_eng = 'https://www.youtube.com/watch?v=M7_WdFhI7Hk'
    ...
    def what_is_it(self):
        ...
        นอกจากนี้ หากรับประทานเกินพอดี จะร้อนใน, เจ็บคอ, ท้องผูก, ปวดหัว เป็นต้น เอาได้ 
        อย่างไรก็ดี ข้าวเหนียวในขนมหวานชนิดนี้มีสรรพคุณเป็นของร้อนรสหวาน 
        จะช่วยบำรุงพลัง ตลอดจนบำบัดอาการเหงื่อออกมาก และท้องเสีย 
        โดยเฉพาะมะม่วงที่มีรสหวานปนเปรี้ยวนั้น ช่วยบำรุงร่างกาย, แก้ไอ และขับลมได้

        ref: https://th.wikipedia.org/wiki/ข้าวเหนียวมะม่วง
        '''
        print(text)

    def show_ingredient(self,eng=False):
        ''' # โชว์ส่วนผสมข้าวเหนียวมะม่วง 
        
        show_ingredient(eng=True) # for English
        '''
        text = ''' 
        - ข้าวเหนียว 350 กรัม
        - กะทิ 1 กระป๋อง
    ...
    def show_location(self,location='',eng=False,open=False):
        ''' # ร้านข้าวเหนียวมะม่วง '''
        if eng == True:
            url = 'https://www.google.com/search?q=mango+sticky+rice+shop'
            print(url)
            if open == True:
