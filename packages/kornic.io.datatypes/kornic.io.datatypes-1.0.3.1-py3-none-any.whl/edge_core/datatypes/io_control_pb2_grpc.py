...
class IoControlServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetIoResponse = channel.unary_unary(
                '/kornic.sf.communication.io.IoControlService/GetIoResponse',
        ...
        self.GetIoAllCached = channel.unary_unary(
                '/kornic.sf.communication.io.IoControlService/GetIoAllCached',
        ...
        self.SetIoCache = channel.unary_unary(
                '/kornic.sf.communication.io.IoControlService/SetIoCache',
...
def add_IoControlServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'kornic.sf.communication.io.IoControlService', rpc_method_handlers)
...
class IoControlService(object):
    ...
    def GetIoResponse(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/kornic.sf.communication.io.IoControlService/GetIoResponse',
    ...
    def GetIoAllCached(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/kornic.sf.communication.io.IoControlService/GetIoAllCached',
    ...
    def SetIoCache(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/kornic.sf.communication.io.IoControlService/SetIoCache',
