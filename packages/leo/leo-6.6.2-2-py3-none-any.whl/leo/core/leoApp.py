...
class LoadManager:
    ...
    def doScriptOption(self, args, parser):
    ...
    def doSimpleOptions(self, args, trace_m):
    ...
    def doWindowSizeOption(self, args):
