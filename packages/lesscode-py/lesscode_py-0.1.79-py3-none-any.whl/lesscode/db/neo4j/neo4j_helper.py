...
class Neo4jHelper:
    ...
    async def delete_node(self, node_name: str, label_name: str, match_property_dict: dict = {},
                          node_property_dict: dict = {}):
    ...
    async def delete_property(self, node_name: str, label_name: str, delete_node_property_list: list,
                              match_property_dict: dict = {}, node_property_dict: dict = {}):
        sql = f"MATCH ({node_name}:{label_name}"
        if match_property_dict:
            sql += f"{dict_str(match_property_dict)})"
        else:
    ...
    async def delete_two_node_relationship(self, relationship_name: str, relationship: str, node1_name: str = None,
                                           label1_name: str = None, node1_match_property_dict: dict = {},
                                           node2_name: str = None, label2_name: str = None,
                                           node2_match_property_dict: dict = {}):
        if node1_name:
    ...
    async def query_node_relationship(self, relationship: str, node1_name: str = None, label1_name: str = None,
                                      node1_match_property_dict: dict = {},
                                      property_dict: dict = {}, node2_name: str = None, label2_name: str = None,
                                      node2_match_property_dict: dict = {}, result_list: list = None):
        if node1_name:
            if label1_name and not node1_match_property_dict:
                sql = f'MATCH ({node1_name}:{label1_name})'
            elif node1_match_property_dict and not label1_name:
    ...
    async def query_all_node(self, node_name: str = None, label_name: str = None, match_property_dict: dict = {},
                             node_property_dict: dict = {}, result_list: list = None):
        if node_name:
            if label_name and not match_property_dict:
                sql = f'MATCH ({node_name}:{label_name})'
            elif match_property_dict and not label_name:
    ...
    async def query_node_count(self, node_name: str = None, label_name: str = None, match_property_dict: dict = {},
                               node_property_dict: dict = {}):
        if node_name:
            if label_name and not match_property_dict:
                sql = f'MATCH ({node_name}:{label_name})'
    ...
    async def query_node_page(self, node_name: str = None, label_name: str = None, match_property_dict: dict = {},
                              node_property_dict: dict = {}, result_list: list = None,
    ...
    async def execute_write(self, sql):
        ...
        return eval(summary.counters.__repr__())
    ...
    def sync_delete_node(self, node_name: str, label_name: str, match_property_dict: dict = {},
                         node_property_dict: dict = {}):
        sql = f"MATCH ({node_name}:{label_name}"
        if match_property_dict:
            sql += f"{dict_str(match_property_dict)})"
    ...
    def sync_query_all_node(self, node_name: str = None, label_name: str = None, match_property_dict: dict = {},
                            node_property_dict: dict = {}, result_list: list = None):
        if node_name:
            if label_name and not match_property_dict:
                sql = f'MATCH ({node_name}:{label_name})'
    ...
    def sync_query_node_count(self, node_name: str = None, label_name: str = None, match_property_dict: dict = {},
                              node_property_dict: dict = {}):
        if node_name:
            if label_name and not match_property_dict:
                sql = f'MATCH ({node_name}:{label_name})'
    ...
    def sync_query_node_page(self, node_name: str = None, label_name: str = None, match_property_dict: dict = {},
                             node_property_dict: dict = {}, result_list: list = None,
                             page_num: int = 1, page_size: int = 10):
        if node_name:
            if label_name and not match_property_dict:
