...
class TaggingData:
    ...
    def _compute_calibrated_statistics(self, func, minimizer):
        ...
        # self._full_data.loc[self._full_data.tagged, "omega"] = func.eval(params_ps[:func.npar],
        #                                                                  eta     = self._full_data.eta[self._full_data.tagged],
        #                                                                  dec     = self._full_data.dec[self._full_data.tagged])
    ...
    def dilution_squared(self, calibrated, inselection=True):
        ...
        if calibrated:
            if inselection:
                ...
                grad_calib = self.func.gradient(self._params_nominal, self._tagdata.omega, self._tagdata.cdec)
                ...
                grad_calib = self.func.gradient(self._params_nominal, self._full_data[self._full_data.tagged].omega, self._full_data[self._full_data.tagged].cdec)
