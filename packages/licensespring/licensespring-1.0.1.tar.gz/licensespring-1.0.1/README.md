...
# Generate license data for offline activation
...
# Generate license data for offline deactivation
...
# Activate offline
license_data = api_client.activate_offline(data=deactivate_offline_data)
```
