...
class SalesNoteDetail(InvoiceDetail):
    main = "sales_tab general more ledger"

    sales_tab = dd.Panel("""
    payment_method total_incl
    ItemsByInvoice
    """, label=_("Sales"))
...
class SalesNotesByJournal(InvoicesByJournal):
    detail_layout = 'sales.SalesNoteDetail'
...
VoucherTypes.add_item_lazy(SalesNotesByJournal)
