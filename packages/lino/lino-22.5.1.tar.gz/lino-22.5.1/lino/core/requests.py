...
class BaseRequest(object):
    ...
    def show(self, spec=None, master_instance=None, column_names=None,
        ...
        :nosummary: if it is a table with :attr:`display_mode_main
                    <lino.core.tables.AbstractTable.display_mode_main>`
                    set to ``'summary'``, force rendering it as a
                    table.

        :display_mode: override the table's :attr:`display_mode_main
                       <lino.core.tables.AbstractTable.display_mode_main>`.
