...
class AuthProviderInternal(AuthProvider):
	...
	def get_user_for_token(A,token):raise NotImplementedError
class AuthClient:
...
def login(username=_A):
	...
	D=get_auth_cache();D.update({_C:A,_B:C.token});call_safe(D.save,exception_message='error saving authentication information')
