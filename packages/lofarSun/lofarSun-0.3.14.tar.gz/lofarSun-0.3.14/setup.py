...
setup(
  ...
  version = '0.3.14',      # Start with a small number and increase it with every change you make
  ...
  entry_points={'console_scripts': ['lofarBFcube=lofarSun.BF.GUI.lofarBFgui']},
