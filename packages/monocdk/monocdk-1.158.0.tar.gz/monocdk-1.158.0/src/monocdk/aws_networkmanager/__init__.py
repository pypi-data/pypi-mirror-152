...
class CfnConnectAttachment(
    ...
    def __init__(
        ...
        *,
        ...
        options: typing.Optional[typing.Union["CfnConnectAttachment.ConnectAttachmentOptionsProperty", _IResolvable_a771d0ef]] = None,
...
class CfnConnectPeer(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        bgp_options: typing.Optional[typing.Union["CfnConnectPeer.BgpOptionsProperty", _IResolvable_a771d0ef]] = None,
...
class CfnVpcAttachment(
    ...
    def __init__(
        ...
        *,
        core_network_id: typing.Optional[builtins.str] = None,
        options: typing.Optional[typing.Union["CfnVpcAttachment.VpcOptionsProperty", _IResolvable_a771d0ef]] = None,
