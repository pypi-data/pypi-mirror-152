...
from mozperftest_tools.mozperftest_tools.utils.artifact_downloader import artifact_downloader
from mozperftest_tools.mozperftest_tools.utils.task_processor import get_task_data_paths, match_vismets_with_videos, sorted_nicely

from mozperftest_tools.mozperftest_tools.utils.utils import write_same_line, finish_same_line, find_task_group_id
...
if __name__ == "__main__":
    s = SideBySide("../../side_by_side/imgur-macos/")
    s.run(
        test_name="browsertime-tp6-firefox-imgur-fis-e10s",
        platform="test-macosx1015-64-shippable-qr/opt-browsertime-tp6-firefox-imgur-fis-e10s",
        base_branch="autoland",
        base_revision="0988c4cb48f57c8ddfdf4f6a4f6f0e0ba9f6d730",
        new_branch="autoland",
        new_revision="41021fdf3844e44e65cd1d4c700ce4668d4f4456"
    )