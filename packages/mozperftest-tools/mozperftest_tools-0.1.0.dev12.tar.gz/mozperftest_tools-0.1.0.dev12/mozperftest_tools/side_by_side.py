...
if __name__ == "__main__":
    s = SideBySide("../../side_by_side/bing-search-windows/")
    s.run(
        test_name="browsertime-tp6-essential-firefox-bing-search-fis-e10s",
        platform="test-windows10-64-shippable-qr/opt-browsertime-tp6-essential-firefox-bing-search-fis-e10s",
        base_branch="autoland",
        base_revision="31328dea3321907e711f5ffc0946c71a3c01ce05",
        new_branch="autoland",
        new_revision="c36ca41e04d417e30cb2b2f41c93f0e093ca9285"
    )