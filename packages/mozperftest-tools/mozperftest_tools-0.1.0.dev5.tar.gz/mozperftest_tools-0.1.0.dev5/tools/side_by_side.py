...
from tools.utils.artifact_downloader import artifact_downloader
from tools.utils.task_processor import get_task_data_paths, match_vismets_with_videos, sorted_nicely

from tools.utils.utils import write_same_line, finish_same_line, find_task_group_id
...
if __name__ == "__main__":
    s = SideBySide("../../side_by_side/welcome-linux/")
    s.run(
