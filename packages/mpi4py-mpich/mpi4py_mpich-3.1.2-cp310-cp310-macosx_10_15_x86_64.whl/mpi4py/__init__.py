...
if platform.system() == "Windows":
    import os
    import ctypes
    PATH_TO_MSMPI_DLL = os.path.join(os.path.dirname(__file__), "..", "mpiexec", ".libs")
    # load MS-MPI dll into memory to make sure it is found (because it's not in PATH)
    ctypes.CDLL(os.path.join(PATH_TO_MSMPI_DLL, "msmpi.dll"))
