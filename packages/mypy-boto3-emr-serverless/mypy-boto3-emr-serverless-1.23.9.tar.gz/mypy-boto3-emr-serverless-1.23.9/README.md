...
[boto3.EMRServerlessWebService 1.23.9](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/emr-serverless.html#EMRServerlessWebService)
...
`EMRServerlessWebServiceClient` provides annotations for
`boto3.client("emr-serverless")`.

```python
from boto3.session import Session

from mypy_boto3_emr_serverless import EMRServerlessWebServiceClient
