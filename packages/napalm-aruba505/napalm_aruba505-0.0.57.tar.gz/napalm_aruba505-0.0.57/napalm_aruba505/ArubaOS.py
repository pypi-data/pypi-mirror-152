...
class ArubaOS505(NetworkDriver):
    ...
    def get_lldp_neighbors(self):
        """IOS implementation of get_lldp_neighbors."""
        lldp = {'Ethernet0': [{'hostname': 'junos-unittest0','port': '520',}],
                'Ethernet1': [{'hostname': 'junos-unittest1','port': '521',}],
                'Ethernet2': [{'hostname': 'junos-unittest2','port': '522',}],
                'Ethernet3': [{'hostname': 'junos-unittest3','port': '523',}],
                'Ethernet4': [{'hostname': 'junos-unittest4','port': '524',}],}
