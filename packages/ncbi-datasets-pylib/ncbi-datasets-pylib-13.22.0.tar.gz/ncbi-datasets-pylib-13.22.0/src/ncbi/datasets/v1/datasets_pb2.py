...
_VIRUSDATASETREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='host', full_name='ncbi.datasets.v1.VirusDatasetRequest.host', index=8,
      number=7, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='pangolin_classification', full_name='ncbi.datasets.v1.VirusDatasetRequest.pangolin_classification', index=9,
      number=15, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='geo_location', full_name='ncbi.datasets.v1.VirusDatasetRequest.geo_location', index=10,
      number=8, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='complete_only', full_name='ncbi.datasets.v1.VirusDatasetRequest.complete_only', index=11,
      number=9, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='table_fields', full_name='ncbi.datasets.v1.VirusDatasetRequest.table_fields', index=12,
    ...
    _descriptor.FieldDescriptor(
      name='exclude_sequence', full_name='ncbi.datasets.v1.VirusDatasetRequest.exclude_sequence', index=13,
      ...
      serialized_options=b'\302\360\031L\n\005false\022 \n\004true\022\030Exclude genomic sequence\022!\n\005false\022\030Include genomic sequence\332\360\031\002\010\002', json_name='excludeSequence', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='include_annotation_type', full_name='ncbi.datasets.v1.VirusDatasetRequest.include_annotation_type', index=14,
    ...
    _descriptor.FieldDescriptor(
      name='format', full_name='ncbi.datasets.v1.VirusDatasetRequest.format', index=15,
...
_VIRUSDATASETFILTER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=b'\302\360\031\036\022\034\n\n2020-08-01\022\016August 1, 2020', json_name='releasedSince', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='host', full_name='ncbi.datasets.v1.VirusDatasetFilter.host', index=5,
      number=7, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\302\360\031\020\022\016\n\005human\022\005human', json_name='host', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='pangolin_classification', full_name='ncbi.datasets.v1.VirusDatasetFilter.pangolin_classification', index=6,
      number=8, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='pangolinClassification', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='geo_location', full_name='ncbi.datasets.v1.VirusDatasetFilter.geo_location', index=7,
      number=9, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\302\360\031\031\022\n\n\003USA\022\003USA\022\013\n\002TX\022\005Texas', json_name='geoLocation', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='complete_only', full_name='ncbi.datasets.v1.VirusDatasetFilter.complete_only', index=8,
