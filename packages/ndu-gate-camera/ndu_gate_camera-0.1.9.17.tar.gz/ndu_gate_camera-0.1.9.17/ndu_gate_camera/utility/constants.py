...
LOCAL_RESULTS_PATH = "local_results.txt"
LOCAL_RESULT_LIMIT_BYTE = 131360
SEND_FRAME='send_frame'
CONFIGURATION_KEY = "conf"
MOBILE_RUNNER = 'ssd_mobilenet_SsdMobilenetRunner_ssd_mobilenet.json'