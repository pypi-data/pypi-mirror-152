...
def refine(home_dir, job_id, pdb, cpu):
    ...
    print("paths here",tleap,sander,sander_MPI,cpptraj,"paths here")

    tleap = subprocess.run(["which","tleap",">>","/home/nmrbox/0013/nfowler/pipeline/test_package/logs/checkwhich.tmp"],stdout=subprocess.PIPE, stderr=open(os.devnull, 'w'))
