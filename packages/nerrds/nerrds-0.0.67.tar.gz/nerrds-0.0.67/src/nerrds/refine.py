...
def refine(home_dir, job_id, pdb, cpu, tleap, sander, sander_MPI, cpptraj):
    ...
    #elif nmrbox == 1:
    #    tleap = "/usr/software/amber/bin/tleap" # hard code for NMRBox, fix later
    #    sander = "/usr/software/amber/bin/sander"
    #    sander_MPI = "/usr/software/amber/bin/sander.MPI"
    #    cpptraj = "/usr/software/amber/bin/cpptraj"
...
if __name__ == "__main__":
    ...
    if mode == 'refine':
        ...
        pdb = sys.argv[4]
        cpu = sys.argv[5]
        refine(home_dir, job_id, pdb, cpu, nmrbox=1)
    elif mode == 'combine':
        home_dir = sys.argv[2]
        job_id = sys.argv[3]
        pdb_id = sys.argv[4]
