...
setuptools.setup(
    ...
    platforms="any",
    install_requires=["aiofiles", "fuzzyfinder", 'nonebot-adapter-onebot>=2.0.0-beta.1,<3.0.0', 'nonebot2>=2.0.0-beta'
                                                                                                '.1,<3.0.0', "jieba",
                      "httpx", "tencentcloud-sdk-python>=3.0.580", "jinja2", "pyppeteer"]
)
