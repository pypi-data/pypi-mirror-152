...
class BackTest:
    ...
    def get_performance_graph(self, pair: str):
        ...
        plt.plot(self.df_pos.open_time[self.df_pos.index > begin], self.df_pos[f'total_profit_{pair}'][self.df_pos.index > begin], label='Total Profit')
        plt.plot(self.df_pos.open_time[self.df_pos.index > begin], self.df_pos[f'long_profit_{pair}'][self.df_pos.index > begin], label='Long Profit')
        plt.plot(self.df_pos.open_time[self.df_pos.index > begin], self.df_pos[f'short_profit_{pair}'][self.df_pos.index > begin], label='Short Profit')
        plt.legend()
