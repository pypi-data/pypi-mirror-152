...
def __test_post(
    ...
    list_url = list_url_for_model(model)
    if expectation.create_status_code:
...
def __test_put(
    ...
    detail_url = detail_url_for_model(model)
    if expectation.put_status_code:
...
def __test_patch(
    ...
    detail_url = detail_url_for_model(model)
    if expectation.patch_status_code:
