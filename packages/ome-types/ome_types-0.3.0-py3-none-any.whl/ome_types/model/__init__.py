...
_lists = {
    ...
    "Pixels": {"BinData", "Plane", "TiffData", "Channel"},
    "Plane": {"AnnotationRef"},
    ...
    "ExperimenterGroup": {"AnnotationRef", "ExperimenterRef", "Leader"},
    "Dataset": {"AnnotationRef", "ImageRef"},
    "Experiment": {"MicrobeamManipulation", "Type"},
    "Experimenter": {"AnnotationRef"},
    "Folder": {"AnnotationRef", "FolderRef", "ImageRef", "ROIRef"},
    ...
    "Screen": {"PlateRef", "Reagent", "AnnotationRef"},
