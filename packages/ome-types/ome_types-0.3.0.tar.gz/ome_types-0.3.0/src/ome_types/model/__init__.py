...
_lists = {
    ...
    "Image": {"ROIRef", "MicrobeamManipulationRef", "AnnotationRef"},
    "Pixels": {"TiffData", "BinData", "Channel", "Plane"},
    "Plane": {"AnnotationRef"},
    ...
    "ExperimenterGroup": {"ExperimenterRef", "Leader", "AnnotationRef"},
    "Dataset": {"ImageRef", "AnnotationRef"},
    "Experiment": {"Type", "MicrobeamManipulation"},
    "Experimenter": {"AnnotationRef"},
    "Folder": {"FolderRef", "ROIRef", "ImageRef", "AnnotationRef"},
