...
class Browser:
    ...
    **Constructor**
    ...
    def __init__(self, showWindow=True, proxy=None, downloadPath:str='/tmp', browser_options=[]):
        ...
        self.driver = webdriver.Chrome(ChromeDriverManager(path='/tmp/chromedriver', print_first_line=False, log_level=0).install(), options=options)
        self.Key = Keys
        self.errors = []
