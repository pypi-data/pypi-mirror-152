...
__all__ = ['dict2tuple', 'read_asxml', 'xml2dict', 'exclude_kpts', 'get_ispin', 'get_summary', 'join_ksegments',
           'get_kpts', 'get_tdos', 'get_evals', 'get_bands_pro_set', 'get_dos_pro_set', 'get_structure',
           'export_vasprun', 'load_export', 'islice2array', 'slice_data', 'split_vasprun', 'export_spin_data']
