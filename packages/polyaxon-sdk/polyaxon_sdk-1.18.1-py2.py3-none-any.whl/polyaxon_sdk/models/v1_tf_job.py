...
class V1TFJob(object):
    ...
    def __init__(self, kind='tfjob', clean_pod_policy=None, scheduling_policy=None, chief=None, worker=None, ps=None, evaluator=None, local_vars_configuration=None):  # noqa: E501
