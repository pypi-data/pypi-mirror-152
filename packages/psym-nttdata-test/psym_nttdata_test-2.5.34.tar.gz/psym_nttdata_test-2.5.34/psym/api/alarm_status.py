...
def add_alarm_status(
    ...
    **Example 2**
    ...
    if alarm_status_input.name =="": 
        print ("you cant leave the name parameter empty")
    elif alarm_status_input.name != str:
        print ("the input must be a text, example name=\"new name\"")
    else:
