...
class Remote(object):
    ...
    def __init__(self, name=None, url=None, ca_cert=None, client_cert=None, client_key=None, tls_validation=None, proxy_url=None, proxy_username=None, proxy_password=None, username=None, password=None, pulp_labels=None, download_concurrency=None, max_retries=None, policy=None, total_timeout=None, connect_timeout=None, sock_connect_timeout=None, sock_read_timeout=None, headers=None, rate_limit=None, local_vars_configuration=None):  # noqa: E501
        """Remote - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this Remote.  # noqa: E501

        A unique name for this remote.  # noqa: E501

        :return: The name of this Remote.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        ...
        :param name: The name of this Remote.  # noqa: E501
        :type: str
        """
    ...
    @property
    def url(self):
        """Gets the url of this Remote.  # noqa: E501

        The URL of an external content source.  # noqa: E501

        :return: The url of this Remote.  # noqa: E501
        :rtype: str
        """
        return self._url
    ...
    def url(self, url):
        ...
        :param url: The url of this Remote.  # noqa: E501
        :type: str
        """
    ...
    def ca_cert(self, ca_cert):
        """Sets the ca_cert of this Remote.

        A PEM encoded CA certificate used to validate the server certificate presented by the remote server.  # noqa: E501

        :param ca_cert: The ca_cert of this Remote.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def client_cert(self):
        """Gets the client_cert of this Remote.  # noqa: E501

        A PEM encoded client certificate used for authentication.  # noqa: E501

        :return: The client_cert of this Remote.  # noqa: E501
        :rtype: str
        """
    ...
    def client_cert(self, client_cert):
        """Sets the client_cert of this Remote.

        A PEM encoded client certificate used for authentication.  # noqa: E501

        :param client_cert: The client_cert of this Remote.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def client_key(self):
        """Gets the client_key of this Remote.  # noqa: E501

        A PEM encoded private key used for authentication.  # noqa: E501

        :return: The client_key of this Remote.  # noqa: E501
        :rtype: str
        """
    ...
    def client_key(self, client_key):
        """Sets the client_key of this Remote.

        A PEM encoded private key used for authentication.  # noqa: E501

        :param client_key: The client_key of this Remote.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def tls_validation(self):
        """Gets the tls_validation of this Remote.  # noqa: E501

        If True, TLS peer validation must be performed.  # noqa: E501

        :return: The tls_validation of this Remote.  # noqa: E501
        :rtype: bool
        """
    ...
    def tls_validation(self, tls_validation):
        """Sets the tls_validation of this Remote.

        If True, TLS peer validation must be performed.  # noqa: E501

        :param tls_validation: The tls_validation of this Remote.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def proxy_url(self):
        """Gets the proxy_url of this Remote.  # noqa: E501

        The proxy URL. Format: scheme://host:port  # noqa: E501

        :return: The proxy_url of this Remote.  # noqa: E501
        :rtype: str
        """
    ...
    def proxy_url(self, proxy_url):
        """Sets the proxy_url of this Remote.

        The proxy URL. Format: scheme://host:port  # noqa: E501

        :param proxy_url: The proxy_url of this Remote.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def proxy_username(self):
        """Gets the proxy_username of this Remote.  # noqa: E501

        The username to authenticte to the proxy.  # noqa: E501

        :return: The proxy_username of this Remote.  # noqa: E501
        :rtype: str
        """
    ...
    def proxy_username(self, proxy_username):
        """Sets the proxy_username of this Remote.

        The username to authenticte to the proxy.  # noqa: E501

        :param proxy_username: The proxy_username of this Remote.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def proxy_password(self):
        """Gets the proxy_password of this Remote.  # noqa: E501

        The password to authenticte to the proxy.  # noqa: E501

        :return: The proxy_password of this Remote.  # noqa: E501
        :rtype: str
        """
    ...
    def proxy_password(self, proxy_password):
        """Sets the proxy_password of this Remote.

        The password to authenticte to the proxy.  # noqa: E501

        :param proxy_password: The proxy_password of this Remote.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def pulp_labels(self):
        """Gets the pulp_labels of this Remote.  # noqa: E501


        :return: The pulp_labels of this Remote.  # noqa: E501
        :rtype: object
        """
    ...
    def pulp_labels(self, pulp_labels):
        """Sets the pulp_labels of this Remote.


        :param pulp_labels: The pulp_labels of this Remote.  # noqa: E501
        :type: object
        """
    ...
    def download_concurrency(self):
        """Gets the download_concurrency of this Remote.  # noqa: E501

        Total number of simultaneous connections. If not set then the default value will be used.  # noqa: E501

        :return: The download_concurrency of this Remote.  # noqa: E501
        :rtype: int
        """
    ...
    def download_concurrency(self, download_concurrency):
        """Sets the download_concurrency of this Remote.

        Total number of simultaneous connections. If not set then the default value will be used.  # noqa: E501

        :param download_concurrency: The download_concurrency of this Remote.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def max_retries(self, max_retries):
        """Sets the max_retries of this Remote.

        Maximum number of retry attempts after a download failure. If not set then the default value (3) will be used.  # noqa: E501

        :param max_retries: The max_retries of this Remote.  # noqa: E501
        :type: int
        """
    ...
    @property
    def policy(self):
        """Gets the policy of this Remote.  # noqa: E501

        The policy to use when downloading content.  # noqa: E501

        :return: The policy of this Remote.  # noqa: E501
        :rtype: PolicyEnum
        """
        return self._policy
    ...
    def policy(self, policy):
        """Sets the policy of this Remote.

        The policy to use when downloading content.  # noqa: E501

        :param policy: The policy of this Remote.  # noqa: E501
        :type: PolicyEnum
        """
    ...
    def total_timeout(self):
        """Gets the total_timeout of this Remote.  # noqa: E501
        ...
        :return: The total_timeout of this Remote.  # noqa: E501
        :rtype: float
        """
    ...
    def total_timeout(self, total_timeout):
        """Sets the total_timeout of this Remote.

        aiohttp.ClientTimeout.total (q.v.) for download-connections. The default is null, which will cause the default from the aiohttp library to be used.  # noqa: E501

        :param total_timeout: The total_timeout of this Remote.  # noqa: E501
        :type: float
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def connect_timeout(self):
        """Gets the connect_timeout of this Remote.  # noqa: E501
        ...
        :return: The connect_timeout of this Remote.  # noqa: E501
        :rtype: float
        """
    ...
    def connect_timeout(self, connect_timeout):
        """Sets the connect_timeout of this Remote.

        aiohttp.ClientTimeout.connect (q.v.) for download-connections. The default is null, which will cause the default from the aiohttp library to be used.  # noqa: E501

        :param connect_timeout: The connect_timeout of this Remote.  # noqa: E501
        :type: float
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def sock_connect_timeout(self):
        """Gets the sock_connect_timeout of this Remote.  # noqa: E501
        ...
        :return: The sock_connect_timeout of this Remote.  # noqa: E501
        :rtype: float
        """
    ...
    def sock_connect_timeout(self, sock_connect_timeout):
        """Sets the sock_connect_timeout of this Remote.

        aiohttp.ClientTimeout.sock_connect (q.v.) for download-connections. The default is null, which will cause the default from the aiohttp library to be used.  # noqa: E501

        :param sock_connect_timeout: The sock_connect_timeout of this Remote.  # noqa: E501
        :type: float
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def sock_read_timeout(self):
        """Gets the sock_read_timeout of this Remote.  # noqa: E501
        ...
        :return: The sock_read_timeout of this Remote.  # noqa: E501
        :rtype: float
        """
    ...
    def sock_read_timeout(self, sock_read_timeout):
        """Sets the sock_read_timeout of this Remote.

        aiohttp.ClientTimeout.sock_read (q.v.) for download-connections. The default is null, which will cause the default from the aiohttp library to be used.  # noqa: E501

        :param sock_read_timeout: The sock_read_timeout of this Remote.  # noqa: E501
        :type: float
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def headers(self):
        """Gets the headers of this Remote.  # noqa: E501

        Headers for aiohttp.Clientsession  # noqa: E501

        :return: The headers of this Remote.  # noqa: E501
        :rtype: list[object]
        """
    ...
    def headers(self, headers):
        """Sets the headers of this Remote.

        Headers for aiohttp.Clientsession  # noqa: E501

        :param headers: The headers of this Remote.  # noqa: E501
        :type: list[object]
        """
    ...
    @property
    def rate_limit(self):
        """Gets the rate_limit of this Remote.  # noqa: E501

        Limits requests per second for each concurrent downloader  # noqa: E501

        :return: The rate_limit of this Remote.  # noqa: E501
        :rtype: int
        """
    ...
    def rate_limit(self, rate_limit):
        """Sets the rate_limit of this Remote.

        Limits requests per second for each concurrent downloader  # noqa: E501

        :param rate_limit: The rate_limit of this Remote.  # noqa: E501
        :type: int
        """
