...
def daily_factor_on300500(fac,hs300=False,zz500=False,zz1000=False,gz2000=False,other=False):
    ...
    if fac.shape[0]/last.shape[0]>2:
        if hs300:
            ...
            df=pd.read_feather('/Users/chenzongwei/pythoncode/数据库/国证2000成分股.feather').set_index('index')
            df=df*fac
            df=df.dropna(how='all')
        elif other:
        ...
        if hs300:
            ...
            df=pd.read_feather('/Users/chenzongwei/pythoncode/数据库/国证2000成分股.feather').set_index('index').resample('M').last()
            df=df*fac
            df=df.dropna(how='all')
        elif other:
