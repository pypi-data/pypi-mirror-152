...
#       Successfully imported crystal data
    ...
    # def _get_sf(sftype = 1, aptype = 0):
    #     """
    #     This routine returns raw crystal structure factors
    ...
    #     ret = dif.generate_sf(1, 0)
    #     if ret != 0:
    #         print(f"Error generating crytsal structure factors data: {ret}")
    #         return
