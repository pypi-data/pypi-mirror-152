...
class AvrDebugger():
    ...
    def sram_read(self, address, numbytes):
        ...
        # Subtract offset to match debugger protocol call
    ...
    def flash_read(self, address, numbytes):
        ...
        # Subtract offset to match debugger protocol call
        offset = (self.memory_info.memory_info_by_name('flash'))['address']
        return self.device.read(self.memory_info.memory_info_by_name('flash'), address-offset, numbytes)
