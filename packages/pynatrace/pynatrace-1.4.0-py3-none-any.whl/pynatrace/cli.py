...
def main():
    ...
    Example Usage: pynatrace send-log CRCO8GWSFTP01 ERROR "SMB VERIFICATION FAILED"
    """
...
@main.command('create-token', short_help='Create a new token with permissions to read and ingest metrics')
def create_token():
    """ Create a new token """
    dt_api_key = os.getenv('DT_API_KEY')
    dt_server_uri = os.getenv('DT_SERVER_URI')
