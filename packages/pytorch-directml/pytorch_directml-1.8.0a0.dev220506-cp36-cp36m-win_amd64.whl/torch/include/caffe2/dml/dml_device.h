...
#include "dml_backend.h"
//#include "tensorflow/core/common_runtime/local_device.h"
//#include "tensorflow/core/public/session_options.h"

namespace dml {

// Implements dml::Device using a shared DmlBackend.
//class DmlDevice : public LocalDevice {
class DmlDevice {
 public:  // Methods
  DmlDevice(const DmlBackend* state
  // const SessionOptions& options, const DeviceAttributes& attributes
  );
  ...
  */
 private:
  const DmlBackend* state_;  // Weak; owned by the device factory
