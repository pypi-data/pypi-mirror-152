...
def build_and_bind_namespaces(qctrl: "Qctrl") -> None:
    ...
    if PackageRegistry.QCTRLTOOLKIT.is_installed():
        toolkit = PackageRegistry.QCTRLTOOLKIT.import_pkg()
        build_and_bind_toolkit(qctrl, ToolkitCategory.WORKFLOWS, toolkit)
