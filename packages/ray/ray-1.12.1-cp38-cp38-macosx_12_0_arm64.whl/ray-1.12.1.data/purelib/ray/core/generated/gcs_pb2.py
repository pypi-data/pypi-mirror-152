...
_JOBCONFIG_ACTORLIFETIME = _descriptor.EnumDescriptor(
  name='ActorLifetime',
  full_name='ray.rpc.JobConfig.ActorLifetime',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
    _descriptor.EnumValueDescriptor(
      name='DETACHED', index=0, number=0,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='NON_DETACHED', index=1, number=1,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
  ],
...
_sym_db.RegisterEnumDescriptor(_JOBCONFIG_ACTORLIFETIME)
...
_JOBCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='default_actor_lifetime', full_name='ray.rpc.JobConfig.default_actor_lifetime', index=6,
      number=7, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='defaultActorLifetime', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
  ],
  extensions=[
  ],
  nested_types=[_JOBCONFIG_METADATAENTRY, ],
  enum_types=[
    _JOBCONFIG_ACTORLIFETIME,
  ],
  serialized_options=None,
  is_extendable=False,
  syntax='proto3',
...
_ACTORTABLEDATA.fields_by_name['death_cause'].message_type = src_dot_ray_dot_protobuf_dot_common__pb2._ACTORDEATHCAUSE
...
_JOBCONFIG.fields_by_name['default_actor_lifetime'].enum_type = _JOBCONFIG_ACTORLIFETIME
_JOBCONFIG_ACTORLIFETIME.containing_type = _JOBCONFIG
