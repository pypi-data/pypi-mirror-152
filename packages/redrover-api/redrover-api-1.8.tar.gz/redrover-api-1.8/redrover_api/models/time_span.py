...
class TimeSpan(object):
    ...
    def __init__(self, ticks=None, days=None, hours=None, milliseconds=None, minutes=None, seconds=None, total_days=None, total_hours=None, total_milliseconds=None, total_minutes=None, total_seconds=None, local_vars_configuration=None):  # noqa: E501
