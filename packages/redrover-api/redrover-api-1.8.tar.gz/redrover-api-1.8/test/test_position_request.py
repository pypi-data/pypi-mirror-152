...
import redrover_api
from redrover_api.models.position_request import PositionRequest  # noqa: E501
...
class TestPositionRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        """Test PositionRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = redrover_api.models.position_request.PositionRequest()  # noqa: E501
        if include_optional :
