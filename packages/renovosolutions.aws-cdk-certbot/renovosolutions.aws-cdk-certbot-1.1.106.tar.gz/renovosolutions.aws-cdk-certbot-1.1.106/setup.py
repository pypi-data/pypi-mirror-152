    ...
    """
{
    ...
    "package_data": {
        "certbot._jsii": [
            "cdk-library-certbot@1.1.106.jsii.tgz"
        ],
        "certbot": [
            "py.typed"
        ]
    ...
    "python_requires": "~=3.7",
    "install_requires": [
        "aws-cdk.aws-events-targets>=1.158.0, <2.0.0",
        "aws-cdk.aws-events>=1.158.0, <2.0.0",
        "aws-cdk.aws-iam>=1.158.0, <2.0.0",
        "aws-cdk.aws-lambda>=1.158.0, <2.0.0",
        "aws-cdk.aws-route53>=1.158.0, <2.0.0",
        "aws-cdk.aws-s3>=1.158.0, <2.0.0",
        "aws-cdk.aws-sns-subscriptions>=1.158.0, <2.0.0",
        "aws-cdk.aws-sns>=1.158.0, <2.0.0",
        "aws-cdk.core>=1.158.0, <2.0.0",
