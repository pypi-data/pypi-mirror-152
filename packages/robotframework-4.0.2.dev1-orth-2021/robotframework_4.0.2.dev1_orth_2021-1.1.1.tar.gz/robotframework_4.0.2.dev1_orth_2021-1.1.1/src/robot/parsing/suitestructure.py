...
class SuiteStructure(object):
    ...
    def visit(self, visitor,out_dir=None,file=None):
        if self.children is None:
            visitor.visit_file(self,out_dir,file)
        else:
            visitor.visit_directory(self,out_dir)
...
class SuiteStructureVisitor(object):
    ...
    def visit_directory(self, structure,out_dir=None):
        self.start_directory(structure,out_dir)
