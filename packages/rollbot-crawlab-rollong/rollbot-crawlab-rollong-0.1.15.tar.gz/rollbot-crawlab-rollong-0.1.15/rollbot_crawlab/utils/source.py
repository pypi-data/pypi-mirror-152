...
def update_source_comment_latest_id(source, comment_latest_id):
    col = get_col("sources")
    comment_latest_count = source.get("comment_total_count", 0)
    comment_total_count= get_source_total(source) #TODO
    where = {"_id": source["_id"]}
