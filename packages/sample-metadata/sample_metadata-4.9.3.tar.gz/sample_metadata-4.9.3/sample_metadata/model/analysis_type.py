...
class AnalysisType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): Types of analysis., must be one of ["qc", "joint-calling", "gvcf", "cram", "custom", ]  # noqa: E501

        Keyword Args:
            value (str): Types of analysis., must be one of ["qc", "joint-calling", "gvcf", "cram", "custom", ]  # noqa: E501
