...
class SequenceType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): Type of sequencing., must be one of ["genome", "exome", "single-cell", "mtseq", ]  # noqa: E501

        Keyword Args:
            value (str): Type of sequencing., must be one of ["genome", "exome", "single-cell", "mtseq", ]  # noqa: E501
