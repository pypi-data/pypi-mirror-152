...
class Transmitter(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'itu_notification': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, uuid, description, alive, mode, mode_id, uplink_mode, sat_id, norad_cat_id, updated, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            itu_notification ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): [optional]  # noqa: E501
        """
