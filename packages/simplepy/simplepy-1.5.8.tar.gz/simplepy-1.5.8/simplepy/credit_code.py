...
class UnifiedSocialCreditIdentifier(object):
    ...
    def check_social_credit_code(self, code):
        ...
        if self.string1[tmp_check_code] == check_code:
            print(self.string1[tmp_check_code], tmp_check_code)
...
if __name__ == '__main__':
    ...
    print(u.check_organization_code(code='836303192'))
    # suffix = '91330110MA2KKN0E5'
    # res = u.code_gen(suffix)
    # print(res)
    # 402836303192
    # 402836303192
