...
class CVStudio(object):
    ...
    def __init__(self, interactive=False, token=None, ibm_api_key_id=None, base_url=None, public=False, settingsFile='.cvstudio.json'):
        self.public = public
    ...
    def download_file_cos(self, key, folder=os.getcwd(), attempts=0):
        try:
            local_file_name=Path(folder).joinpath(key)
    ...
    class Dataset(Dataset):
        ...
        def __init__(self, annotations, bucket_name, transform,train_test=None,percentage_train=percentage_train,random_state=random_state,degrees=degrees):
            ...
            if self.train_test=='train':
                ...
                labels_filename=Path(os.getcwd()).joinpath(bucket_name+"_train_lables.csv")
                #self.data.to_csv(labels_filename)
            #test set    
            if self.train_test=='test':
                print("this is the test set")
                labels_filename=Path(os.getcwd()).joinpath(bucket_name+"_test_lables.csv")    
