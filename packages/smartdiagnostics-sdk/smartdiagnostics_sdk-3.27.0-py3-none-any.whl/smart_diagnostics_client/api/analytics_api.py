...
class AnalyticsApi(object):
    ...
    def get_analytics_assignments(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str filter: Filter statements to narrow results by properties. Filterable properties:  | Field name | Type | Operators | | ---------- | ---- | --------- | | `CorporationAbbreviation` | String | `eq, neq, in, like, isnull, isnotnull` | | `CorporationId` | Guid | `eq, neq, in` | | `CorporationName` | String | `eq, neq, in, like, isnull, isnotnull` | | `UserEmail` | String | `eq, neq, in, like, isnull, isnotnull` | | `UserFirstName` | String | `eq, neq, in, like, isnull, isnotnull` | | `UserId` | Guid | `eq, neq, in` | | `UserLastName` | String | `eq, neq, in, like, isnull, isnotnull` | | `LocationAbbreviation` | String | `eq, neq, in, like, isnull, isnotnull` | | `LocationId` | Guid | `eq, neq, in` | | `LocationName` | String | `eq, neq, in, like, isnull, isnotnull` | | `AnalyticsModelId` | Guid | `eq, neq, in` | | `AnalyticsModelName` | String | `eq, neq, in, like, isnull, isnotnull` |
        ...
        :param str order_by: Allows sorting response items by multiple fields. Sortable properties: | Field name | Type | | ---------- | ---- |
    ...
    def get_analytics_models(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param list[str] corporation_ids: A list of corporation ids to filter the results to models that are assigned to them or are global. Filtering on this will only return corporation-based models, models with a location id will not be returned.
