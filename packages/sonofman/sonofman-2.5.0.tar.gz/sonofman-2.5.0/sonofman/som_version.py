...
class SomVersion:
    ...
    2.4.1 (4)  20220430 - Search style. Rem: discover that db not under Linux is always fresh install with PyPI!
    ...
    app_version = '2.5.0'
    app_version_date = '20220526'
    db_version = 4      # db version code
