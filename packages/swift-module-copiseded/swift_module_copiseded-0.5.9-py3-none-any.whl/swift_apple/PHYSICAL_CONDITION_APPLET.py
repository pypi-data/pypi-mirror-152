...
def read_from_file():
    with open('/Applications/Apple\ Swift\ 0.5.8/swift\ apple/swift_apple/APPLET.txt') as file:
        for line in file:
            line = line.rstrip('\n')
...
def write_to_file(solution_name,condition_name):
    with open('/Applications/Apple\ Swift\ 0.5.8/swift\ apple/swift_apple/APPLET.txt','a')as file:
