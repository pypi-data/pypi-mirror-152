...
def generate_synthetic_records(
    ...
    # Ensure totals match
    sales_df = calculation_utils.realign_with_totals(sales_df, "packages", total_packages)
    sales_df = calculation_utils.realign_with_totals(sales_df, "quantity", total_quantity)
