...
def load_tpu_embedding_frequency_estimator_parameters_grad_accum_debug(parameters, last_hit_step, gradient_accumulators, num_shards, shard_id, table_id=-1, table_name="", config="", name=None):
  r"""Load frequency estimator embedding parameters with debug support.
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx, "LoadTPUEmbeddingFrequencyEstimatorParametersGradAccumDebug",
        name, parameters, last_hit_step, gradient_accumulators, "table_id",
        table_id, "table_name", table_name, "num_shards", num_shards,
        "shard_id", shard_id, "config", config)
      return _result
    except _core._NotOkStatusException as e:
      ...
      pass
    try:
      return load_tpu_embedding_frequency_estimator_parameters_grad_accum_debug_eager_fallback(
          parameters, last_hit_step, gradient_accumulators, table_id=table_id,
          table_name=table_name, num_shards=num_shards, shard_id=shard_id,
          config=config, name=name, ctx=_ctx)
    except _core._SymbolicException:
      pass  # Add nodes to the TensorFlow graph.
  ...
  config = _execute.make_str(config, "config")
  _, _, _op, _outputs = _op_def_library._apply_op_helper(
        "LoadTPUEmbeddingFrequencyEstimatorParametersGradAccumDebug", parameters=parameters,
                                                                      last_hit_step=last_hit_step,
                                                                      gradient_accumulators=gradient_accumulators,
                                                                      num_shards=num_shards,
                                                                      shard_id=shard_id,
                                                                      ...
                                                                      name=name)
  return _op
LoadTPUEmbeddingFrequencyEstimatorParametersGradAccumDebug = tf_export("raw_ops.LoadTPUEmbeddingFrequencyEstimatorParametersGradAccumDebug")(_ops.to_raw_op(load_tpu_embedding_frequency_estimator_parameters_grad_accum_debug))


def load_tpu_embedding_frequency_estimator_parameters_grad_accum_debug_eager_fallback(parameters, last_hit_step, gradient_accumulators, num_shards, shard_id, table_id, table_name, config, name, ctx):
  num_shards = _execute.make_int(num_shards, "num_shards")
  shard_id = _execute.make_int(shard_id, "shard_id")
  if table_id is None:
    table_id = -1
  ...
  last_hit_step = _ops.convert_to_tensor(last_hit_step, _dtypes.float32)
  gradient_accumulators = _ops.convert_to_tensor(gradient_accumulators, _dtypes.float32)
  _inputs_flat = [parameters, last_hit_step, gradient_accumulators]
  _attrs = ("table_id", table_id, "table_name", table_name, "num_shards",
  num_shards, "shard_id", shard_id, "config", config)
  _result = _execute.execute(b"LoadTPUEmbeddingFrequencyEstimatorParametersGradAccumDebug",
                             0, inputs=_inputs_flat, attrs=_attrs, ctx=ctx,
                             name=name)
  _result = None
  return _result
...
_RetrieveTPUEmbeddingFrequencyEstimatorParametersGradAccumDebugOutput = collections.namedtuple(
    "RetrieveTPUEmbeddingFrequencyEstimatorParametersGradAccumDebug",
    ["parameters", "last_hit_step", "gradient_accumulators"])


def retrieve_tpu_embedding_frequency_estimator_parameters_grad_accum_debug(num_shards, shard_id, table_id=-1, table_name="", config="", name=None):
  r"""Retrieve frequency estimator embedding parameters with debug support.
  ...
  Returns:
    A tuple of `Tensor` objects (parameters, last_hit_step, gradient_accumulators).
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        ...
        num_shards, "shard_id", shard_id, "config", config)
      _result = _RetrieveTPUEmbeddingFrequencyEstimatorParametersGradAccumDebugOutput._make(_result)
      return _result
    except _core._NotOkStatusException as e:
      _ops.raise_from_not_ok_status(e, name)
    except _core._FallbackException:
      pass
    try:
      return retrieve_tpu_embedding_frequency_estimator_parameters_grad_accum_debug_eager_fallback(
          table_id=table_id, table_name=table_name, num_shards=num_shards,
          shard_id=shard_id, config=config, name=name, ctx=_ctx)
    except _core._SymbolicException:
      pass  # Add nodes to the TensorFlow graph.
  ...
  config = _execute.make_str(config, "config")
  _, _, _op, _outputs = _op_def_library._apply_op_helper(
        "RetrieveTPUEmbeddingFrequencyEstimatorParametersGradAccumDebug", num_shards=num_shards,
                                                                          shard_id=shard_id,
                                                                          table_id=table_id,
                                                                          table_name=table_name,
                                                                          config=config,
  ...
  if _execute.must_record_gradient():
    ...
    _inputs_flat = _op.inputs
    _execute.record_gradient(
        "RetrieveTPUEmbeddingFrequencyEstimatorParametersGradAccumDebug", _inputs_flat, _attrs, _result)
  _result = _RetrieveTPUEmbeddingFrequencyEstimatorParametersGradAccumDebugOutput._make(_result)
  return _result

RetrieveTPUEmbeddingFrequencyEstimatorParametersGradAccumDebug = tf_export("raw_ops.RetrieveTPUEmbeddingFrequencyEstimatorParametersGradAccumDebug")(_ops.to_raw_op(retrieve_tpu_embedding_frequency_estimator_parameters_grad_accum_debug))


def retrieve_tpu_embedding_frequency_estimator_parameters_grad_accum_debug_eager_fallback(num_shards, shard_id, table_id, table_name, config, name, ctx):
  num_shards = _execute.make_int(num_shards, "num_shards")
  shard_id = _execute.make_int(shard_id, "shard_id")
  if table_id is None:
    table_id = -1
  ...
  _attrs = ("table_id", table_id, "table_name", table_name, "num_shards",
  num_shards, "shard_id", shard_id, "config", config)
  _result = _execute.execute(b"RetrieveTPUEmbeddingFrequencyEstimatorParametersGradAccumDebug",
                             3, inputs=_inputs_flat, attrs=_attrs, ctx=ctx,
                             name=name)
  if _execute.must_record_gradient():
    _execute.record_gradient(
