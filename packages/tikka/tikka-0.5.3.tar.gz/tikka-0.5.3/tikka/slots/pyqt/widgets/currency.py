...
class CurrencyWidget(QWidget, Ui_currencyWidget):
    ...
    def _update_ui(self):
        ...
        selected_amount = self.application.amounts.get_amount(
    ...
    def _on_refresh_button_clicked_event(self):
        ...
        self.refreshButton.setEnabled(False)
        # Start the thread
        self.network_fetch_currency_async_qworker.start()
...
if __name__ == "__main__":
    ...
    main_window.setCentralWidget(CurrencyWidget(application_, main_window))
