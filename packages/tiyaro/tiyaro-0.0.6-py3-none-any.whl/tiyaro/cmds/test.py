...
@click.option('-i', '--input', required=True, help=f'Valid input string or file path that contains input in expected format for your model-class')
@click.option('-o', '--output', required=False, help=f'Inference output file - saves inference output to file')
