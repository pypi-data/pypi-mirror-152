...
@click.option('-i', '--input', required=True, help=f'Valid input string or file path that contains input in expected format for your model-type')
@click.option('-o', '--output', required=False, help=f'Inference output file - saves inference output to the specified file')
