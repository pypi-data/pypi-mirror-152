...
class CreateFunctionRequestPayload(ModelNormal):
    ...
    validations = {
        ('name',): {
            'regex': {
                'pattern': r'[a-zA-Z]+([A-Za-z0-9\-_]){5,28}[a-zA-Z0-9]',  # noqa: E501
            },
        },
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, src, *args, **kwargs):  # noqa: E501
        """CreateFunctionRequestPayload - a model defined in OpenAPI

        Args:
            name (str): Prefix to name your function
            src (str): Definition of function body
        ...
        Keyword Args:
            ...
            lang (str): Language to write your function in. . [optional] if omitted the server will use the default value of "larky"  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, src, *args, **kwargs):  # noqa: E501
        """CreateFunctionRequestPayload - a model defined in OpenAPI
