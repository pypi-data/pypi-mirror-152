...
class Attributes(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] ([str]): Attributes. Used to add service information.. if omitted defaults to []  

        Keyword Args:
            value ([str]): Attributes. Used to add service information.. if omitted defaults to []  
