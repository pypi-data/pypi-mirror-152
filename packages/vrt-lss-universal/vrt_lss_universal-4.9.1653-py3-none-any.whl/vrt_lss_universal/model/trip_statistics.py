...
class TripStatistics(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, trip_key, statistics, total_load, max_load, max_transfer_load, *args, **kwargs):  
        ...
        Keyword Args:
            stop_statistics ([StopStatistics]): Statistics per stop during the trip.. defaults to []  
        ...
        stop_statistics = kwargs.get('stop_statistics', [])
    ...
    @convert_js_args_to_python_args
    def __init__(self, trip_key, statistics, total_load, max_load, max_transfer_load, *args, **kwargs):  
        """TripStatistics - a model defined in OpenAPI
