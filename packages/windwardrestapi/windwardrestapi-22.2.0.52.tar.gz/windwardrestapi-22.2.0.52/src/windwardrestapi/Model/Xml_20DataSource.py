...
class Xml_20DataSource(Datasource.Datasource):
    ...
    :type str
    '''
    def __init__(self, name, connectionString=None, data=None, schemaConnectionString=None, schemaData=None):
        super().__init__(name=name, connectionString=connectionString, data=data, schemaConnectionString=schemaConnectionString, schemaData=schemaData, type= Datasource.datasouceTypeEnum.XML2)