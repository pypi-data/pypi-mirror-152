...
def read(host: str, user: str, password: str, command: str, port = 1433, database: str = '', fields: _Union[str, list] = None) -> _pd.DataFrame:
    """
...
def write(df: _pd.DataFrame, host: str, database: str, table: str, user: str, password: str, action = 'INSERT', port = 1433, fields: _Union[str, list] = None) -> None:
    """
