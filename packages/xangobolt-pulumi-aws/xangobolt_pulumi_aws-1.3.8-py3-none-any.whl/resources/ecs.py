...
def ecs_service(stem, props, lb_id=None, td_arn=None, cluster_id=None, tg_id=None, vpc_id=None, cp_name=None, snet_ids=None, container=None, provider=None, parent=None, depends_on=None):
