    ...
    try:
        for store_id in reset_stores:
            ...
            if debug_mode == 'N':
                ...
                weekly_fcst['drug_id'] = weekly_fcst['store_id'].astype(int)
                ...
                safety_stock_df['drug_id'] = safety_stock_df['store_id'].astype(int)
                ...
                drug_class['drug_id'] = drug_class['store_id'].astype(int)
