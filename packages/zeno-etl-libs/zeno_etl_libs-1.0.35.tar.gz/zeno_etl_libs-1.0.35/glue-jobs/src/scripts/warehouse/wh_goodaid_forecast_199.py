...
try:
    ...
    main_df['ss_wo_cap'] = (norm.ppf(main_df['service_level']).round(2)
                               * main_df['lead_time_std']
                               * main_df['demand_daily']).round(0)
    main_df['cap_ss_days'] = np.where(main_df['ss_wo_cap'] / main_df['drug_sales_quantity'] * 28 > cap_ss_days, cap_ss_days, '')
    main_df['safety_stock'] = np.where(main_df['ss_wo_cap'] / main_df['drug_sales_quantity'] * 28 > cap_ss_days,
    ...
    main_df['safety_stock_doh'] = main_df['safety_stock'] / main_df['drug_sales_quantity'] * 28
    main_df['reorder_point_doh'] = main_df['reorder_point'] / main_df['drug_sales_quantity'] * 28
    main_df['order_upto_point_doh'] = main_df['order_upto_point'] / main_df['drug_sales_quantity'] * 28
